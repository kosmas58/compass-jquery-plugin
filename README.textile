...
<pre>compass install [-r jquery] jquery/jqmobile <project name></pre>

You will find all the stylesheets in easy-to-read Sass format at:

<pre>stylesheets/jqmobile</pre>

To use the localized stylesheets and javacripts include:

<pre>
= stylesheet_link_tag 'compiled/jquery.mobile/jqm.default.css', :media => 'screen, projection'
= stylesheet_link_tag 'compiled/jquery.mobile/jqm.valencia.css', :media => 'screen, projection'</pre>
= javascript_include_tag :jqmobile'</pre>
