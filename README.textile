...
* jRails with 
** jQuery 1.4.2 and jQuery.UI 1.8 including themes
or
** jQuery 1.3.2 and jQuery.UI 1.7.2 including themes
* jqGrid V3.6.4
* dynatree V0.5.2	
...
For jQuery 1.4.x:
<pre>compass [-r jquery] -f jquery -p jrails-1.4.2 <project name></pre>

For jQuery 1.3.x
<pre>compass [-r jquery] -f jquery -p jrails-1.3.2 <project name></pre>
...
jqGrid now uses the jQuery UI Themes.
