    ...
    b.create("tinymce.ui.KeyboardNavigation", {KeyboardNavigation:function(e, f) {
        ...
        o = function(y) {
            ...
            switch (y.keyCode) {case u:if (i) {
                ...
                p.moveFocus(1)
            }break;case q:if (e.onCancel) {
                e.onCancel();
                a.cancel(y)
            }break;case s:case r:case v:if (e.onAction) {
                e.onAction(g);
                a.cancel(y)
            }break
            }
...
(function(e) {
    ...
    e.create("tinymce.ui.DropMenu:tinymce.ui.Menu", {DropMenu:function(h, g) {
        ...
        var h = this,i;
        switch (g.keyCode) {case 37:if (h.settings.parent) {
            h.hideMenu();
            h.settings.parent.focus();
            a.cancel(g)
        }break;case 39:if (h.mouseOverFunc) {
            h.mouseOverFunc(g)
        }break
        }
    },_add:function(j, h) {
...
(function(j) {
    ...
    j.EditorManager = d(j, {editors:[],i18n:{},activeEditor:null,init:function(q) {
        ...
        i.add(document, "init", function() {
            var s,v;
            r(q, "onpageload");
            switch (q.mode) {case"exact":s = q.elements || "";if (s.length > 0) {
                g(e(s), function(x) {
                    if (k.get(x)) {
                        m = new j.Editor(x, q);
                        o.push(m);
            ...
            }break;case"textareas":case"specific_textareas":function t(y, x) {
        ...
        switch (r) {case"mceFocus":n.focus();return true;case"mceAddEditor":case"mceAddControl":if (!q.get(o)) {
            new j.Editor(o, q.settings).render()
        }return true;case"mceAddFrameControl":l = o.window;l.tinyMCE = tinyMCE;l.tinymce = j;j.DOM.doc = l.document;j.DOM.win = l;n = new j.Editor(o.element_id, o);n.render();if (j.isIE) {
            function m() {
                n.destroy();
        ...
        }o.page_window = null;return true;case"mceRemoveEditor":case"mceRemoveControl":if (n) {
            n.remove()
        }return true;case"mceToggleEditor":if (!n) {
...
(function(m) {
    ...
    m.create("tinymce.Editor", {Editor:function(r, q) {
        ...
        i(p.dom.select("table,a", r), function(t) {
            var s;
            switch (t.nodeName) {case"TABLE":s = p.dom.getAttrib(t, "border");if (!s || s == "0") {
                if (p.hasVisual) {
        ...
        i(x, function(t, s) {
            switch (s) {case"contextmenu":q.bind(B.getDoc(), s, p);break;case"paste":q.bind(B.getBody(), s, function(D) {
                p(D)
            });break;case"submit":case"reset":q.bind(B.getElement().form || n.getParent(B.id, "form"), s, p);break;default:q.bind(C.content_editable ? B.getBody() : B.getDoc(), s, p)
            }
        });
        ...
        if (m.isIE) {
            ...
            B.onKeyDown.add(function(s, D) {
                var t;
                switch (D.keyCode) {case 8:t = B.getDoc().selection;if (t.createRange && t.createRange().item) {
