...
all_scripts = [
    'js/jstree.intro.js',
    'js/jstree.core.js',
    'js/plugins/jstree.ui.js',
    'js/plugins/jstree.crrm.js',
    'js/plugins/jstree.themes.js',
    'js/plugins/jstree.hotkeys.js',
    'js/plugins/jstree.json.js',
    'js/plugins/jstree.languages.js',
    'js/plugins/jstree.cookies.js',
    'js/plugins/jstree.sort.js',
    'js/plugins/jstree.dnd.js',
    'js/plugins/jstree.checkbox.js',
    'js/plugins/jstree.xml.js',
    'js/plugins/jstree.search.js',
    'js/plugins/jstree.contextmenu.js',
    'js/plugins/jstree.types.js',
    'js/plugins/jstree.html.js',
    'js/plugins/jstree.themeroller.js',
    'js/plugins/jstree.unique.js',
    'js/plugins/jstree.radio.js',
    'js/plugins/jstree.wholerow.js',
    'js/plugins/jstree.model.js',
    'js/jstree.outro.js',
