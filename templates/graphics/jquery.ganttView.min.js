...
(function(){var f=Date,g=f.prototype,j=f.CultureInfo,b=function(a,d){d||(d=2);return("000"+a).slice(-1*d)};g.clearTime=function(){this.setHours(0);this.setMinutes(0);this.setSeconds(0);this.setMilliseconds(0);return this};g.setTimeToNow=function(){var a=new Date;this.setHours(a.getHours());this.setMinutes(a.getMinutes());this.setSeconds(a.getSeconds());this.setMilliseconds(a.getMilliseconds());return this};f.today=function(){return(new Date).clearTime()};f.compare=function(a,d){if(isNaN(a)||isNaN(d))throw Error(a+
" - "+d);if(a instanceof Date&&d instanceof Date)return a<d?-1:a>d?1:0;throw new TypeError(a+" - "+d);};f.equals=function(a,d){return 0===a.compareTo(d)};f.getDayNumberFromName=function(a){for(var d=j.dayNames,e=j.abbreviatedDayNames,c=j.shortestDayNames,a=a.toLowerCase(),b=0;b<d.length;b++)if(d[b].toLowerCase()==a||e[b].toLowerCase()==a||c[b].toLowerCase()==a)return b;return-1};f.getMonthNumberFromName=function(a){for(var d=j.monthNames,e=j.abbreviatedMonthNames,a=a.toLowerCase(),b=0;b<d.length;b++)if(d[b].toLowerCase()==
a||e[b].toLowerCase()==a)return b;return-1};f.isLeapYear=function(a){return 0===a%4&&0!==a%100||0===a%400};f.getDaysInMonth=function(a,d){return[31,f.isLeapYear(a)?29:28,31,30,31,30,31,31,30,31,30,31][d]};f.getTimezoneAbbreviation=function(a){for(var d=j.timezones,e=0;e<d.length;e++)if(d[e].offset===a)return d[e].name;return null};f.getTimezoneOffset=function(a){for(var d=j.timezones,e=0;e<d.length;e++)if(d[e].name===a.toUpperCase())return d[e].offset;return null};g.clone=function(){return new Date(this.getTime())};
g.compareTo=function(a){return Date.compare(this,a)};g.equals=function(a){return Date.equals(this,a||new Date)};g.between=function(a,d){return this.getTime()>=a.getTime()&&this.getTime()<=d.getTime()};g.isAfter=function(a){return 1===this.compareTo(a||new Date)};g.isBefore=function(a){return-1===this.compareTo(a||new Date)};g.isToday=function(){return this.isSameDay(new Date)};g.isSameDay=function(a){return this.clone().clearTime().equals(a.clone().clearTime())};g.addMilliseconds=function(a){this.setMilliseconds(this.getMilliseconds()+
a);return this};g.addSeconds=function(a){return this.addMilliseconds(1E3*a)};g.addMinutes=function(a){return this.addMilliseconds(6E4*a)};g.addHours=function(a){return this.addMilliseconds(36E5*a)};g.addDays=function(a){this.setDate(this.getDate()+a);return this};g.addWeeks=function(a){return this.addDays(7*a)};g.addMonths=function(a){var d=this.getDate();this.setDate(1);this.setMonth(this.getMonth()+a);this.setDate(Math.min(d,f.getDaysInMonth(this.getFullYear(),this.getMonth())));return this};g.addYears=
function(a){return this.addMonths(12*a)};g.add=function(a){if("number"==typeof a)return this._orient=a,this;a.milliseconds&&this.addMilliseconds(a.milliseconds);a.seconds&&this.addSeconds(a.seconds);a.minutes&&this.addMinutes(a.minutes);a.hours&&this.addHours(a.hours);a.weeks&&this.addWeeks(a.weeks);a.months&&this.addMonths(a.months);a.years&&this.addYears(a.years);a.days&&this.addDays(a.days);return this};var c,h,n;g.getWeek=function(){var a,d,e,b,f;c=!c?this.getFullYear():c;h=!h?this.getMonth()+
1:h;n=!n?this.getDate():n;2>=h?(a=c-1,d=(a/4|0)-(a/100|0)+(a/400|0),e=d-(((a-1)/4|0)-((a-1)/100|0)+((a-1)/400|0)),b=0,f=n-1+31*(h-1)):(a=c,d=(a/4|0)-(a/100|0)+(a/400|0),e=d-(((a-1)/4|0)-((a-1)/100|0)+((a-1)/400|0)),b=e+1,f=n+(153*(h-3)+2)/5+58+e);a=(a+d)%7;b=f+3-(f+a-b)%7|0;c=h=n=null;return 0>b?53-((a-e)/5|0):b>364+e?1:(b/7|0)+1};g.getISOWeek=function(){c=this.getUTCFullYear();h=this.getUTCMonth()+1;n=this.getUTCDate();return b(this.getWeek())};g.setWeek=function(a){return this.moveToDayOfWeek(1).addWeeks(a-
this.getWeek())};f._validate=function(a,d,e,b){if("undefined"==typeof a)return!1;if("number"!=typeof a)throw new TypeError(a+" is not a Number.");if(a<d||a>e)throw new RangeError(a+" is not a valid value for "+b+".");return!0};f.validateMillisecond=function(a){return f._validate(a,0,999,"millisecond")};f.validateSecond=function(a){return f._validate(a,0,59,"second")};f.validateMinute=function(a){return f._validate(a,0,59,"minute")};f.validateHour=function(a){return f._validate(a,0,23,"hour")};f.validateDay=
...
this.getHours());f.validateMonth(a.month)&&this.addMonths(a.month-this.getMonth());f.validateYear(a.year)&&this.addYears(a.year-this.getFullYear());f.validateDay(a.day,this.getFullYear(),this.getMonth())&&this.addDays(a.day-this.getDate());a.timezone&&this.setTimezone(a.timezone);a.timezoneOffset&&this.setTimezoneOffset(a.timezoneOffset);a.week&&f._validate(a.week,0,53,"week")&&this.setWeek(a.week);return this};g.moveToFirstDayOfMonth=function(){return this.set({day:1})};g.moveToLastDayOfMonth=function(){return this.set({day:f.getDaysInMonth(this.getFullYear(),
this.getMonth())})};g.moveToNthOccurrence=function(a,d){var e=0;if(0<d)e=d-1;else if(-1===d)return this.moveToLastDayOfMonth(),this.getDay()!==a&&this.moveToDayOfWeek(a,-1),this;return this.moveToFirstDayOfMonth().addDays(-1).moveToDayOfWeek(a,1).addWeeks(e)};g.moveToDayOfWeek=function(a,d){var e=(a-this.getDay()+7*(d||1))%7;return this.addDays(0===e?e+7*(d||1):e)};g.moveToMonth=function(a,d){var e=(a-this.getMonth()+12*(d||1))%12;return this.addMonths(0===e?e+12*(d||1):e)};g.getOrdinalNumber=function(){return Math.ceil((this.clone().clearTime()-
new Date(this.getFullYear(),0,1))/864E5)+1};g.getTimezone=function(){return f.getTimezoneAbbreviation(this.getUTCOffset())};g.setTimezoneOffset=function(a){var d=this.getTimezoneOffset();return this.addMinutes(-6*Number(a)/10-d)};g.setTimezone=function(a){return this.setTimezoneOffset(f.getTimezoneOffset(a))};g.hasDaylightSavingTime=function(){return Date.today().set({month:0,day:1}).getTimezoneOffset()!==Date.today().set({month:6,day:1}).getTimezoneOffset()};g.isDaylightSavingTime=function(){return this.hasDaylightSavingTime()&&
(new Date).getTimezoneOffset()===Date.today().set({month:6,day:1}).getTimezoneOffset()};g.getUTCOffset=function(){var a=-10*this.getTimezoneOffset()/6;if(0>a)return a=(a-1E4).toString(),a.charAt(0)+a.substr(2);a=(a+1E4).toString();return"+"+a.substr(1)};g.getElapsed=function(a){return(a||new Date)-this};if(!g.toISOString)g.toISOString=function(){function a(a){return 10>a?"0"+a:a}return'"'+this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+
":"+a(this.getUTCSeconds())+'Z"'};g._toString=g.toString;g.toString=function(a){var d=this;if(a&&1==a.length){var e=j.formatPatterns;d.t=d.toString;switch(a){case "d":return d.t(e.shortDate);case "D":return d.t(e.longDate);case "F":return d.t(e.fullDateTime);case "m":return d.t(e.monthDay);case "r":return d.t(e.rfc1123);case "s":return d.t(e.sortableDateTime);case "t":return d.t(e.shortTime);case "T":return d.t(e.longTime);case "u":return d.t(e.universalSortableDateTime);case "y":return d.t(e.yearMonth)}}var c=
...
g.weekday=function(){return this._is?(this._is=!1,!this.is().sat()&&!this.is().sun()):!1};g.at=function(a){return"string"===typeof a?f.parse(this.toString("d")+" "+a):this.set(a)};b.fromNow=b.after=function(a){var e={};e[this._dateElement]=this;return(!a?new Date:a.clone()).add(e)};b.ago=b.before=function(a){var e={};e[this._dateElement]=-1*this;return(!a?new Date:a.clone()).add(e)};var c="sunday monday tuesday wednesday thursday friday saturday".split(/\s/),h="january february march april may june july august september october november december".split(/\s/),
n="Millisecond Second Minute Hour Day Week Month Year".split(/\s/),a="Milliseconds Seconds Minutes Hours Date Week Month FullYear".split(/\s/),d="final first second third fourth fifth".split(/\s/);g.toObject=function(){for(var e={},d=0;d<n.length;d++)e[n[d].toLowerCase()]=this["get"+a[d]]();return e};f.fromObject=function(a){a.week=null;return Date.today().set(a)};for(var e=function(a){return function(){if(this._is)return this._is=!1,this.getDay()==a;if(null!==this._nth){this._isSecond&&this.addSeconds(-1*
this._orient);this._isSecond=!1;var e=this._nth;this._nth=null;var d=this.clone().moveToLastDayOfMonth();this.moveToNthOccurrence(a,e);if(this>d)throw new RangeError(f.getDayName(a)+" does not occur "+e+" times in the month of "+f.getMonthName(d.getMonth())+" "+d.getFullYear()+".");return this}return this.moveToDayOfWeek(a,this._orient)}},l=function(a){return function(){var e=f.today(),d=a-e.getDay();0===a&&1===j.firstDayOfWeek&&0!==e.getDay()&&(d+=7);return e.addDays(d)}},k=0;k<c.length;k++)f[c[k].toUpperCase()]=
f[c[k].toUpperCase().substring(0,3)]=k,f[c[k]]=f[c[k].substring(0,3)]=l(k),g[c[k]]=g[c[k].substring(0,3)]=e(k);c=function(a){return function(){return this._is?(this._is=!1,this.getMonth()===a):this.moveToMonth(a,this._orient)}};e=function(a){return function(){return f.today().set({month:a,day:1})}};for(l=0;l<h.length;l++)f[h[l].toUpperCase()]=f[h[l].toUpperCase().substring(0,3)]=l,f[h[l]]=f[h[l].substring(0,3)]=e(l),g[h[l]]=g[h[l].substring(0,3)]=c(l);c=function(a){return function(e){if(this._isSecond)return this._isSecond=
!1,this;if(this._same){this._same=this._is=!1;for(var d=this.toObject(),e=(e||new Date).toObject(),b="",c=a.toLowerCase(),f=n.length-1;-1<f;f--){b=n[f].toLowerCase();if(d[b]!=e[b])return!1;if(c==b)break}return!0}"s"!=a.substring(a.length-1)&&(a+="s");return this["add"+a](this._orient)}};e=function(a){return function(){this._dateElement=a;return this}};for(l=0;l<n.length;l++)h=n[l].toLowerCase(),g[h]=g[h+"s"]=c(n[l]),b[h]=b[h+"s"]=e(h);g._ss=c("Second");b=function(a){return function(e){if(this._same)return this._ss(e);
if(e||0===e)return this.moveToNthOccurrence(e,a);this._nth=a;return 2===a&&(void 0===e||null===e)?(this._isSecond=!0,this.addSeconds(this._orient)):this}};for(h=0;h<d.length;h++)g[d[h]]=0===h?b(-1):b(h)})();
(function(){Date.Parsing={Exception:function(b){this.message="Parse error at '"+b.substring(0,10)+" ...'"}};for(var f=Date.Parsing,g=f.Operators={rtoken:function(b){return function(c){var a=c.match(b);if(a)return[a[0],c.substring(a[0].length)];throw new f.Exception(c);}},token:function(){return function(b){return g.rtoken(RegExp("^s*"+b+"s*"))(b)}},stoken:function(b){return g.rtoken(RegExp("^"+b))},until:function(b){return function(c){for(var a=[],d=null;c.length;){try{d=b.call(this,c)}catch(e){a.push(d[0]);
...
arguments[0],c=Array.prototype.slice.call(arguments,1),a=[],d=0;d<b.length;d++)a.push(g.each(b[d],c));return a},cache:function(b){var c={},a=null;return function(d){try{a=c[d]=c[d]||b.call(this,d)}catch(e){a=c[d]=e}if(a instanceof f.Exception)throw a;return a}},any:function(){var b=arguments;return function(c){for(var a=null,d=0;d<b.length;d++)if(null!=b[d]){try{a=b[d].call(this,c)}catch(e){a=null}if(a)return a}throw new f.Exception(c);}},each:function(){var b=arguments;return function(c){for(var a=
[],d=null,e=0;e<b.length;e++)if(null!=b[e]){try{d=b[e].call(this,c)}catch(l){throw new f.Exception(c);}a.push(d[0]);c=d[1]}return[a,c]}},all:function(){var b=b;return b.each(b.optional(arguments))},sequence:function(b,c,a){c=c||g.rtoken(/^\s*/);a=a||null;return 1==b.length?b[0]:function(d){for(var e=null,l=null,g=[],i=0;i<b.length;i++){try{e=b[i].call(this,d)}catch(m){break}g.push(e[0]);try{l=c.call(this,e[1])}catch(j){l=null;break}d=l[1]}if(!e)throw new f.Exception(d);if(l)throw new f.Exception(l[1]);
...
null,l=e=null,k=null,i=[[],d],m=!1,j=0;j<b.length;j++){e=l=null;m=1==b.length;try{e=b[j].call(this,d)}catch(p){continue}k=[[e[0]],e[1]];if(0<e[1].length&&!m)try{l=c.call(this,e[1])}catch(q){m=!0}else m=!0;!m&&0===l[1].length&&(m=!0);if(!m){e=[];for(m=0;m<b.length;m++)j!=m&&e.push(b[m]);e=g.set(e,c).call(this,l[1]);0<e[0].length&&(k[0]=k[0].concat(e[0]),k[1]=e[1])}k[1].length<i[1].length&&(i=k);if(0===i[1].length)break}if(0===i[0].length)return i;if(a){try{l=a.call(this,i[1])}catch(t){throw new f.Exception(i[1]);
}i[1]=l[1]}return i}},forward:function(b,c){return function(a){return b[c].call(this,a)}},replace:function(b,c){return function(a){a=b.call(this,a);return[c,a[1]]}},process:function(b,c){return function(a){a=b.call(this,a);return[c.call(this,a[0]),a[1]]}},min:function(b,c){return function(a){var d=c.call(this,a);if(d[0].length<b)throw new f.Exception(a);return d}}},j=function(b){return function(){var c=null,a=[];1<arguments.length?c=Array.prototype.slice.call(arguments):arguments[0]instanceof Array&&
...
"");b.length?this.timezoneOffset=Number(b):this.timezone=a.toLowerCase()}},day:function(a){var b=a[0];return function(){this.day=Number(b.match(/\d+/)[0])}},month:function(a){return function(){this.month=3==a.length?"jan feb mar apr may jun jul aug sep oct nov dec".indexOf(a)/4:Number(a)-1}},year:function(a){return function(){var b=Number(a);this.year=2<a.length?b:b+(b+2E3<g.twoDigitYearMax?2E3:1900)}},rday:function(a){return function(){switch(a){case "yesterday":this.days=-1;break;case "tomorrow":this.days=
1;break;case "today":this.days=0;break;case "now":this.days=0,this.now=!0}}},finishExact:function(a){for(var a=a instanceof Array?a:[a],b=0;b<a.length;b++)a[b]&&a[b].call(this);a=new Date;if((this.hour||this.minute)&&!this.month&&!this.year&&!this.day)this.day=a.getDate();if(!this.year)this.year=a.getFullYear();if(!this.month&&0!==this.month)this.month=a.getMonth();if(!this.day)this.day=1;if(!this.hour)this.hour=0;if(!this.minute)this.minute=0;if(!this.second)this.second=0;if(this.meridian&&this.hour)if("p"==
this.meridian&&12>this.hour)this.hour+=12;else if("a"==this.meridian&&12==this.hour)this.hour=0;if(this.day>f.getDaysInMonth(this.year,this.month))throw new RangeError(this.day+" is not a valid value for days.");a=new Date(this.year,this.month,this.day,this.hour,this.minute,this.second);this.timezone?a.set({timezone:this.timezone}):this.timezoneOffset&&a.set({timezoneOffset:this.timezoneOffset});return a},finish:function(a){a=a instanceof Array?j(a):[a];if(0===a.length)return null;for(var b=0;b<a.length;b++)"function"==
...
this.day=c.getDate();if(!this.month)this.month=c.getMonth();this.year=c.getFullYear()}if(b&&this.weekday&&"month"!=this.unit)this.unit="day",c=f.getDayNumberFromName(this.weekday)-a.getDay(),d=7,this.days=c?(c+g*d)%d:g*d;if(this.month&&"day"==this.unit&&this.operator)this.value=this.month+1,this.month=null;if(null!=this.value&&null!=this.month&&null!=this.year)this.day=1*this.value;if(this.month&&!this.day&&this.value&&(a.set({day:1*this.value}),!b))this.day=1*this.value;if(!this.month&&this.value&&
"month"==this.unit&&!this.now)this.month=this.value,b=!0;if(b&&(this.month||0===this.month)&&"year"!=this.unit)this.unit="month",c=this.month-a.getMonth(),d=12,this.months=c?(c+g*d)%d:g*d,this.month=null;if(!this.unit)this.unit="day";if(!this.value&&this.operator&&null!==this.operator&&this[this.unit+"s"]&&null!==this[this.unit+"s"])this[this.unit+"s"]=this[this.unit+"s"]+("add"==this.operator?1:-1)+(this.value||0)*g;else if(null==this[this.unit+"s"]||null!=this.operator){if(!this.value)this.value=
1;this[this.unit+"s"]=this.value*g}if(this.meridian&&this.hour)if("p"==this.meridian&&12>this.hour)this.hour+=12;else if("a"==this.meridian&&12==this.hour)this.hour=0;if(this.weekday&&!this.day&&!this.days&&(c=Date[this.weekday](),this.day=c.getDate(),c.getMonth()!==a.getMonth()))this.month=c.getMonth();if((this.month||0===this.month)&&!this.day)this.day=1;if(!this.orient&&!this.operator&&"week"==this.unit&&this.value&&!this.day&&!this.month)return Date.today().setWeek(this.value);if(b&&this.timezone&&
...
c.ddd,c.MMM]);n=function(){return b.set(arguments,c.datePartDelimiter)};c.mdy=n(c.ddd,c.month,c.day,c.year);c.ymd=n(c.ddd,c.year,c.month,c.day);c.dmy=n(c.ddd,c.day,c.month,c.year);c.date=function(a){return(c[g.dateElementOrder]||c.mdy).call(this,a)};c.format=b.process(b.many(b.any(b.process(b.rtoken(/^(dd?d?d?|MM?M?M?|yy?y?y?|hh?|HH?|mm?|ss?|tt?|zz?z?)/),function(a){if(c[a])return c[a];throw f.Parsing.Exception(a);}),b.process(b.rtoken(/^[^dMyhHmstz]+/),function(a){return b.ignore(b.stoken(a))}))),
function(a){return b.process(b.each.apply(null,a),h.finishExact)});var d={};c.formats=function(a){if(a instanceof Array){for(var f=[],g=0;g<a.length;g++)f.push(d[a[g]]=d[a[g]]||c.format(a[g])[0]);return b.any.apply(null,f)}return d[a]=d[a]||c.format(a)[0]};c._formats=c.formats('"yyyy-MM-ddTHH:mm:ssZ";yyyy-MM-ddTHH:mm:ssZ;yyyy-MM-ddTHH:mm:ssz;yyyy-MM-ddTHH:mm:ss;yyyy-MM-ddTHH:mmZ;yyyy-MM-ddTHH:mmz;yyyy-MM-ddTHH:mm;ddd, MMM dd, yyyy H:mm:ss tt;ddd MMM d yyyy HH:mm:ss zzz;MMddyyyy;ddMMyyyy;Mddyyyy;ddMyyyy;Mdyyyy;dMyyyy;yyyy;Mdyy;dMyy;d'.split(";"));
c._start=b.process(b.set([c.date,c.time,c.expression],c.generalDelimiter,c.whiteSpace),h.finish);c.start=function(a){try{var b=c._formats.call({},a);if(0===b[1].length)return b}catch(d){}return c._start.call({},a)};f._parse=f.parse;f.parse=function(a){var b=null;if(!a)return null;if(a instanceof Date)return a;try{b=f.Grammar.start.call({},a.replace(/^\s*(\S*(\s+\S+)*)\s*$/,"$1"))}catch(c){return null}return 0===b[1].length?b[0]:null};f.getParseFunction=function(a){var b=f.Grammar.formats(a);return function(a){var c=
null;try{c=b.call({},a)}catch(d){return null}return 0===c[1].length?c[0]:null}};f.parseExact=function(a,b){return f.getParseFunction(b)(a)}})();
...
draggable:!0,resizable:!0}},g);e.data?a():e.dataUrl&&f.getJSON(e.dataUrl,function(b){e.data=b;a()})}function j(b,a){if("setSlideWidth"==b){var c=$("div.ganttview",this);c.each(function(){var b=$("div.ganttview-vtheader",c).outerWidth();$(c).width(b+a+1);$("div.ganttview-slide-container",this).width(a)})}}f.fn.ganttView=function(){var b=Array.prototype.slice.call(arguments);1==b.length&&"object"==typeof b[0]&&g.call(this,b[0]);2==b.length&&"string"==typeof b[0]&&j.call(this,b[0],b[1])};var b=function(b,
a){var c="Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(",");return{render:function(){for(var e=a.data,g=a.cellHeight,k=f("<div>",{"class":"ganttview-vtheader"}),i=0;i<e.length;i++){var m=f("<div>",{"class":"ganttview-vtheader-item"});m.append(f("<div>",{"class":"ganttview-vtheader-item-name",css:{height:e[i].series.length*g+"px"}}).append(e[i].name));for(var j=f("<div>",{"class":"ganttview-vtheader-series"}),p=0;p<e[i].series.length;p++)j.append(f("<div>",{"class":"ganttview-vtheader-series-name"}).append(e[i].series[p].name));
m.append(j);k.append(m)}b.append(k);e=f("<div>",{"class":"ganttview-slide-container",css:{width:a.slideWidth+"px"}});i=a.start;g=a.end;k=[];k[i.getFullYear()]=[];for(k[i.getFullYear()][i.getMonth()]=[i];-1==i.compareTo(g);)i=i.clone().addDays(1),k[i.getFullYear()]||(k[i.getFullYear()]=[]),k[i.getFullYear()][i.getMonth()]||(k[i.getFullYear()][i.getMonth()]=[]),k[i.getFullYear()][i.getMonth()].push(i);var g=dates=k,k=a.cellWidth,i=f("<div>",{"class":"ganttview-hzheader"}),m=f("<div>",{"class":"ganttview-hzheader-months"}),
j=f("<div>",{"class":"ganttview-hzheader-days"}),p=0,q;for(q in g)for(var t in g[q]){var w=g[q][t].length*k,p=p+w;m.append(f("<div>",{"class":"ganttview-hzheader-month",css:{width:w-1+"px"}}).append(c[t]+"/"+q));for(var s in g[q][t])j.append(f("<div>",{"class":"ganttview-hzheader-day"}).append(g[q][t][s].getDate()))}m.css("width",p+"px");j.css("width",p+"px");i.append(m).append(j);e.append(i);q=a.data;g=dates;k=a.cellWidth;i=a.showWeekends;t=f("<div>",{"class":"ganttview-grid"});s=f("<div>",{"class":"ganttview-grid-row"});
...
d.clone().addDays(c);f("div.ganttview-block-text",b).text(c+1);b.css("top","").css("left","").css("position","relative").css("margin-left",a+"px")}return{apply:function(){a.behavior.clickable&&c(b,a.behavior.onClick);a.behavior.resizable&&e(b,a.cellWidth,a.start,a.behavior.onResize);a.behavior.draggable&&g(b,a.cellWidth,a.start,a.behavior.onDrag)}}},h={daysBetween:function(b,a){if(!b||!a)return 0;b=Date.parse(b);a=Date.parse(a);if(1901==b.getYear()||8099==a.getYear())return 0;for(var c=0,e=b.clone();-1==
e.compareTo(a);)c+=1,e.addDays(1);return c},isWeekend:function(b){return 0==b.getDay()%6},getBoundaryDatesFromData:function(b,a){var c=new Date;maxEnd=new Date;for(var e=0;e<b.length;e++)for(var f=0;f<b[e].series.length;f++){var g=Date.parse(b[e].series[f].start),i=Date.parse(b[e].series[f].end);0==e&&0==f&&(c=g,maxEnd=i);1==c.compareTo(g)&&(c=g);-1==maxEnd.compareTo(i)&&(maxEnd=i)}h.daysBetween(c,maxEnd)<a&&(maxEnd=c.clone().addDays(a));return[c,maxEnd]}}})(jQuery);
