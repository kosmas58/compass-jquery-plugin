...
g.setWeek=function(a){return this.moveToDayOfWeek(1).addWeeks(a-this.getWeek())};f._validate=function(a,d,e,b){if(typeof a=="undefined")return false;else if(typeof a!="number")throw new TypeError(a+" is not a Number.");else if(a<d||a>e)throw new RangeError(a+" is not a valid value for "+b+".");return true};f.validateMillisecond=function(a){return f._validate(a,0,999,"millisecond")};f.validateSecond=function(a){return f._validate(a,0,59,"second")};f.validateMinute=function(a){return f._validate(a,
...
g.moveToFirstDayOfMonth=function(){return this.set({day:1})};g.moveToLastDayOfMonth=function(){return this.set({day:f.getDaysInMonth(this.getFullYear(),this.getMonth())})};g.moveToNthOccurrence=function(a,d){var e=0;if(d>0)e=d-1;else if(d===-1)return this.moveToLastDayOfMonth(),this.getDay()!==a&&this.moveToDayOfWeek(a,-1),this;return this.moveToFirstDayOfMonth().addDays(-1).moveToDayOfWeek(a,1).addWeeks(e)};g.moveToDayOfWeek=function(a,d){var e=(a-this.getDay()+7*(d||1))%7;return this.addDays(e===
0?e+7*(d||1):e)};g.moveToMonth=function(a,d){var e=(a-this.getMonth()+12*(d||1))%12;return this.addMonths(e===0?e+12*(d||1):e)};g.getOrdinalNumber=function(){return Math.ceil((this.clone().clearTime()-new Date(this.getFullYear(),0,1))/864E5)+1};g.getTimezone=function(){return f.getTimezoneAbbreviation(this.getUTCOffset())};g.setTimezoneOffset=function(a){var d=this.getTimezoneOffset();return this.addMinutes(Number(a)*-6/10-d)};g.setTimezone=function(a){return this.setTimezoneOffset(f.getTimezoneOffset(a))};
g.hasDaylightSavingTime=function(){return Date.today().set({month:0,day:1}).getTimezoneOffset()!==Date.today().set({month:6,day:1}).getTimezoneOffset()};g.isDaylightSavingTime=function(){return this.hasDaylightSavingTime()&&(new Date).getTimezoneOffset()===Date.today().set({month:6,day:1}).getTimezoneOffset()};g.getUTCOffset=function(){var a=this.getTimezoneOffset()*-10/6;return a<0?(a=(a-1E4).toString(),a.charAt(0)+a.substr(2)):(a=(a+1E4).toString(),"+"+a.substr(1))};g.getElapsed=function(a){return(a||
new Date)-this};if(!g.toISOString)g.toISOString=function(){function a(a){return a<10?"0"+a:a}return'"'+this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+'Z"'};g._toString=g.toString;g.toString=function(a){var d=this;if(a&&a.length==1){var e=j.formatPatterns;d.t=d.toString;switch(a){case "d":return d.t(e.shortDate);case "D":return d.t(e.longDate);case "F":return d.t(e.fullDateTime);case "m":return d.t(e.monthDay);
case "r":return d.t(e.rfc1123);case "s":return d.t(e.sortableDateTime);case "t":return d.t(e.shortTime);case "T":return d.t(e.longTime);case "u":return d.t(e.universalSortableDateTime);case "y":return d.t(e.yearMonth)}}var c=function(a){switch(a*1){case 1:case 21:case 31:return"st";case 2:case 22:return"nd";case 3:case 23:return"rd";default:return"th"}};return a?a.replace(/(\\)?(dd?d?d?|MM?M?M?|yy?y?y?|hh?|HH?|mm?|ss?|tt?|S)/g,function(a){if(a.charAt(0)==="\\")return a.replace("\\","");d.h=d.getHours;
switch(a){case "hh":return b(d.h()<13?d.h()===0?12:d.h():d.h()-12);case "h":return d.h()<13?d.h()===0?12:d.h():d.h()-12;case "HH":return b(d.h());case "H":return d.h();case "mm":return b(d.getMinutes());case "m":return d.getMinutes();case "ss":return b(d.getSeconds());case "s":return d.getSeconds();case "yyyy":return b(d.getFullYear(),4);case "yy":return b(d.getFullYear());case "dddd":return j.dayNames[d.getDay()];case "ddd":return j.abbreviatedDayNames[d.getDay()];case "dd":return b(d.getDate());
case "d":return d.getDate();case "MMMM":return j.monthNames[d.getMonth()];case "MMM":return j.abbreviatedMonthNames[d.getMonth()];case "MM":return b(d.getMonth()+1);case "M":return d.getMonth()+1;case "t":return d.h()<12?j.amDesignator.substring(0,1):j.pmDesignator.substring(0,1);case "tt":return d.h()<12?j.amDesignator:j.pmDesignator;case "S":return c(d.getDate());default:return a}}):this._toString()}})();
(function(){var f=Date,g=f.prototype,j=f.CultureInfo,b=Number.prototype;g._orient=1;g._nth=null;g._is=false;g._same=false;g._isSecond=false;b._dateElement="day";g.next=function(){this._orient=1;return this};f.next=function(){return f.today().next()};g.last=g.prev=g.previous=function(){this._orient=-1;return this};f.last=f.prev=f.previous=function(){return f.today().last()};g.is=function(){this._is=true;return this};g.same=function(){this._same=true;this._isSecond=false;return this};g.today=function(){return this.same().day()};
g.weekday=function(){return this._is?(this._is=false,!this.is().sat()&&!this.is().sun()):false};g.at=function(a){return typeof a==="string"?f.parse(this.toString("d")+" "+a):this.set(a)};b.fromNow=b.after=function(a){var e={};e[this._dateElement]=this;return(!a?new Date:a.clone()).add(e)};b.ago=b.before=function(a){var e={};e[this._dateElement]=this*-1;return(!a?new Date:a.clone()).add(e)};var c="sunday monday tuesday wednesday thursday friday saturday".split(/\s/),h="january february march april may june july august september october november december".split(/\s/),
n="Millisecond Second Minute Hour Day Week Month Year".split(/\s/),a="Milliseconds Seconds Minutes Hours Date Week Month FullYear".split(/\s/),d="final first second third fourth fifth".split(/\s/);g.toObject=function(){for(var e={},d=0;d<n.length;d++)e[n[d].toLowerCase()]=this["get"+a[d]]();return e};f.fromObject=function(a){a.week=null;return Date.today().set(a)};for(var e=function(a){return function(){if(this._is)return this._is=false,this.getDay()==a;if(this._nth!==null){this._isSecond&&this.addSeconds(this._orient*
-1);this._isSecond=false;var e=this._nth;this._nth=null;var d=this.clone().moveToLastDayOfMonth();this.moveToNthOccurrence(a,e);if(this>d)throw new RangeError(f.getDayName(a)+" does not occur "+e+" times in the month of "+f.getMonthName(d.getMonth())+" "+d.getFullYear()+".");return this}return this.moveToDayOfWeek(a,this._orient)}},l=function(a){return function(){var e=f.today(),d=a-e.getDay();a===0&&j.firstDayOfWeek===1&&e.getDay()!==0&&(d+=7);return e.addDays(d)}},k=0;k<c.length;k++)f[c[k].toUpperCase()]=
f[c[k].toUpperCase().substring(0,3)]=k,f[c[k]]=f[c[k].substring(0,3)]=l(k),g[c[k]]=g[c[k].substring(0,3)]=e(k);c=function(a){return function(){return this._is?(this._is=false,this.getMonth()===a):this.moveToMonth(a,this._orient)}};e=function(a){return function(){return f.today().set({month:a,day:1})}};for(l=0;l<h.length;l++)f[h[l].toUpperCase()]=f[h[l].toUpperCase().substring(0,3)]=l,f[h[l]]=f[h[l].substring(0,3)]=e(l),g[h[l]]=g[h[l].substring(0,3)]=c(l);c=function(a){return function(e){if(this._isSecond)return this._isSecond=
false,this;if(this._same){this._same=this._is=false;for(var d=this.toObject(),e=(e||new Date).toObject(),b="",c=a.toLowerCase(),f=n.length-1;f>-1;f--){b=n[f].toLowerCase();if(d[b]!=e[b])return false;if(c==b)break}return true}a.substring(a.length-1)!="s"&&(a+="s");return this["add"+a](this._orient)}};e=function(a){return function(){this._dateElement=a;return this}};for(l=0;l<n.length;l++)h=n[l].toLowerCase(),g[h]=g[h+"s"]=c(n[l]),b[h]=b[h+"s"]=e(h);g._ss=c("Second");b=function(a){return function(e){if(this._same)return this._ss(e);
if(e||e===0)return this.moveToNthOccurrence(e,a);this._nth=a;return a===2&&(e===void 0||e===null)?(this._isSecond=true,this.addSeconds(this._orient)):this}};for(h=0;h<d.length;h++)g[d[h]]=h===0?b(-1):b(h)})();
...
[],d=null,e=0;e<b.length;e++)if(b[e]!=null){try{d=b[e].call(this,c)}catch(l){throw new f.Exception(c);}a.push(d[0]);c=d[1]}return[a,c]}},all:function(){var b=b;return b.each(b.optional(arguments))},sequence:function(b,c,a){c=c||g.rtoken(/^\s*/);a=a||null;return b.length==1?b[0]:function(d){for(var e=null,l=null,g=[],i=0;i<b.length;i++){try{e=b[i].call(this,d)}catch(m){break}g.push(e[0]);try{l=c.call(this,e[1])}catch(j){l=null;break}d=l[1]}if(!e)throw new f.Exception(d);if(l)throw new f.Exception(l[1]);
...
null,l=e=null,k=null,i=[[],d],m=false,j=0;j<b.length;j++){e=l=null;m=b.length==1;try{e=b[j].call(this,d)}catch(p){continue}k=[[e[0]],e[1]];if(e[1].length>0&&!m)try{l=c.call(this,e[1])}catch(q){m=true}else m=true;!m&&l[1].length===0&&(m=true);if(!m){e=[];for(m=0;m<b.length;m++)j!=m&&e.push(b[m]);e=g.set(e,c).call(this,l[1]);e[0].length>0&&(k[0]=k[0].concat(e[0]),k[1]=e[1])}k[1].length<i[1].length&&(i=k);if(i[1].length===0)break}if(i[0].length===0)return i;if(a){try{l=a.call(this,i[1])}catch(t){throw new f.Exception(i[1]);
...
c._start=b.process(b.set([c.date,c.time,c.expression],c.generalDelimiter,c.whiteSpace),h.finish);c.start=function(a){try{var b=c._formats.call({},a);if(b[1].length===0)return b}catch(d){}return c._start.call({},a)};f._parse=f.parse;f.parse=function(a){var b=null;if(!a)return null;if(a instanceof Date)return a;try{b=f.Grammar.start.call({},a.replace(/^\s*(\S*(\s+\S+)*)\s*$/,"$1"))}catch(c){return null}return b[1].length===0?b[0]:null};f.getParseFunction=function(a){var b=f.Grammar.formats(a);return function(a){var c=
null;try{c=b.call({},a)}catch(d){return null}return c[1].length===0?c[0]:null}};f.parseExact=function(a,b){return f.getParseFunction(b)(a)}})();
(function(f){function g(g){function a(){var a=h.getBoundaryDatesFromData(e.data,Math.floor(e.slideWidth/e.cellWidth+5));e.start=a[0];e.end=a[1];d.each(function(){var a=f(this),d=f("<div>",{"class":"ganttview"});(new b(d,e)).render();a.append(d);d=f("div.ganttview-vtheader",a).outerWidth()+f("div.ganttview-slide-container",a).outerWidth();a.css("width",d+2+"px");(new c(a,e)).apply()})}var d=this,e=f.extend(true,{showWeekends:true,cellWidth:21,cellHeight:31,slideWidth:400,vHeaderWidth:100,behavior:{clickable:true,
draggable:true,resizable:true}},g);e.data?a():e.dataUrl&&f.getJSON(e.dataUrl,function(b){e.data=b;a()})}function j(b,a){if(b=="setSlideWidth"){var c=$("div.ganttview",this);c.each(function(){var b=$("div.ganttview-vtheader",c).outerWidth();$(c).width(b+a+1);$("div.ganttview-slide-container",this).width(a)})}}f.fn.ganttView=function(){var b=Array.prototype.slice.call(arguments);b.length==1&&typeof b[0]=="object"&&g.call(this,b[0]);b.length==2&&typeof b[0]=="string"&&j.call(this,b[0],b[1])};var b=function(b,
