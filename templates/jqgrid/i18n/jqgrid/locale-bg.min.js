(function(b){b.jgrid={defaults:{recordtext:"{0} - {1} от {2}",emptyrecords:"Няма запис(и)",loadtext:"Зареждам...",pgtext:"Стр. {0} от {1}"},search:{caption:"Търсене...",Find:"Намери",Reset:"Изчисти",odata:"равно,различно,по-малко,по-малко или=,по-голямо,по-голямо или =,започва с,не започва с,се намира в,не се намира в,завършва с,не завършава с,съдържа,не съдържа".split(","),groupOps:[{op:"AND",text:"&nbsp;И "},{op:"OR",text:"ИЛИ"}],matchText:" включи",rulesText:" клауза"},edit:{addCaption:"Нов Запис",
