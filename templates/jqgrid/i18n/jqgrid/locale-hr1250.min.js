...
currency:{decimalSeparator:".",thousandsSeparator:" ",decimalPlaces:2,prefix:"",suffix:"",defaultValue:"0.00"},date:{dayNames:"Ned,Pon,Uto,Sri,�et,Pet,Sub,Nedjelja,Ponedjeljak,Utorak,Srijeda,�etvrtak,Petak,Subota".split(","),monthNames:"Sij,Vel,O�u,Tra,Svi,Lip,Srp,Kol,Ruj,Lis,Stu,Pro,Sije�anj,Velja�a,O�ujak,Travanj,Svibanj,Lipanj,Srpanj,Kolovoz,Rujan,Listopad,Studeni,Prosinac".split(","),AmPm:["am","pm","AM","PM"],S:function(){return""},srcformat:"Y-m-d",newformat:"d.m.Y.",masks:{ISO8601Long:"Y-m-d H:i:s",
ISO8601Short:"Y-m-d",ShortDate:"j.n.Y.",LongDate:"l, j. F Y",FullDateTime:"l, d. F Y G:i:s",MonthDay:"d. F",ShortTime:"G:i",LongTime:"G:i:s",SortableDateTime:"Y-m-d\\TH:i:s",UniversalSortableDateTime:"Y-m-d H:i:sO",YearMonth:"F, Y"},reformatAfterEdit:false},baseLinkUrl:"",showAction:"",target:"",checkbox:{disabled:true},idName:"id"}}})(jQuery);
