(function(b){b.jgrid={defaults:{recordtext:"Перегляд {0} - {1} з {2}",emptyrecords:"Немає записів для перегляду",loadtext:"Завантаження...",pgtext:"Стор. {0} з {1}"},search:{caption:"Пошук...",Find:"Знайти",Reset:"Скидання",odata:["рівно","не рівно","менше","менше або рівне","більше","більше або рівне","починається з","не починається з","знаходиться в","не знаходиться в","закінчується на","не закінчується на","містить","не містить"],groupOps:[{op:"AND",text:"все"},{op:"OR",text:"будь-який"}],matchText:" збігається",
