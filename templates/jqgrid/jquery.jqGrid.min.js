...
function(){var o={},m=0,n,q=a(b.p.gridid)[0],r;q.p.searchdata={};a.isFunction(b.p.beforeSearch)&&b.p.beforeSearch();a.each(b.p.filterModel,function(){r=this.index;switch(this.stype){case "select":if(n=a("select[name="+r+"]",b).val()){o[r]=n;b.p.marksearched&&a("#jqgh_"+this.name,q.grid.hDiv).addClass("dirty-cell");m++}else{b.p.marksearched&&a("#jqgh_"+this.name,q.grid.hDiv).removeClass("dirty-cell");try{delete q.p.postData[this.index]}catch(w){}}break;default:if(n=a("input[name="+r+"]",b).val()){o[r]=
n;b.p.marksearched&&a("#jqgh_"+this.name,q.grid.hDiv).addClass("dirty-cell");m++}else{b.p.marksearched&&a("#jqgh_"+this.name,q.grid.hDiv).removeClass("dirty-cell");try{delete q.p.postData[this.index]}catch(z){}}}});var u=m>0?true:false;a.extend(q.p.postData,o);var v;if(b.p.url){v=a(q).jqGrid("getGridParam","url");a(q).jqGrid("setGridParam",{url:b.p.url})}a(q).jqGrid("setGridParam",{search:u}).trigger("reloadGrid",[{page:1}]);v&&a(q).jqGrid("setGridParam",{url:v});a.isFunction(b.p.afterSearch)&&b.p.afterSearch()},
c=function(){var o={},m,n=0,q=a(b.p.gridid)[0],r;a.isFunction(b.p.beforeClear)&&b.p.beforeClear();a.each(b.p.filterModel,function(){r=this.index;m=this.defval?this.defval:"";if(!this.stype)this.stype="text";switch(this.stype){case "select":var w;a("select[name="+r+"] option",b).each(function(C){if(C==0)this.selected=true;if(a(this).text()==m){this.selected=true;w=a(this).val();return false}});if(w){o[r]=w;b.p.marksearched&&a("#jqgh_"+this.name,q.grid.hDiv).addClass("dirty-cell");n++}else{b.p.marksearched&&
a("#jqgh_"+this.name,q.grid.hDiv).removeClass("dirty-cell");try{delete q.p.postData[this.index]}catch(z){}}break;case "text":a("input[name="+r+"]",b).val(m);if(m){o[r]=m;b.p.marksearched&&a("#jqgh_"+this.name,q.grid.hDiv).addClass("dirty-cell");n++}else{b.p.marksearched&&a("#jqgh_"+this.name,q.grid.hDiv).removeClass("dirty-cell");try{delete q.p.postData[this.index]}catch(D){}}break}});var u=n>0?true:false;a.extend(q.p.postData,o);var v;if(b.p.url){v=a(q).jqGrid("getGridParam","url");a(q).jqGrid("setGridParam",
{url:b.p.url})}a(q).jqGrid("setGridParam",{search:u}).trigger("reloadGrid",[{page:1}]);v&&a(q).jqGrid("setGridParam",{url:v});a.isFunction(b.p.afterClear)&&b.p.afterClear()},l=a("<form name='SearchForm' style=display:inline;' class='"+this.p.formclass+"'></form>"),k=a("<table class='"+this.p.tableclass+"' cellspacing='0' cellpading='0' border='0'><tbody></tbody></table>");a(l).append(k);(function(){var o=document.createElement("tr"),m,n,q,r;b.p.formtype=="horizontal"&&a(k).append(o);a.each(b.p.filterModel,
function(u){q=document.createElement("td");a(q).append("<label for='"+this.name+"'>"+this.label+"</label>");r=document.createElement("td");var v=this;if(!this.stype)this.stype="text";switch(this.stype){case "select":if(this.surl)a(r).load(this.surl,function(){v.defval&&a("select",this).val(v.defval);a("select",this).attr({name:v.index||v.name,id:"sg_"+v.name});v.sopt&&a("select",this).attr(v.sopt);b.p.gridToolbar===true&&v.width&&a("select",this).width(v.width);b.p.autosearch===true&&a("select",this).change(function(){j();
...
"selected";z.appendChild(D)}b.p.gridToolbar===true&&v.width&&a(z).width(v.width);a(r).append(z);b.p.autosearch===true&&a(z).change(function(){j();return false})}break;case "text":z=this.defval?this.defval:"";a(r).append("<input type='text' name='"+(this.index||this.name)+"' id='sg_"+this.name+"' value='"+z+"'/>");v.sopt&&a("input",r).attr(v.sopt);if(b.p.gridToolbar===true&&v.width)a.browser.msie?a("input",r).width(v.width-4):a("input",r).width(v.width-2);b.p.autosearch===true&&a("input",r).keypress(function(y){if((y.charCode?
y.charCode:y.keyCode?y.keyCode:0)==13){j();return false}return this});break}if(b.p.formtype=="horizontal"){b.p.gridToolbar===true&&b.p.gridNames===false?a(o).append(r):a(o).append(q).append(r);a(o).append(r)}else{m=document.createElement("tr");a(m).append(q).append(r);a(k).append(m)}});r=document.createElement("td");if(b.p.enableSearch===true){n="<input type='button' id='sButton' class='"+b.p.buttonclass+"' value='"+b.p.searchButton+"'/>";a(r).append(n);a("input#sButton",r).click(function(){j();return false})}if(b.p.enableClear===
true){n="<input type='button' id='cButton' class='"+b.p.buttonclass+"' value='"+b.p.clearButton+"'/>";a(r).append(n);a("input#cButton",r).click(function(){c();return false})}if(b.p.enableClear===true||b.p.enableSearch===true)if(b.p.formtype=="horizontal")a(o).append(r);else{m=document.createElement("tr");a(m).append("<td>&#160;</td>").append(r);a(k).append(m)}})();a(this).append(l);this.triggerSearch=j;this.clearSearch=c}else alert("Could not get grid colModel")}else alert("No target grid is set!")})},
...
this.searchoptions.sopt[0]:"bw";switch(this.stype){case "select":if(l=a("select[name="+k+"]",b.grid.hDiv).val()){j[k]=l;o[k]=v;c++}else try{delete b.p.postData[k]}catch(w){}break;case "text":if(l=a("input[name="+k+"]",b.grid.hDiv).val()){j[k]=l;o[k]=v;c++}else try{delete b.p.postData[k]}catch(z){}break}});var m=c>0?true:false;if(d.stringResult){var n='{"groupOp":"'+d.groupOp+'","rules":[',q=0;a.each(j,function(v,w){if(q>0)n+=",";n+='{"field":"'+v+'",';n+='"op":"'+o[v]+'",';n+='"data":"'+w+'"}';q++});
n+="]}";a.extend(b.p.postData,{filters:n})}else a.extend(b.p.postData,j);var r;if(b.p.searchurl){r=b.p.url;a(b).jqGrid("setGridParam",{url:b.p.searchurl})}var u=false;if(a.isFunction(d.beforeSearch))u=d.beforeSearch.call(b);u||a(b).jqGrid("setGridParam",{search:m}).trigger("reloadGrid",[{page:1}]);r&&a(b).jqGrid("setGridParam",{url:r});a.isFunction(d.afterSearch)&&d.afterSearch()},g=a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),h;a.each(b.p.colModel,function(){var j=this,c,l,k,o;l=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+
...
k>0?true:false;if(d.stringResult){var n='{"groupOp":"'+d.groupOp+'","rules":[',q=0;a.each(c,function(v,w){if(q>0)n+=",";n+='{"field":"'+v+'",';n+='"op":"eq",';n+='"data":"'+w+'"}';q++});n+="]}";a.extend(b.p.postData,{filters:n})}else a.extend(b.p.postData,c);var r;if(b.p.searchurl){r=b.p.url;a(b).jqGrid("setGridParam",{url:b.p.searchurl})}var u=false;if(a.isFunction(d.beforeClear))u=d.beforeClear.call(b);u||j&&a(b).jqGrid("setGridParam",{search:m}).trigger("reloadGrid",[{page:1}]);r&&a(b).jqGrid("setGridParam",
{url:r});a.isFunction(d.afterClear)&&d.afterClear()};this.toggleToolbar=function(){var j=a("tr.ui-search-toolbar",b.grid.hDiv);j.css("display")=="none"?j.show():j.hide()}})}})})(jQuery);
