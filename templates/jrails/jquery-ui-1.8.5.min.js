...
this.collapsePanel=this.headerBox.children(":first").addClass(f.collapsePnlClass);this.collapseButton=this.collapsePanel.children(":first").addClass(f.slideLIcon);this.iconBtnClpsd=f.slideLIconClpsd;this.iconBtn=f.slideLIcon;this.ctrlBox=this.rightBox;break;default:this.headerBox.prepend("<span><span/></span>");this.collapseButton=this.headerBox.children(":first").addClass(f.headerIcon);this.iconBtnClpsd=f.headerIconClpsd;this.iconBtn=f.headerIcon;this.ctrlBox=this.controlsBox;break}this._buttonHover(this.collapseButton);
...
d.close(m,true);a(m.target).parents("li:eq(0)").trigger("mouseup");break;case a.ui.keyCode.TAB:l=true;d.close(m,true);break;case a.ui.keyCode.ESCAPE:l=false;d.close(m,true);break;default:l=false;d._typeAhead(m.keyCode,"focus");break}return l});if(f.style=="dropdown"){this.newelement.addClass(d.widgetBaseClass+"-dropdown");this.list.addClass(d.widgetBaseClass+"-menu-dropdown")}else{this.newelement.addClass(d.widgetBaseClass+"-popup");this.list.addClass(d.widgetBaseClass+"-menu-popup")}this.newelement.prepend('<span class="'+
