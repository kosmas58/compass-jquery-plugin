/*
 ...
 Since: Mar 2010
 Date: Sun Sep 11 12:08:48 +0200 2011
...
(function(b){function p(b,c){var a=Math.pow(10,c);return Math.round(b*a)/a}function k(b,c){var a=parseInt(b.css(c),10);return a?a:(a=b[0].currentStyle)&&a.width&&parseInt(a.width,10)}function h(b){return(b=b.data("events"))&&b.onSlide}function a(c,a){function d(b,f,n,q){n===void 0?n=f/t*D:q&&(n-=a.min);y&&(n=Math.round(n/y)*y);if(f===void 0||y)f=n*t/D;if(isNaN(n))return j;f=Math.max(0,Math.min(f,t));n=f/t*D;if(q||!r)n+=a.min;r&&(q?f=t-f:n=a.max-n);var n=p(n,A),g=b.type=="click";if(u&&z!==void 0&&
!g&&(b.type="onSlide",B.trigger(b,[n,f]),b.isDefaultPrevented()))return j;q=g?a.speed:0;g=g?function(){b.type="change";B.trigger(b,[n])}:null;r?(o.animate({top:f},q,g),a.progress&&J.animate({height:t-f+o.width()/2},q)):(o.animate({left:f},q,g),a.progress&&J.animate({width:f+o.width()/2},q));z=n;c.val(n);return j}function g(){(r=a.vertical||k(s,"height")>k(s,"width"))?(t=k(s,"height")-k(o,"height"),l=s.offset().top+t):(t=k(s,"width")-k(o,"width"),l=s.offset().left)}function n(){g();j.setValue(a.value!==
...
var d=a.attr("min");return parseFloat(b)>=parseFloat(d)?!0:[d]});e.fn("[required]","Please complete this mandatory field.",function(a,b){return a.is(":checkbox")?a.is(":checked"):!!b});e.fn("[pattern]",function(a){return RegExp("^"+a.attr("pattern")+"$").test(a.val())});b.fn.validator=function(a){var c=this.data("validator");c&&(c.destroy(),this.removeData("validator"));a=b.extend(!0,{},e.conf,a);return this.is("form")?this.each(function(){var d=b(this);c=new h(d.find(":input"),d,a);d.data("validator",
