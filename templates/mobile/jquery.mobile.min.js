 ...
 */
(function($,e,b){var c="hashchange",h=document,f,g=$.event.special,i=h.documentMode,d="on"+c in e&&(i===b||i>7);function a(j){j=j||location.href;return"#"+j.replace(/^[^#]*#?(.*)$/,"$1")}$.fn[c]=function(j){return j?this.bind(c,j):this.trigger(c)};$.fn[c].delay=50;g[c]=$.extend(g[c],{setup:function(){if(d){return false}$(f.start)},teardown:function(){if(d){return false}$(f.stop)}});f=(function(){var j={},p,m=a(),k=function(q){return q},l=k,o=k;j.start=function(){p||n()};j.stop=function(){p&&clearTimeout(p);p=b};function n(){var r=a(),q=o(m);if(r!==m){l(m=r,q);$(e).trigger(c)}else{if(q!==m){location.href=location.href.replace(/#.*/,"")+q}}p=setTimeout(n,$.fn[c].delay)}$.browser.msie&&!d&&(function(){var q,r;j.start=function(){if(!q){r=$.fn[c].src;r=r&&r+a();q=$('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){r||l(a());n()}).attr("src",r||"javascript:0").insertAfter("body")[0].contentWindow;h.onpropertychange=function(){try{if(event.propertyName==="title"){q.document.title=h.title}}catch(s){}}}};j.stop=k;o=function(){return a(q.location.href)};l=function(v,s){var u=q.document,t=$.fn[c].domain;if(v!==s){u.title=h.title;u.open();t&&u.write('<script>document.domain="'+t+'"<\/script>');u.close();q.location.hash=v}}})();return j})()})(jQuery,this);(function(a,b){a.widget("mobile.page",a.mobile.widget,{options:{backBtnText:"Back",addBackBtn:true,degradeInputs:{color:false,date:false,datetime:false,"datetime-local":false,email:false,month:false,number:false,range:"number",search:true,tel:false,time:false,url:false,week:false},keepNative:null},_create:function(){var c=this.element,e=this.options;this.keepNative=":jqmData(role='none'), :jqmData(role='nojs')"+(e.keepNative?", "+e.keepNative:"");if(this._trigger("beforeCreate")===false){return}c.find(":jqmData(role='page'), :jqmData(role='content')").andSelf().each(function(){a(this).addClass("ui-"+a(this).jqmData(a.mobile.ns+"role"))});c.find("[data-"+a.mobile.ns+"role='nojs']").addClass("ui-nojs");var d=c.find(":jqmData(role)").andSelf().each(function(){var j=a(this),k=j.jqmData("role"),i=j.jqmData("theme");if(k==="header"||k==="footer"){j.addClass("ui-bar-"+(i||j.parent(":jqmData(role='page')").jqmData("theme")||"a"));j.attr("role",k==="header"?"banner":"contentinfo");var f=j.children("a"),g=f.hasClass("ui-btn-left"),h=f.hasClass("ui-btn-right");if(!g){g=f.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length}if(!h){h=f.eq(1).addClass("ui-btn-right").length}if(e.addBackBtn&&k==="header"&&a(".ui-page").length>1&&c.jqmData("url")!==a.mobile.path.stripHash(location.hash)&&!g&&j.jqmData("backbtn")!==false){a("<a href='#' class='ui-btn-left' data-"+a.mobile.ns+"rel='back' data-"+a.mobile.ns+"icon='arrow-l'>"+e.backBtnText+"</a>").prependTo(j)}j.children("h1, h2, h3, h4, h5, h6").addClass("ui-title").attr({tabindex:"0",role:"heading","aria-level":"1"})}else{if(k==="content"){if(i){j.addClass("ui-body-"+i)}j.attr("role","main")}else{if(k==="page"){j.addClass("ui-body-"+(i||"c"))}}}switch(k){case"header":case"footer":case"page":case"content":j.addClass("ui-"+k);break;case"collapsible":case"fieldcontain":case"navbar":case"listview":case"dialog":j[k]();break}});this._enhanceControls();c.find(":jqmData(role='button'), .ui-bar > a, .ui-header > a, .ui-footer > a").not(".ui-btn").not(this.keepNative).buttonMarkup();c.find(":jqmData(role='controlgroup')").controlgroup();c.find("a:not(.ui-btn):not(.ui-link-inherit)").not(this.keepNative).addClass("ui-link");c.fixHeaderFooter()},_typeAttributeRegex:/\s+type=["']?\w+['"]?/,_enhanceControls:function(){var e=this.options,c=this;this.element.find("input").not(this.keepNative).each(function(){var i=this.getAttribute("type"),h=e.degradeInputs[i]||"text";if(e.degradeInputs[i]){a(this).replaceWith(a("<div>").html(a(this).clone()).html().replace(c._typeAttributeRegex,' type="'+h+'" data-'+a.mobile.ns+'type="'+i+'" '))}});var g=this.element.find("input, textarea, select, button"),d=g.not(this.keepNative);var f=g.filter("input[type=text]");if(f.length&&typeof f[0].autocorrect!=="undefined"){f.each(function(){this.setAttribute("autocorrect","off");this.setAttribute("autocomplete","off")})}d.filter("[type='radio'], [type='checkbox']").checkboxradio();d.filter("button, [type='button'], [type='submit'], [type='reset'], [type='image']").button();d.filter("input, textarea").not("[type='radio'], [type='checkbox'], [type='button'], [type='submit'], [type='reset'], [type='image'], [type='hidden']").textinput();d.filter("input, select").filter(":jqmData(role='slider'), :jqmData(type='range')").slider();d.filter("select:not(:jqmData(role='slider'))").selectmenu()}})})(jQuery);
/*!
