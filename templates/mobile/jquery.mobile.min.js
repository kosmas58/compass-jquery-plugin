...
!0,j.set(p);var A=c.jqmData("title")||c.children(":jqmData(role='header')").find(".ui-title").text();A&&z==document.title&&(z=A);v||l.addNew(p,h.transition,z,o,h.role);document.title=l.getActive().title;a.mobile.activePage=c;h.transition=h.transition||(v&&!w?x.transition:d)||(y?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);h.reverse=h.reverse||v<0;e(c,m,h.transition,h.reverse).done(function(){b();h.duplicateCachedPage&&h.duplicateCachedPage.remove();q.removeClass("ui-mobile-rendering");
