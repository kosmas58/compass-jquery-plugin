 ...
 * http://jquery.org/license
 */
(function(c,b,d){c.extend(c.mobile,{ns:"",subPageUrlKey:"ui-page",nonHistorySelectors:"dialog",activePageClass:"ui-page-active",activeBtnClass:"ui-btn-active",ajaxEnabled:true,hashListeningEnabled:true,ajaxLinksEnabled:true,ajaxFormsEnabled:true,defaultTransition:"slide",loadingMessage:"loading",pageLoadErrorMessage:"Error Loading Page",gradeA:function(){return c.support.mediaquery||c.mobile.browser.ie&&c.mobile.browser.ie>=7},keyCode:{ALT:18,BACKSPACE:8,CAPS_LOCK:20,COMMA:188,COMMAND:91,COMMAND_LEFT:91,COMMAND_RIGHT:93,CONTROL:17,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,INSERT:45,LEFT:37,MENU:93,NUMPAD_ADD:107,NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:106,NUMPAD_SUBTRACT:109,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SHIFT:16,SPACE:32,TAB:9,UP:38,WINDOWS:91},silentScroll:function(e){e=e||0;c.event.special.scrollstart.enabled=false;setTimeout(function(){b.scrollTo(0,e);c(document).trigger("silentscroll",{x:0,y:e})},20);setTimeout(function(){c.event.special.scrollstart.enabled=true},150)},normalizeRegex:/-([a-z])/g,nsNormalize:function(e){if(!e){return}return(c.mobile.ns+e).replace(this.normalizeRegex,function(g,f){return f.toUpperCase()})}});c.fn.jqmData=function(f,e){return this.data(f?c.mobile.nsNormalize(f):f,e)};c.jqmData=function(e,g,f){return c.data(e,c.mobile.nsNormalize(g),f)};c.fn.jqmRemoveData=function(e){return this.removeData(c.mobile.nsNormalize(e))};c.jqmRemoveData=function(e,f){return c.removeData(e,c.mobile.nsNormalize(f))};c.jqmHasData=function(e,f){return c.hasData(e,c.mobile.nsNormalize(f))};var a=c.find;c.find=function(f,h,g,e){f=f.replace(/:jqmData\(([^)]*)\)/g,"[data-"+(c.mobile.ns||"")+"$1]");return a.call(this,f,h,g,e)};c.extend(c.find,a);c.find.matches=function(e,f){return c.find(e,null,null,f)};c.find.matchesSelector=function(e,f){return c.find(f,null,null,[e]).length>0}})(jQuery,this);(function(c,f){var l=c(window),o=c("html"),j=c("head"),m={get:function(v){if(v===f){v=location.hash}return m.stripHash(v).replace(/[^\/]*\.[^\/*]+$/,"")},getFilePath:function(w){var v="&"+c.mobile.subPageUrlKey;return w&&w.split(v)[0].split(t)[0]},set:function(v){location.hash=v},origin:"",setOrigin:function(){m.origin=m.get(location.protocol+"//"+location.host+location.pathname)},makeAbsolute:function(w){var v=m.isPath(location.hash);if(m.isQuery(w)){return(v?m.cleanHash(location.hash):location.pathname)+w}return(v?m.get():m.get(location.pathname))+w},isPath:function(v){return(/\//).test(v)},isQuery:function(v){return(/^\?/).test(v)},clean:function(v){var w=new RegExp("^"+location.protocol+"//"+location.host);return v.replace(w,"")},stripHash:function(v){return v.replace(/^#/,"")},cleanHash:function(v){return m.stripHash(v.replace(/\?.*$/,"").replace(t,""))},isExternal:function(v){return m.hasProtocol(m.clean(v))},hasProtocol:function(v){return(/^(:?\w+:)/).test(v)},isRelative:function(v){return(/^[^\/|#]/).test(v)&&!m.hasProtocol(v)},isEmbeddedPage:function(v){return(/^#/).test(v)}},u=null,b={stack:[],activeIndex:0,getActive:function(){return b.stack[b.activeIndex]},getPrev:function(){return b.stack[b.activeIndex-1]},getNext:function(){return b.stack[b.activeIndex+1]},addNew:function(w,y,x,v){if(b.getNext()){b.clearForward()}b.stack.push({url:w,transition:y,title:x,page:v});b.activeIndex=b.stack.length-1},clearForward:function(){b.stack=b.stack.slice(0,b.activeIndex+1)},directHashChange:function(x){var v,w,y;c.each(b.stack,function(z,A){if(x.currentUrl===A.url){v=z<b.activeIndex;w=!v;y=z}});this.activeIndex=y!==f?y:this.activeIndex;if(v){x.isBack()}else{if(w){x.isForward()}}},ignoreNextHashChange:true},p="[tabindex],a,button:visible,select:visible,input",a=null,k=[],q=false,t="&ui-state=dialog",i=j.children("base"),e=location.protocol+"//"+location.host,n=e+location.pathname;if(i.length){var r=i.attr("href");if(r){if(r.search(/^[^:\/]+:\/\/[^\/]+\/?/)===-1){e=e+r}else{e=r}}e=e+(e.charAt(e.length-1)==="/"?" ":"/")}var d=c.support.dynamicBaseTag?{element:(i.length?i:c("<base>",{href:n}).prependTo(j)),set:function(v){d.element.attr("href",e+m.get(v))},reset:function(){d.element.attr("href",n)}}:f;m.setOrigin();function h(w){var x=w.jqmData("lastClicked");if(x&&x.length){x.focus()}else{var v=w.find(".ui-title:eq(0)");if(v.length){v.focus()}else{w.find(p).eq(0).focus()}}}function s(v){if(!!u&&(!u.closest(".ui-page-active").length||v)){u.removeClass(c.mobile.activeBtnClass)}u=null}c.fn.animationComplete=function(v){if(c.support.cssTransitions){return c(this).one("webkitAnimationEnd",v)}else{setTimeout(v,0);return c(this)}};c.mobile.updateHash=m.set;c.mobile.path=m;c.mobile.base=d;c.mobile.urlstack=b.stack;c.mobile.urlHistory=b;c.mobile.noneTransitionHandler=function(w,v,y,x){if(x){x.removeClass(c.mobile.activePageClass)}y.addClass(c.mobile.activePageClass);return c.Deferred().resolve(w,v,y,x).promise()};c.mobile.defaultTransitionHandler=c.mobile.noneTransitionHandler;c.mobile.transitionHandlers={none:c.mobile.defaultTransitionHandler};c.mobile.allowCrossDomainPages=false;c.mobile.changePage=function(w,R,G,K,x){var y=c.type(w),A=y==="array",Q=y==="object",O=A?w[0]:c.mobile.activePage;w=A?w[1]:w;var B=c.type(w)==="string"?m.stripHash(w):"",I=B,T,z="get",L=false,F=null,D=b.getActive(),M=false,H=false,C=document.title;if(b.stack.length>0&&D.page.jqmData("url")===B&&!A&&!Q){return}else{if(q){k.unshift(arguments);return}}q=true;if(x){b.directHashChange({currentUrl:B,isBack:function(){H=!(M=true);G=true;R=R||D.transition},isForward:function(){H=!(M=false);R=R||b.getActive().transition}})}if(Q&&w.url){B=w.url;T=w.data;z=w.type;L=true;if(T&&z==="get"){if(c.type(T)==="object"){T=c.param(T)}B+="?"+T;T=f}}if(d){d.reset()}c(window.document.activeElement||"").add("input:focus, textarea:focus, select:focus").blur();function E(){if(R===f){R=(a&&a==="dialog")?"pop":c.mobile.defaultTransition}}function J(){q=false;if(k.length>0){c.mobile.changePage.apply(c.mobile,k.pop())}}function P(){c.mobile.silentScroll();var V=l.scrollTop();if(B.indexOf("&"+c.mobile.subPageUrlKey)>-1){w=c(":jqmData(url='"+B+"')")}if(O){O.jqmData("lastScroll",V).jqmData("lastClicked",u);O.data("page")._trigger("beforehide",null,{nextPage:w})}w.data("page")._trigger("beforeshow",null,{prevPage:O||c("")});function X(){if(K!==false&&B){b.ignoreNextHashChange=false;m.set(B)}var Y=w.jqmData("title")||w.find(":jqmData(role='header') .ui-title").text();if(!!Y&&C===document.title){C=Y}if(!M&&!H){b.addNew(B,R,C,w)}document.title=b.getActive().title;s();c.mobile.silentScroll(w.jqmData("lastScroll"));c(document).one("silentscroll",function(){h(w)});if(O){O.data("page")._trigger("hide",null,{nextPage:w})}w.data("page")._trigger("show",null,{prevPage:O||c("")});c.mobile.activePage=w;if(F!==null){F.remove()}o.removeClass("ui-mobile-rendering");J()}c.mobile.pageLoading(true);var W=c.mobile.transitionHandlers[R||"none"]||c.mobile.defaultTransitionHandler,U=W(R,G,w,O);U.done(function(){X()})}function N(){if(a||w.jqmData("role")==="dialog"){B=b.getActive().url+t;if(a){w.attr("data-"+c.mobile.ns+"role",a);a=null}}w.page()}if(B){w=c(":jqmData(url='"+B+"')");I=m.getFilePath(B)}else{var v=w.attr("data-"+c.mobile.ns+"url"),S=m.getFilePath(v);if(v!==S){I=S}}E();if(w.length&&!L){if(I&&d){d.set(I)}N();P()}else{if(w.length){F=w}c.mobile.pageLoading();c.ajax({url:I,type:z,data:T,dataType:"html",success:function(X){var Y=c("<div></div>"),V,U=X.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,aa=new RegExp("(<[^>]+\\bdata-"+c.mobile.ns+"role=[\"']?page[\"']?[^>]*>)"),W=new RegExp("\\bdata-"+c.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");if(aa.test(X)&&RegExp.$1&&W.test(RegExp.$1)&&RegExp.$1){V=RegExp.$1}if(V){if(d){d.set(V)}B=I=m.getFilePath(V)}else{if(d){d.set(I)}}Y.get(0).innerHTML=X;w=Y.find(":jqmData(role='page'), :jqmData(role='dialog')").first();if(U){C=U}if(!c.support.dynamicBaseTag){var Z=m.get(I);w.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var ad=["href","src","action"],ag=f,af=f;for(var ae=0;ae<ad.length;ae++){var ab=ad[ae],ac=c(this).attr(ab);if(ac){ag=ab;af=ac;break}}if(ag&&af){af=af.replace(location.protocol+"//"+location.host+location.pathname,"");if(!/^(\w+:|#|\/)/.test(af)){c(this).attr(ag,Z+af)}}})}w.attr("data-"+c.mobile.ns+"url",I).appendTo(c.mobile.pageContainer);N();setTimeout(function(){P()},0)},error:function(){c.mobile.pageLoading(true);s(true);if(d){d.set(m.get())}J();c("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>"+c.mobile.pageLoadErrorMessage+"</h1></div>").css({display:"block",opacity:0.96,top:c(window).scrollTop()+100}).appendTo(c.mobile.pageContainer).delay(800).fadeOut(400,function(){c(this).remove()})}})}};c("form").live("submit",function(x){if(!c.mobile.ajaxEnabled||!c.mobile.ajaxFormsEnabled||c(this).is(":jqmData(ajax='false')")){return}var w=c(this).attr("method"),v=m.clean(c(this).attr("action")),y=c(this).attr("target");if(m.isExternal(v)||y){return}if(m.isRelative(v)){v=m.makeAbsolute(v)}c.mobile.changePage({url:v.length&&v||m.get(),type:w.length&&w.toLowerCase()||"get",data:c(this).serialize()},c(this).jqmData("transition"),c(this).jqmData("direction"),true);x.preventDefault()});function g(v){while(v){if(v.nodeName.toLowerCase()==="a"){break}v=v.parentNode}return v}c(document).bind("vclick",function(x){var w=g(x.target);if(w){var v=m.clean(w.getAttribute("href")||"#");if(v!=="#"&&v.replace(m.get(),"")!=="#"){c(w).closest(".ui-btn").not(".ui-disabled").addClass(c.mobile.activeBtnClass)}}});c(document).bind("click",function(w){var I=g(w.target);if(!I){return}var D=c(I),y=D.attr("href")||"#",C=m.hasProtocol(y),x=m.clean(y),z=D.is("[rel='external']"),H=m.isEmbeddedPage(x),G=(c.mobile.allowCrossDomainPages&&location.protocol==="file:"&&x.search(/^https?:/)!==-1),v=(m.isExternal(x)&&!G)||(z&&!H),F=D.is("[target]"),A=D.is(":jqmData(ajax='false')");if(D.is(":jqmData(rel='back')")){window.history.back();return false}if(x.replace(m.get(),"")==="#"){w.preventDefault();return}u=D.closest(".ui-btn");if(v||A||F||!c.mobile.ajaxEnabled||!c.mobile.ajaxLinksEnabled){window.setTimeout(function(){s(true)},200);return}var E=D.jqmData("transition"),J=D.jqmData("direction"),B=(J&&J==="reverse")||D.jqmData("back");a=D.attr("data-"+c.mobile.ns+"rel");if(m.isRelative(x)&&!C){x=m.makeAbsolute(x)}x=m.stripHash(x);c.mobile.changePage(x,E,B);w.preventDefault()});l.bind("hashchange",function(x,v){var z=m.stripHash(location.hash),y=c.mobile.urlHistory.stack.length===0?false:f;if(!c.mobile.hashListeningEnabled||!b.ignoreNextHashChange){if(!b.ignoreNextHashChange){b.ignoreNextHashChange=true}return}if(b.stack.length>1&&z.indexOf(t)>-1){if(!c.mobile.activePage.is(".ui-dialog")){b.directHashChange({currentUrl:z,isBack:function(){window.history.back()},isForward:function(){window.history.forward()}});return}else{var w=function(){z=c.mobile.urlHistory.getActive().page};b.directHashChange({currentUrl:z,isBack:w,isForward:w})}}if(z){c.mobile.changePage(z,y,f,false,true)}else{c.mobile.changePage(c.mobile.firstPage,y,true,false,true)}})})(jQuery);
/*!
 * jQuery Mobile v1.0a4.1
 * http://jquerymobile.com/
 *
 ...
 * http://jquery.org/license
 */
(function(e,d,g){var b=e("html"),a=e("head"),f=e(d);e(d.document).trigger("mobileinit");if(!e.mobile.gradeA()){return}b.addClass("ui-mobile ui-mobile-rendering");var c=e.mobile.loadingMessage?e("<div class='ui-loader ui-body-a ui-corner-all'><span class='ui-icon ui-icon-loading spin'></span><h1>"+e.mobile.loadingMessage+"</h1></div>"):g;e.extend(e.mobile,{pageLoading:function(h){if(h){b.removeClass("ui-loading")}else{if(e.mobile.loadingMessage){var i=e("."+e.mobile.activeBtnClass).first();c.appendTo(e.mobile.pageContainer).css({top:e.support.scrollTop&&e(d).scrollTop()+e(d).height()/2||i.length&&i.offset().top||100})}b.addClass("ui-loading")}},initializePage:function(){var h=e(":jqmData(role='page')");h.add(":jqmData(role='dialog')").each(function(){var i=e(this);if(!i.jqmData("url")){i.attr("data-"+e.mobile.ns+"url",i.attr("id"))}});e.mobile.firstPage=h.first();e.mobile.pageContainer=h.first().parent().addClass("ui-mobile-viewport");e.mobile.pageLoading();if(!e.mobile.hashListeningEnabled||!e.mobile.path.stripHash(location.hash)){e.mobile.changePage(e.mobile.firstPage,false,true,false,true)}else{f.trigger("hashchange",[true])}}});e(e.mobile.initializePage);f.load(e.mobile.silentScroll)})(jQuery,this);(function(a){a.themeswitcher=function(){if(a("[data-"+a.mobile.ns+"-url=themeswitcher]").length){return}var c="/stylesheets/compiled/jquery/mobile/",b=["default","valencia"],d=a.mobile.activePage,e=a("<div data-"+a.mobile.ns+'url="themeswitcher" data-'+a.mobile.ns+"role='dialog' data-"+a.mobile.ns+"theme='a'><div data-"+a.mobile.ns+"role='header' data-"+a.mobile.ns+"theme='b'><div class='ui-title'>Switch Theme:</div></div><div data-"+a.mobile.ns+"role='content' data-"+a.mobile.ns+"theme='c'><ul data-"+a.mobile.ns+"role='listview' data-"+a.mobile.ns+"inset='true'></ul></div></div>").appendTo(a.mobile.pageContainer),g=e.find("ul");a.each(b,function(h){a('<li><a href="#" data-'+a.mobile.ns+'rel="back">'+b[h].charAt(0).toUpperCase()+b[h].substr(1)+"</a></li>").click(function(){f(b[h]);return false}).appendTo(g)});function f(h){a("head").append("<link rel='stylesheet' href='"+c+h+".css' />")}e.page()}})(jQuery);