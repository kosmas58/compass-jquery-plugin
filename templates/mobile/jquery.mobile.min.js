 ...
 * http://jquery.org/license
 */
(function(c,b,d){c.extend(c.mobile,{ns:"",subPageUrlKey:"ui-page",nonHistorySelectors:"dialog",activePageClass:"ui-page-active",activeBtnClass:"ui-btn-active",ajaxEnabled:true,hashListeningEnabled:true,defaultPageTransition:"slide",defaultDialogTransition:"pop",loadingMessage:"loading",pageLoadErrorMessage:"Error Loading Page",gradeA:function(){return c.support.mediaquery||c.mobile.browser.ie&&c.mobile.browser.ie>=7},keyCode:{ALT:18,BACKSPACE:8,CAPS_LOCK:20,COMMA:188,COMMAND:91,COMMAND_LEFT:91,COMMAND_RIGHT:93,CONTROL:17,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,INSERT:45,LEFT:37,MENU:93,NUMPAD_ADD:107,NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:106,NUMPAD_SUBTRACT:109,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SHIFT:16,SPACE:32,TAB:9,UP:38,WINDOWS:91},silentScroll:function(e){e=e||0;c.event.special.scrollstart.enabled=false;setTimeout(function(){b.scrollTo(0,e);c(document).trigger("silentscroll",{x:0,y:e})},20);setTimeout(function(){c.event.special.scrollstart.enabled=true},150)},normalizeRegex:/-([a-z])/g,nsNormalize:function(e){if(!e){return}return c.camelCase(c.mobile.ns+e)}});c.fn.jqmData=function(f,e){return this.data(f?c.mobile.nsNormalize(f):f,e)};c.jqmData=function(e,g,f){return c.data(e,c.mobile.nsNormalize(g),f)};c.fn.jqmRemoveData=function(e){return this.removeData(c.mobile.nsNormalize(e))};c.jqmRemoveData=function(e,f){return c.removeData(e,c.mobile.nsNormalize(f))};c.jqmHasData=function(e,f){return c.hasData(e,c.mobile.nsNormalize(f))};var a=c.find;c.find=function(f,h,g,e){f=f.replace(/:jqmData\(([^)]*)\)/g,"[data-"+(c.mobile.ns||"")+"$1]");return a.call(this,f,h,g,e)};c.extend(c.find,a);c.find.matches=function(e,f){return c.find(e,null,null,f)};c.find.matchesSelector=function(e,f){return c.find(f,null,null,[e]).length>0}})(jQuery,this);(function(e,g){var m=e(window),p=e("html"),k=e("head"),o={urlParseRE:/^(((([^:\/#\?]+:)?(?:\/\/((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?]+)(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,parseUrl:function(z){if(typeof z==="object"){return z}var y=z||"",B=o.urlParseRE.exec(z),A;if(B){A={href:B[0]||"",hrefNoHash:B[1]||"",hrefNoSearch:B[2]||"",domain:B[3]||"",protocol:B[4]||"",authority:B[5]||"",username:B[7]||"",password:B[8]||"",host:B[9]||"",hostname:B[10]||"",port:B[11]||"",pathname:B[12]||"",directory:B[13]||"",filename:B[14]||"",search:B[15]||"",hash:B[16]||""}}return A||{}},makePathAbsolute:function(B,A){if(B&&B.charAt(0)==="/"){return B}B=B||"";A=A?A.replace(/^\/|\/?[^\/]*$/g,""):"";var y=A?A.split("/"):[],D=B.split("/");for(var z=0;z<D.length;z++){var C=D[z];switch(C){case".":break;case"..":if(y.length){y.pop()}break;default:y.push(C);break}}return"/"+y.join("/")},isSameDomain:function(z,y){return o.parseUrl(z).domain===o.parseUrl(y).domain},isRelativeUrl:function(y){return o.parseUrl(y).protocol===""},isAbsoluteUrl:function(y){return o.parseUrl(y).protocol!==""},makeUrlAbsolute:function(z,A){if(!o.isRelativeUrl(z)){return z}var C=o.parseUrl(z),F=o.parseUrl(A),G=C.protocol||F.protocol,D=C.authority||F.authority,E=C.pathname!=="",y=o.makePathAbsolute(C.pathname||F.filename,F.pathname),H=C.search||(!E&&F.search)||"",B=C.hash;return G+"//"+D+y+H+B},addSearchParams:function(z,C){var y=o.parseUrl(z),B=(typeof C==="object")?e.param(C):C,A=y.search||"?";return y.hrefNoSearch+A+(A.charAt(A.length-1)!=="?"?"&":"")+B+(y.hash||"")},convertUrlToDataUrl:function(z){var y=o.parseUrl(z);if(o.isEmbeddedPage(y)){return y.hash.replace(/^#/,"")}else{if(o.isSameDomain(y,s)){return y.hrefNoHash.replace(s.domain,"")}}return z},get:function(y){if(y===g){y=location.hash}return o.stripHash(y).replace(/[^\/]*\.[^\/*]+$/,"")},getFilePath:function(z){var y="&"+e.mobile.subPageUrlKey;return z&&z.split(y)[0].split(w)[0]},set:function(y){location.hash=y},isPath:function(y){return(/\//).test(y)},clean:function(y){return y.replace(s.domain,"")},stripHash:function(y){return y.replace(/^#/,"")},cleanHash:function(y){return o.stripHash(y.replace(/\?.*$/,"").replace(w,""))},isExternal:function(z){var y=o.parseUrl(z);return y.protocol&&y.domain!==d.domain?true:false},hasProtocol:function(y){return(/^(:?\w+:)/).test(y)},isEmbeddedPage:function(z){var y=o.parseUrl(z);if(y.protocol!==""){return(y.hash&&(y.hrefNoHash===d.hrefNoHash||(a&&y.hrefNoHash===s.hrefNoHash)))}return(/^#/).test(y.href)}},x=null,c={stack:[],activeIndex:0,getActive:function(){return c.stack[c.activeIndex]},getPrev:function(){return c.stack[c.activeIndex-1]},getNext:function(){return c.stack[c.activeIndex+1]},addNew:function(z,B,A,y){if(c.getNext()){c.clearForward()}c.stack.push({url:z,transition:B,title:A,page:y});c.activeIndex=c.stack.length-1},clearForward:function(){c.stack=c.stack.slice(0,c.activeIndex+1)},directHashChange:function(A){var y,z,B;e.each(c.stack,function(C,D){if(A.currentUrl===D.url){y=C<c.activeIndex;z=!y;B=C}});this.activeIndex=B!==g?B:this.activeIndex;if(y){A.isBack()}else{if(z){A.isForward()}}},ignoreNextHashChange:false},r="[tabindex],a,button:visible,select:visible,input",l=[],t=false,w="&ui-state=dialog",j=k.children("base"),d=o.parseUrl(location.href),s=j.length?o.parseUrl(o.makeUrlAbsolute(j.attr("href"),d.href)):d,a=(d.hrefNoHash!==s.hrefNoHash);var f=e.support.dynamicBaseTag?{element:(j.length?j:e("<base>",{href:s.hrefNoHash}).prependTo(k)),set:function(y){f.element.attr("href",o.makeUrlAbsolute(y,s))},reset:function(){f.element.attr("href",s.hrefNoHash)}}:g;function i(z){var A=z.jqmData("lastClicked");if(A&&A.length){A.focus()}else{var y=z.find(".ui-title:eq(0)");if(y.length){y.focus()}else{z.find(r).eq(0).focus()}}}function v(y){if(!!x&&(!x.closest(".ui-page-active").length||y)){x.removeClass(e.mobile.activeBtnClass)}x=null}function n(){t=false;if(l.length>0){e.mobile.changePage.apply(null,l.pop())}}function u(B,C,E,y){e.mobile.silentScroll();var z=m.scrollTop();if(C){C.jqmData("lastScroll",z).jqmData("lastClicked",x);C.data("page")._trigger("beforehide",null,{nextPage:B})}B.data("page")._trigger("beforeshow",null,{prevPage:C||e("")});e.mobile.hidePageLoadingMsg();var A=e.mobile.transitionHandlers[E||"none"]||e.mobile.defaultTransitionHandler,D=A(E,y,B,C);D.done(function(){e.mobile.silentScroll(B.jqmData("lastScroll")||0);e(document).one("silentscroll",function(){i(B)});if(C){C.data("page")._trigger("hide",null,{nextPage:B})}B.data("page")._trigger("show",null,{prevPage:C||e("")})});return D}function q(y,z){if(z){y.attr("data-"+e.mobile.ns+"role",z)}y.page()}e.fn.animationComplete=function(y){if(e.support.cssTransitions){return e(this).one("webkitAnimationEnd",y)}else{setTimeout(y,0);return e(this)}};e.mobile.updateHash=o.set;e.mobile.path=o;e.mobile.base=f;e.mobile.urlstack=c.stack;e.mobile.urlHistory=c;e.mobile.noneTransitionHandler=function(z,y,B,A){if(A){A.removeClass(e.mobile.activePageClass)}B.addClass(e.mobile.activePageClass);return e.Deferred().resolve(z,y,B,A).promise()};e.mobile.defaultTransitionHandler=e.mobile.noneTransitionHandler;e.mobile.transitionHandlers={none:e.mobile.defaultTransitionHandler};e.mobile.allowCrossDomainPages=false;e.mobile.getDocumentUrl=function(y){return y?e.extend({},d):d.href};e.mobile.getDocumentBase=function(y){return y?e.extend({},s):s.href};e.mobile.loadPage=function(y,G){var F=e.Deferred(),z=e.extend({},e.mobile.loadPage.defaults,G),B=null,E=null,A=o.makeUrlAbsolute(y,s.hrefNoHash);if(z.data&&z.type==="get"){A=o.addSearchParams(A,z.data);z.data=g}var D=o.getFilePath(A),C=o.convertUrlToDataUrl(A);z.pageContainer=z.pageContainer||e.mobile.pageContainer;B=z.pageContainer.children(":jqmData(url='"+C+"')");if(f){f.reset()}if(B.length){if(!z.reloadPage){q(B,z.role);F.resolve(A,G,B);return F.promise()}E=B}if(z.showLoadMsg){e.mobile.showPageLoadingMsg()}e.ajax({url:D,type:z.type,data:z.data,dataType:"html",success:function(J){var K=e("<div></div>"),H=J.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,M=new RegExp(".*(<[^>]+\\bdata-"+e.mobile.ns+"role=[\"']?page[\"']?[^>]*>).*"),I=new RegExp("\\bdata-"+e.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");if(M.test(J)&&RegExp.$1&&I.test(RegExp.$1)&&RegExp.$1){y=D=o.getFilePath(RegExp.$1)}if(f){f.set(D)}K.get(0).innerHTML=J;B=K.find(":jqmData(role='page'), :jqmData(role='dialog')").first();if(H&&!B.jqmData("title")){B.jqmData("title",H)}if(!e.support.dynamicBaseTag){var L=o.get(D);B.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var O=e(this).is("[href]")?"href":e(this).is("[src]")?"src":"action",N=e(this).attr(O);N=N.replace(location.protocol+"//"+location.host+location.pathname,"");if(!/^(\w+:|#|\/)/.test(N)){e(this).attr(O,L+N)}})}B.attr("data-"+e.mobile.ns+"url",o.convertUrlToDataUrl(D)).appendTo(z.pageContainer);q(B,z.role);if(A.indexOf("&"+e.mobile.subPageUrlKey)>-1){B=z.pageContainer.children(":jqmData(url='"+C+"')")}if(z.showLoadMsg){e.mobile.hidePageLoadingMsg()}F.resolve(A,G,B,E)},error:function(){if(f){f.set(o.get())}if(z.showLoadMsg){e.mobile.hidePageLoadingMsg();e("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>"+e.mobile.pageLoadErrorMessage+"</h1></div>").css({display:"block",opacity:0.96,top:m.scrollTop()+100}).appendTo(z.pageContainer).delay(800).fadeOut(400,function(){e(this).remove()})}F.reject(A,G)}});return F.promise()};e.mobile.loadPage.defaults={type:"get",data:g,reloadPage:false,role:g,showLoadMsg:true,pageContainer:g};e.mobile.changePage=function(A,z){if(typeof z!=="object"){var I=null;if(typeof A==="object"&&A.url&&A.type){I={type:A.type,data:A.data,forcePageLoad:true};A=A.url}var K=arguments.length;if(K>1){var P=["transition","reverse","changeHash","fromHashChange"],J;for(J=1;J<K;J++){var N=arguments[J];if(typeof N!=="undefined"){I=I||{};I[P[J-1]]=N}}}if(I){return e.mobile.changePage(A,I)}}if(t){l.unshift(arguments);return}t=true;var L=e.extend({},e.mobile.changePage.defaults,z);L.pageContainer=L.pageContainer||e.mobile.pageContainer;if(typeof A=="string"){e.mobile.loadPage(A,L).done(function(S,R,T,Q){t=false;R.duplicateCachedPage=Q;e.mobile.changePage(T,R)}).fail(function(R,Q){t=false;v(true);n();L.pageContainer.trigger("changepagefailed")});return}var F=L.pageContainer,O=e.mobile.activePage,B=A.jqmData("url"),H=o.getFilePath(B),E=c.getActive(),y=c.activeIndex===0,G=0,C=document.title,D=L.role==="dialog"||A.jqmData("role")==="dialog";F.trigger("beforechangepage");if(O&&O[0]===A[0]){t=false;F.trigger("changepage");return}q(A,L.role);if(L.fromHashChange){c.directHashChange({currentUrl:B,isBack:function(){G=-1},isForward:function(){G=1}})}e(document.activeElement||"").add("input:focus, textarea:focus, select:focus").blur();if(D&&E){B=E.url+w}if(L.changeHash!==false&&B){c.ignoreNextHashChange=true;o.set(B)}var M=A.jqmData("title")||A.children(":jqmData(role='header')").find(".ui-title").text();if(!!M&&C==document.title){C=M}if(!G){c.addNew(B,L.transition,C,A)}document.title=c.getActive().title;e.mobile.activePage=A;L.transition=L.transition||((G&&!y)?E.transition:g)||(L.role==="dialog"?e.mobile.defaultDialogTransition:e.mobile.defaultPageTransition);L.reverse=L.reverse||G<0;u(A,O,L.transition,L.reverse).done(function(){v();if(L.duplicateCachedPage){L.duplicateCachedPage.remove()}p.removeClass("ui-mobile-rendering");n();F.trigger("changepage")})};e.mobile.changePage.defaults={transition:g,reverse:false,changeHash:true,fromHashChange:false,role:g,duplicateCachedPage:g,pageContainer:g};e("form").live("submit",function(A){var B=e(this);if(!e.mobile.ajaxEnabled||B.is(":jqmData(ajax='false')")){return}var z=B.attr("method"),y=o.makeUrlAbsolute(B.attr("action"),b(B));target=B.attr("target");if(o.isExternal(y)||target){return}e.mobile.changePage(y,{type:z.length&&z.toLowerCase()||"get",data:B.serialize(),transition:B.jqmData("transition"),direction:B.jqmData("direction"),reloadPage:true});A.preventDefault()});function h(y){while(y){if(y.nodeName.toLowerCase()=="a"){break}y=y.parentNode}return y}function b(A){var y=e(A).closest(".ui-page").jqmData("url"),z=s.hrefNoHash;if(!y||!o.isPath(y)){y=z}return o.makeUrlAbsolute(y,z)}e(document).bind("vclick",function(z){var y=h(z.target);if(y){if(o.parseUrl(y.getAttribute("href")||"#").hash!=="#"){e(y).closest(".ui-btn").not(".ui-disabled").addClass(e.mobile.activeBtnClass)}}});e(document).bind("click",function(y){var I=h(y.target);if(!I){return}var F=e(I);if(F.is(":jqmData(rel='back')")){window.history.back();return false}var E=b(F),A=o.makeUrlAbsolute(F.attr("href")||"#",E);if(A.search("#")!=-1){A=A.replace(/[^#]*#/,"");if(!A){y.preventDefault();return}else{if(o.isPath(A)){A=o.makeUrlAbsolute(A,E)}else{A=o.makeUrlAbsolute("#"+A,d.hrefNoHash)}}}var B=F.is("[rel='external']")||F.is(":jqmData(ajax='false')")||F.is("[target]"),H=(e.mobile.allowCrossDomainPages&&d.protocol==="file:"&&A.search(/^https?:/)!=-1),z=B||(o.isExternal(A)&&!H);x=F.closest(".ui-btn");if(z||!e.mobile.ajaxEnabled){window.setTimeout(function(){v(true)},200);return}var G=F.jqmData("transition"),J=F.jqmData("direction"),D=(J&&J==="reverse")||F.jqmData("back"),C=F.attr("data-"+e.mobile.ns+"rel")||g;e.mobile.changePage(A,{transition:G,reverse:D,role:C});y.preventDefault()});m.bind("hashchange",function(A,y){var C=o.stripHash(location.hash),B=e.mobile.urlHistory.stack.length===0?"none":g;if(!e.mobile.hashListeningEnabled||c.ignoreNextHashChange){c.ignoreNextHashChange=false;return}if(c.stack.length>1&&C.indexOf(w)>-1){if(!e.mobile.activePage.is(".ui-dialog")){c.directHashChange({currentUrl:C,isBack:function(){window.history.back()},isForward:function(){window.history.forward()}});return}else{var z=function(){C=e.mobile.urlHistory.getActive().page};c.directHashChange({currentUrl:C,isBack:z,isForward:z})}}if(C){C=(typeof C==="string"&&!o.isPath(C))?("#"+C):C;e.mobile.changePage(C,{transition:B,changeHash:false,fromHashChange:true})}else{e.mobile.changePage(e.mobile.firstPage,{transition:B,changeHash:false,fromHashChange:true})}})})(jQuery);
/*!
 * jQuery Mobile v1.0a4.1
 * http://jquerymobile.com/
 *
