 ...
 * http://jquery.org/license
 */
(function(e,d,g){var b=e("html"),a=e("head"),f=e(d);e(d.document).trigger("mobileinit");if(!e.mobile.gradeA()){return}b.addClass("ui-mobile ui-mobile-rendering");e.mobile.metaViewportContent&&!a.find("meta[name='viewport']").length?e("<meta>",{name:"viewport",content:e.mobile.metaViewportContent}).prependTo(a):g;var c=e.mobile.loadingMessage?e("<div class='ui-loader ui-body-a ui-corner-all'><span class='ui-icon ui-icon-loading spin'></span><h1>"+e.mobile.loadingMessage+"</h1></div>"):g;if(typeof c==="undefined"){alert(e.mobile.loadingMessage)}e.extend(e.mobile,{pageLoading:function(h){if(h){b.removeClass("ui-loading")}else{if(e.mobile.loadingMessage){var i=e("."+e.mobile.activeBtnClass).first();if(typeof c==="undefined"){alert(e.mobile.loadingMessage)}c.appendTo(e.mobile.pageContainer).css({top:e.support.scrollTop&&e(d).scrollTop()+e(d).height()/2||i.length&&i.offset().top||100})}b.addClass("ui-loading")}},initializePage:function(){var h=e("[data-role='page']");h.add("[data-role='dialog']").each(function(){var i=e(this);if(!i.data("url")){i.attr("data-url",i.attr("id"))}});e.mobile.firstPage=h.first();e.mobile.pageContainer=h.first().parent().addClass("ui-mobile-viewport");e.mobile.pageLoading();if(!e.mobile.hashListeningEnabled||!e.mobile.path.stripHash(location.hash)){e.mobile.changePage(e.mobile.firstPage,false,true,false,true)}else{f.trigger("hashchange",[true])}}});e(e.mobile.initializePage);f.load(e.mobile.silentScroll)})(jQuery,this);(function(a){a.themeswitcher=function(){if(a("[data-url=themeswitcher]").length){return}var c="/stylesheets/compiled/jquery/mobile/",b=["default","valencia"],d=a.mobile.activePage,e=a("<div data-url=\"themeswitcher\" data-role='dialog' data-theme='a'><div data-role='header' data-theme='b'><div class='ui-title'>Switch Theme:</div></div><div data-role='content' data-theme='c'><ul data-role='listview' data-inset='true'></ul></div></div>").appendTo(a.mobile.pageContainer),g=e.find("ul");a.each(b,function(h){a('<li><a href="#" data-rel="back">'+b[h].charAt(0).toUpperCase()+b[h].substr(1)+"</a></li>").click(function(){f(b[h]);return false}).appendTo(g)});function f(h){a("head").append("<link rel='stylesheet' href='"+c+h+".css' />")}e.page()}})(jQuery);