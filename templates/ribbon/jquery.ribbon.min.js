...
d&&(a(".orb li li ul").hide(),a(".orb li li > div").hide(),a(b).parent().children("ul").fadeIn("fast"),a(b).parent().children("div").fadeIn("fast")))}function h(b){b.altKey&&a('div[rel="accesskeyhelper"]').each(function(){a(this).css("top",a(this).parent().offset().top).css("left",a(this).parent().offset().left-20+a(this).parent().width());a(this).show()})}var c=a.extend({theme:"windows7",backStage:false},f||{});a(".ribbon a").each(function(){a(this).attr("accesskey")&&a(this).append('<div rel="accesskeyhelper" style="display: none; position: absolute; background-repeat: none; width: 16px; padding: 0px; text-align: center; height: 17px; line-height: 17px; top: '+
...
a("ul.ribbon-backstage .ribbon-backstage-firstLevel .ribbon-backstage-subMenu > div").addClass("ribbon-backstage-subMenu-header"));a(".ribbon-backstage-rightColumnWide").hide();a(".ribbon-backstage-rightColumnSmall").hide();d=true}})(jQuery);
