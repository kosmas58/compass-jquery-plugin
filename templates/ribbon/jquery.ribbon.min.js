...
a(this).parent().children("ul:first").show();a("body").css("padding-top","120px")});a(".orbButton").click(function(){b.backStage?(a("ul.ribbon-backstage .ribbon-backstage-firstLevel .ribbon-backstage-subMenu").height(0.9*a(window).height()),a("ul.ribbon-backstage .ribbon-backstage-firstLevel div.ribbon-backstage-rightColumnWide").height(0.9*a(window).height()).width(a(window).width()),a("ul.ribbon-backstage .ribbon-backstage-firstLevel div.ribbon-backstage-rightColumnSmall").parent().children("ul").width(a(window).width()).addClass("ribbon-backstage-leftColumnWide"),
a("ul.ribbon-backstage .ribbon-backstage-firstLevel div.ribbon-backstage-rightColumnSmall").height(0.9*a(window).height()).width("200px"),a("ul.ribbon-backstage .ribbon-backstage-firstLevel div.ribbon-backstage-rightColumnSmall").css("left",a(window).width()-200).css("line-height","17px"),a(".orb ul").animate({opacity:"toggle"},"fast"),e(a(".orb li li a:first"),!0)):a(".orb ul").animate({opacity:"toggle"},"fast")});a(".orb ul").hide();a(".orb ul ul").hide();a(".orb li ul li ul").show();a(".orb li li ul").each(function(){a(this).prepend('<div style="background-color: #EBF2F7; height: 25px; line-height: 25px; width: 292px; padding-left: 9px; border-bottom: 1px solid #CFDBEB;">'+
a(this).parent().children("a:first").text()+"</div>")});a(".orb li li a").each(function(){0<a(this).parent().children("ul").length&&a(this).addClass("arrow")});a(".orb .ribbon-backstage a").live("click",function(){a(".orb ul").fadeOut("fast")});a(".ribbon-list div").click(function(b){var c=a(this).parent().width(),d=b.pageX>a(this).offset().left&&b.pageX<a(this).offset().left+a(this).width(),b=b.pageY>a(this).offset().top&&b.pageY<a(this).offset().top+a(this).height();a(".ribbon-list div ul").fadeOut("fast");
...
b.pageY>a(".ribbon-list div ul:visible").parent().offset().top+a(".ribbon-list div ul:visible").parent().height();if(c||d)a(".ribbon-list div ul:visible").each(function(){a(this).fadeOut("fast")}),a(".ribbon-list div").css("background-image","")})});a(".orb li li a").mouseover(function(){e(this)});a(".menu li > a").dblclick(function(){a("ul .submenu").animate({height:"hide"});a("body").animate({paddingTop:a(this).parent().parent().parent().parent().height()})})}function e(b,d){if(!c.backStage&&("none"==
a(b).parent().children("ul").css("display")||0==a(b).parent().children("ul").length)&&a(b).parent().parent().parent().parent().hasClass("orb"))a(".orb li li ul").fadeOut("fast"),0<a(b).parent().children("ul").length&&a(b).parent().children("ul").fadeIn("fast");c.backStage&&(0==a(b).parent().children("ul").length&&0<a("ul.ribbon-backstage .ribbon-backstage-firstLevel .ribbon-backstage-subMenu:first:hidden").length&&a(b).parent().parent().parent().parent().hasClass("orb")&&(a(".orb li li ul").fadeOut("fast"),
a(".orb li li > div").fadeOut("fast"),a("ul.ribbon-backstage .ribbon-backstage-firstLevel:first .ribbon-backstage-subMenu:first").fadeIn("fast"),a("ul.ribbon-backstage .ribbon-backstage-firstLevel:first div").fadeIn("fast")),"none"==a(b).parent().children("ul").css("display")&&0<a(b).parent().children("ul").length&&a(b).parent().parent().parent().parent().hasClass("orb")&&(a(".orb li li ul").fadeOut("fast"),a(".orb li li > div").fadeOut("fast"),a(b).parent().children("ul").fadeIn("fast"),a(b).parent().children("div").fadeIn("fast")),
...
c.theme+'/menu_top.png" style="margin-left: -10px; margin-top: -22px;" />'));a(".ribbon-list div").each(function(){0<a(this).children("ul").length&&a(this).append('<img src="/images/jquery/ribbon/'+c.theme+'/arrow_down.png" style="float: right; margin-top: 5px;" />')});if(-1<navigator.appVersion.indexOf("MSIE 6.0")||-1<navigator.appVersion.indexOf("MSIE 7.0"))a("ul.menu li li div").css("width","90px"),a("ul.menu").css("width","500px"),a("ul.menu").css("float","left"),a("ul.menu .submenu li div.ribbon-list").css("width",
