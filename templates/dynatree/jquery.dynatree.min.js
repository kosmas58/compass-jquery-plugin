...
f.bExpanded&&this.tree.persistence.clearExpand(f.data.key)}f.removeChildren(true,b);this.ul&&this.ul.removeChild(f.li);delete f}this.childList=null}if(!a){this.isLoading=false;this.render()}},reload:function(a){if(this.parent==null)return this.tree.reload();if(!this.data.isLazy)throw"node.reload() requires lazy nodes.";if(this.bExpanded){this.expand(false);this.removeChildren();this.expand(true)}else{this.removeChildren();a&&this._loadContent()}},_addChildNode:function(a,b){var c=this.tree,d=c.options,
e=c.persistence;a.parent=this;if(this.childList===null)this.childList=[];else b||g(this.childList[this.childList.length-1].span).removeClass(d.classNames.lastsib);if(b){b=g.inArray(b,this.childList);if(b<0)throw"<beforeNode> must be a child of <this>";this.childList.splice(b,0,a)}else this.childList.push(a);b=c.isInitializing();if(d.persist&&e.cookiesFound&&b){if(e.activeKey==a.data.key)c.activeNode=a;if(e.focusedKey==a.data.key)c.focusNode=a;a.bExpanded=g.inArray(a.data.key,e.expandedKeyList)>=0;
a.bSelected=g.inArray(a.data.key,e.selectedKeyList)>=0}else{if(a.data.activate){c.activeNode=a;if(d.persist)e.activeKey=a.data.key}if(a.data.focus){c.focusNode=a;if(d.persist)e.focusedKey=a.data.key}a.bExpanded=a.data.expand==true;a.bExpanded&&d.persist&&e.addExpand(a.data.key);a.bSelected=a.data.select==true;a.bSelected&&d.persist&&e.addSelect(a.data.key)}if(d.minExpandLevel>=a.getLevel())this.bExpanded=true;if(a.bSelected&&d.selectMode==3)for(d=this;d;){d.hasSubSel||d._setSubSel(true);d=d.parent}c.bEnableUpdate&&
this.render();return a},addChild:function(a,b){if(!(!a||a.length==0)){if(a instanceof o)return this._addChildNode(a,b);a.length||(a=[a]);for(var c=this.tree.enableUpdate(false),d=null,e=0;e<a.length;e++){var f=a[e],h=this._addChildNode(new o(this,this.tree,f),b);d||(d=h);f.children&&h.addChild(f.children,null)}this.tree.enableUpdate(c);return d}},append:function(a){this.tree.logWarning("node.append() is deprecated (use node.addChild() instead).");return this.addChild(a,null)},appendAjax:function(a){this.removeChildren(false,
true);this.setLazyNodeStatus(DTNodeStatus_Loading);var b=this,c=a.success,d=a.error,e=g.extend({},this.tree.options.ajaxDefaults,a,{success:function(f){var h=b.tree.phase;b.tree.phase="init";b.addChild(f,null);b.tree.phase="postInit";b.setLazyNodeStatus(DTNodeStatus_Ok);c&&c.call(e,b);b.tree.phase=h},error:function(f,h,i){b.tree.logWarning("appendAjax failed:",h,":\n",f,"\n",i);b.setLazyNodeStatus(DTNodeStatus_Error,{info:h,tooltip:""+i});d&&d.call(e,b,f,h,i)}});g.ajax(e)},move:function(a,b){if(this!==
a){if(!this.parent)throw"Cannot move system root";if(b===undefined||b=="over")b="child";var c=this.parent,d=b==="child"?a:a.parent;if(d.isDescendantOf(this))throw"Cannot move a node to it's own descendant";if(this.parent.childList.length==1){this.parent.childList=null;this.parent.bExpanded=false}else{var e=g.inArray(this,this.parent.childList);if(e<0)throw"Internal error";this.parent.childList.splice(e,1)}this.parent.ul.removeChild(this.li);this.li=null;this.parent=d;if(d.hasChildren())switch(b){case "child":d.childList.push(this);
break;case "before":e=g.inArray(a,d.childList);if(e<0)throw"Internal error";d.childList.splice(e,0,this);break;case "after":e=g.inArray(a,d.childList);if(e<0)throw"Internal error";d.childList.splice(e+1,0,this);break;default:throw"Invalid mode "+b;}else d.childList=[this];if(this.tree!==a.tree){this.visit(function(f){f.tree=a.tree},null,true);throw"Not yet implemented.";}c.isDescendantOf(d)||c.render();d.isDescendantOf(c)||d.render()}},lastentry:undefined};var m=n.create();m._getTreePersistData=function(a,
b){a=new m(a,b);a.read();return a.toDict()};getDynaTreePersistData=m._getTreePersistData;m.prototype={initialize:function(a,b){this._log("DynaTreeStatus: initialize");if(a===undefined)a=g.ui.dynatree.prototype.options.cookieId;b=g.extend({},g.ui.dynatree.prototype.options.cookie,b);this.cookieId=a;this.cookieOpts=b;this.cookiesFound=undefined;this.selectedKeyList=this.expandedKeyList=this.focusedKey=this.activeKey=null},_log:function(){Array.prototype.unshift.apply(arguments,["debug"]);_log.apply(this,
arguments)},read:function(){this._log("DynaTreeStatus: read");this.cookiesFound=false;var a=g.cookie(this.cookieId+"-active");this.activeKey=a==null?"":a;if(a!=null)this.cookiesFound=true;a=g.cookie(this.cookieId+"-focus");this.focusedKey=a==null?"":a;if(a!=null)this.cookiesFound=true;a=g.cookie(this.cookieId+"-expand");this.expandedKeyList=a==null?[]:a.split(",");if(a!=null)this.cookiesFound=true;a=g.cookie(this.cookieId+"-select");this.selectedKeyList=a==null?[]:a.split(",");if(a!=null)this.cookiesFound=
true},write:function(){this._log("DynaTreeStatus: write");g.cookie(this.cookieId+"-active",this.activeKey==null?"":this.activeKey,this.cookieOpts);g.cookie(this.cookieId+"-focus",this.focusedKey==null?"":this.focusedKey,this.cookieOpts);g.cookie(this.cookieId+"-expand",this.expandedKeyList==null?"":this.expandedKeyList.join(","),this.cookieOpts);g.cookie(this.cookieId+"-select",this.selectedKeyList==null?"":this.selectedKeyList.join(","),this.cookieOpts)},addExpand:function(a){this._log("addExpand(%o)",
a);if(g.inArray(a,this.expandedKeyList)<0){this.expandedKeyList.push(a);g.cookie(this.cookieId+"-expand",this.expandedKeyList.join(","),this.cookieOpts)}},clearExpand:function(a){this._log("clearExpand(%o)",a);a=g.inArray(a,this.expandedKeyList);if(a>=0){this.expandedKeyList.splice(a,1);g.cookie(this.cookieId+"-expand",this.expandedKeyList.join(","),this.cookieOpts)}},addSelect:function(a){this._log("addSelect(%o)",a);if(g.inArray(a,this.selectedKeyList)<0){this.selectedKeyList.push(a);g.cookie(this.cookieId+
"-select",this.selectedKeyList.join(","),this.cookieOpts)}},clearSelect:function(a){this._log("clearSelect(%o)",a);a=g.inArray(a,this.selectedKeyList);if(a>=0){this.selectedKeyList.splice(a,1);g.cookie(this.cookieId+"-select",this.selectedKeyList.join(","),this.cookieOpts)}},isReloading:function(){return this.cookiesFound==true},toDict:function(){return{cookiesFound:this.cookiesFound,activeKey:this.activeKey,focusedKey:this.activeKey,expandedKeyList:this.expandedKeyList,selectedKeyList:this.selectedKeyList}},
lastentry:undefined};var p=n.create();p.version="$Version:$";p.prototype={initialize:function(a){this.phase="init";this.$widget=a;this.options=a.options;this.$tree=a.element;this.timer=null;this.divTree=this.$tree.get(0);l(this)},_load:function(){var a=this.options;this.bEnableUpdate=true;this._nodeCount=1;this.focusNode=this.activeNode=null;a.rootVisible!==undefined&&_log("warn","Option 'rootVisible' is no longer supported.");a.title!==undefined&&_log("warn","Option 'title' is no longer supported.");
if(a.minExpandLevel<1){_log("warn","Option 'minExpandLevel' must be >= 1.");a.minExpandLevel=1}if(a.classNames!==g.ui.dynatree.prototype.options.classNames)a.classNames=g.extend({},g.ui.dynatree.prototype.options.classNames,a.classNames);a.imagePath||g("script").each(function(){if(this.src.search(_rexDtLibName)>=0){a.imagePath=this.src.indexOf("/")>=0?this.src.slice(0,this.src.lastIndexOf("/"))+"/skin/":"skin/";return false}});this.persistence=new m(a.cookieId,a.cookie);if(a.persist){g.cookie||_log("warn",
...
b){a=this.getNodeByKey(a);if(!a)return null;a.select(b);return a},enableUpdate:function(a){if(this.bEnableUpdate==a)return a;(this.bEnableUpdate=a)&&this.redraw();return!a},visit:function(a,b,c){return this.tnRoot.visit(a,b,c)},_createFromTag:function(a,b){var c=this;b.find(">li").each(function(){var d=g(this),e=d.find(">span:first");if(e.length)e=e.html();else{e=d.html();var f=e.search(/<ul/i);e=f>=0?g.trim(e.substring(0,f)):g.trim(e)}e={title:e,isFolder:d.hasClass("folder"),isLazy:d.hasClass("lazy"),
expand:d.hasClass("expanded"),select:d.hasClass("selected"),activate:d.hasClass("active"),focus:d.hasClass("focused")};if(d.attr("title"))e.tooltip=d.attr("title");if(d.attr("id"))e.key=d.attr("id");if(d.attr("data"))if(f=g.trim(d.attr("data"))){if(f.charAt(0)!="{")f="{"+f+"}";try{g.extend(e,eval("("+f+")"))}catch(h){throw"Error parsing node data: "+h+"\ndata:\n'"+f+"'";}}e=a.addChild(e);d=d.find(">ul:first");d.length&&c._createFromTag(e,d)})},_checkConsistency:function(){},_setDndStatus:function(a,
b,c,d,e){a=a?g(a.span):null;b=g(b.span);if(!this.$dndMarker){this.$dndMarker=g("<div id='dynatree_drop_marker'></div>").hide().prependTo("body");logMsg("Creating marker: %o",this.$dndMarker)}if(d==="after"||d==="before"||d==="over"){b.addClass("dynatree-drop-target");var f=b.position();switch(d){case "before":f.top-=8;break;case "after":f.top+=8;break;default:f.left+=8}this.$dndMarker.css({left:f.left+"px",top:f.top+"px"}).show()}else{b.removeClass("dynatree-drop-target");this.$dndMarker.hide()}d===
...
_create:function(){logMsg("Dynatree._create(): version='%s', debugLevel=%o.",p.version,this.options.debugLevel);this.options.event+=".dynatree";this.element.get(0);this.tree=new p(this);this.tree._load();this.tree.logDebug("Dynatree._init(): done.")},bind:function(){function a(e){e=e=g.event.fix(e||window.event);var f=j(e.target);return f?f.onFocus(e):false}var b=this.element,c=this.options;this.unbind();var d="click.dynatree dblclick.dynatree";if(c.keyboard)d+=" keypress.dynatree keydown.dynatree";
b.bind(d,function(e){var f=j(e.target);if(!f)return true;var h=f.tree.phase;f.tree.phase="userEvent";try{f.tree.logDebug("bind(%o): dtnode: %o",e,f);switch(e.type){case "click":return c.onClick&&c.onClick(f,e)===false?false:f.onClick(e);case "dblclick":return c.onDblClick&&c.onDblClick(f,e)===false?false:f.onDblClick(e);case "keydown":return c.onKeydown&&c.onKeydown(f,e)===false?false:f.onKeydown(e);case "keypress":return c.onKeypress&&c.onKeypress(f,e)===false?false:f.onKeypress(e)}}catch(i){f.tree.logWarning("bind(%o): dtnode: %o, error: %o",
e,f,i)}finally{f.tree.phase=h}});b=this.tree.divTree;if(b.addEventListener){b.addEventListener("focus",a,true);b.addEventListener("blur",a,true)}else b.onfocusin=b.onfocusout=a},unbind:function(){this.element.unbind(".dynatree")},enable:function(){this.bind();g.Widget.prototype.enable.apply(this,arguments)},disable:function(){this.unbind();g.Widget.prototype.disable.apply(this,arguments)},getTree:function(){return this.tree},getRoot:function(){return this.tree.getRoot()},getActiveNode:function(){return this.tree.getActiveNode()},
getSelectedNodes:function(){return this.tree.getSelectedNodes()},lastentry:undefined});g.ui.dynatree.prototype.options={title:"Dynatree",minExpandLevel:1,imagePath:null,children:null,initId:null,initAjax:null,autoFocus:true,keyboard:true,persist:false,autoCollapse:false,clickFolderMode:3,activeVisible:true,checkbox:false,selectMode:2,fx:null,enableDrag:false,enableDrop:false,onClick:null,onDblClick:null,onKeydown:null,onKeypress:null,onFocus:null,onBlur:null,onQueryActivate:null,onQuerySelect:null,
...
lazy:"dynatree-lazy",focused:"dynatree-focused",partsel:"dynatree-partsel",lastsib:"dynatree-lastsib"},debugLevel:0,lastentry:undefined};g.ui.dynatree.nodedatadefaults={title:null,key:null,isFolder:false,isLazy:false,tooltip:null,icon:null,addClass:null,activate:false,focus:false,expand:false,select:false,hideCheckbox:false,unselectable:false,children:null,lastentry:undefined};var q=false,r=function(){if(!q){g.ui.plugin.add("draggable","connectToDynatree",{start:function(a,b){var c=g(this).data("draggable"),
d=b.helper.data("dtSourceNode")||null;logMsg("draggable-connectToDynatree.start, %o",d);logMsg("    this: %o",this);logMsg("    event: %o",a);logMsg("    draggable: %o",c);logMsg("    ui: %o",b);if(d){c.offset.click.top=-2;c.offset.click.left=+16;logMsg("    draggable.offset.click FIXED: %s/%s",c.offset.click.left,c.offset.click.top);return d.tree._onDragEvent("start",d,null,a,b,c)}},drag:function(a,b){var c=g(this).data("draggable"),d=b.helper.data("dtSourceNode")||null,e=b.helper.data("dtTargetNode")||
null,f=j(a.target);b.helper.data("dtTargetNode",f);e&&e!==f&&e.tree._onDragEvent("leave",e,d,a,b,c);if(f)if(f.tree.options.dnd.onDrop)f===e?f.tree._onDragEvent("over",f,d,a,b,c):f.tree._onDragEvent("enter",f,d,a,b,c)},stop:function(a,b){var c=g(this).data("draggable"),d=b.helper.data("dtSourceNode")||null,e=j(a.target);logMsg("draggable-connectToDynatree.stop, %o",d);var f=a.type;logMsg("    type: %o, downEvent: %o, upEvent: %o",f,c._mouseDownEvent,a);(f=f=="mouseup"&&a.which==1)||logMsg("Drag was cancelled");
if(e){f&&e.tree._onDragEvent("drop",e,d,a,b,c);e.tree._onDragEvent("leave",e,d,a,b,c)}d&&d.tree._onDragEvent("stop",d,null,a,b,c)}});q=true}}})(jQuery);var _rexDtLibName=/.*dynatree[^/]*\.js$/i;
