...
this.data.tooltip+"'":"";d+=a.noLink||this.data.noLink?"<span style='display: inline-block;' class='"+a.classNames.title+"'"+b+">"+this.data.title+"</span>":"<a href='#' class='"+a.classNames.title+"'"+b+">"+this.data.title+"</a>";return d},_fixOrder:function(){var a=this.childList;if(a&&this.ul)for(var b=this.ul.firstChild,c=0,d=a.length-1;c<d;c++){var e=a[c],g=b.dtnode;if(e!==g){this.tree.logDebug("_fixOrder: mismatch at index "+c+": "+e+" != "+g);this.ul.insertBefore(e.li,g.li)}else b=b.nextSibling}},
render:function(a){var b=this.tree.options,c=b.classNames,d=this.isLastSibling();if(!this.parent&&!this.ul){this.li=this.span=null;this.ul=document.createElement("ul");this.ul.className=b.minExpandLevel>1?c.container+" "+c.noConnector:c.container}else if(this.parent){if(!this.li){this.li=document.createElement("li");this.li.dtnode=this;if(this.data.key&&b.generateIds)this.li.id=b.idPrefix+this.data.key;this.span=document.createElement("span");this.span.className=c.title;this.li.appendChild(this.span);
if(!this.parent.ul){this.parent.ul=document.createElement("ul");this.parent.ul.style.display="none";this.parent.li.appendChild(this.parent.ul)}this.parent.ul.appendChild(this.li)}this.span.innerHTML=this._getInnerHtml();var e=[];e.push(c.node);this.data.isFolder&&e.push(c.folder);this.bExpanded&&e.push(c.expanded);this.hasChildren()!==false&&e.push(c.hasChildren);this.data.isLazy&&this.childList===null&&e.push(c.lazy);d&&e.push(c.lastsib);this.bSelected&&e.push(c.selected);this.hasSubSel&&e.push(c.partsel);
this.tree.activeNode===this&&e.push(c.active);this.data.addClass&&e.push(this.data.addClass);e.push(c.combinedExpanderPrefix+(this.bExpanded?"e":"c")+(this.data.isLazy&&this.childList===null?"d":"")+(d?"l":""));e.push(c.combinedIconPrefix+(this.bExpanded?"e":"c")+(this.data.isFolder?"f":""));this.span.className=e.join(" ");this.li.className=d?c.lastsib:""}if(this.bExpanded&&this.childList){c=0;for(d=this.childList.length;c<d;c++)this.childList[c].render();this._fixOrder()}if(this.ul){c=this.ul.style.display===
"none";d=!!this.bExpanded;if(a&&b.fx&&c===d){a=b.fx.duration||200;f(this.ul).animate(b.fx,a)}else this.ul.style.display=this.bExpanded||!this.parent?"":"none"}},getKeyPath:function(a){var b=[];this.visitParents(function(c){c.parent&&b.unshift(c.data.key)},!a);return"/"+b.join(this.tree.options.keyPathSeparator)},getParent:function(){return this.parent},getChildren:function(){return this.childList},hasChildren:function(){if(this.data.isLazy){if(this.childList===null||this.childList===undefined)return;
else if(this.childList.length===0)return false;else if(this.childList.length===1&&this.childList[0].isStatusNode())return;return true}return!!this.childList},isFirstSibling:function(){var a=this.parent;return!a||a.childList[0]===this},isLastSibling:function(){var a=this.parent;return!a||a.childList[a.childList.length-1]===this},getPrevSibling:function(){if(!this.parent)return null;for(var a=this.parent.childList,b=1,c=a.length;b<c;b++)if(a[b]===this)return a[b-1];return null},getNextSibling:function(){if(!this.parent)return null;
...
a);if(f.inArray(a,this.selectedKeyList)<0){this.selectedKeyList.push(a);f.cookie(this.cookieId+"-select",this.selectedKeyList.join(","),this.cookieOpts)}},clearSelect:function(a){this._log("clearSelect(%o)",a);a=f.inArray(a,this.selectedKeyList);if(a>=0){this.selectedKeyList.splice(a,1);f.cookie(this.cookieId+"-select",this.selectedKeyList.join(","),this.cookieOpts)}},isReloading:function(){return this.cookiesFound===true},toDict:function(){return{cookiesFound:this.cookiesFound,activeKey:this.activeKey,
...
if(b.minExpandLevel<1){_log("warn","Option 'minExpandLevel' must be >= 1.");b.minExpandLevel=1}if(b.classNames!==f.ui.dynatree.prototype.options.classNames)b.classNames=f.extend({},f.ui.dynatree.prototype.options.classNames,b.classNames);if(b.ajaxDefaults!==f.ui.dynatree.prototype.options.ajaxDefaults)b.ajaxDefaults=f.extend({},f.ui.dynatree.prototype.options.ajaxDefaults,b.ajaxDefaults);if(b.dnd!==f.ui.dynatree.prototype.options.dnd)b.dnd=f.extend({},f.ui.dynatree.prototype.options.dnd,b.dnd);b.imagePath||
f("script").each(function(){if(this.src.search(/.*dynatree[^\/]*\.js$/i)>=0){b.imagePath=this.src.indexOf("/")>=0?this.src.slice(0,this.src.lastIndexOf("/"))+"/skin/":"skin/";logMsg("Guessing imagePath from '%s': '%s'",this.src,b.imagePath);return false}});this.persistence=new n(b.cookieId,b.cookie);if(b.persist){f.cookie||_log("warn","Please include jquery.cookie.js to use persistence.");this.persistence.read()}this.logDebug("DynaTree.persistence: %o",this.persistence.toDict());this.cache={tagEmpty:"<span class='"+
b.classNames.empty+"'></span>",tagVline:"<span class='"+b.classNames.vline+"'></span>",tagExpander:"<span class='"+b.classNames.expander+"'></span>",tagConnector:"<span class='"+b.classNames.connector+"'></span>",tagNodeIcon:"<span class='"+b.classNames.nodeIcon+"'></span>",tagCheckbox:"<span class='"+b.classNames.checkbox+"'></span>",lastentry:undefined};if(b.children||b.initAjax&&b.initAjax.url||b.initId)f(this.divTree).empty();else this.divRoot&&f(this.divRoot).remove();this.tnRoot=new p(null,
this,{});this.tnRoot.bExpanded=true;this.tnRoot.render();this.divTree.appendChild(this.tnRoot.ul);var c=this.tnRoot,d=b.persist&&this.persistence.isReloading(),e=false,g=this.enableUpdate(false);this.logDebug("Dynatree._load(): read tree structure...");if(b.children)c.addChild(b.children);else if(b.initAjax&&b.initAjax.url){e=true;c.data.isLazy=true;this._reloadAjax(a)}else if(b.initId)this._createFromTag(c,f("#"+b.initId));else{a=this.$tree.find(">ul:first").hide();this._createFromTag(c,a);a.remove()}this._checkConsistency();
...
"init"||this.phase=="postInit"},isReloading:function(){return(this.phase=="init"||this.phase=="postInit")&&this.options.persist&&this.persistence.cookiesFound},isUserEvent:function(){return this.phase=="userEvent"},redraw:function(){this.tnRoot.render(false)},reload:function(a){this._load(a)},getRoot:function(){return this.tnRoot},enable:function(){this.$widget.enable()},disable:function(){this.$widget.disable()},getNodeByKey:function(a){var b=document.getElementById(this.options.idPrefix+a);if(b)return b.dtnode?
b.dtnode:null;var c=null;this.visit(function(d){if(d.data.key==a){c=d;return false}},true);return c},getActiveNode:function(){return this.activeNode},reactivate:function(a){var b=this.activeNode;if(b){this.activeNode=null;b.activate();a&&b.focus()}},getSelectedNodes:function(a){var b=[];this.tnRoot.visit(function(c){if(c.bSelected){b.push(c);if(a===true)return"skip"}});return b},activateKey:function(a){a=a===null?null:this.getNodeByKey(a);if(!a){this.activeNode&&this.activeNode.deactivate();return this.activeNode=
null}a.focus();a.activate();return a},loadKeyPath:function(a,b){var c=a.split(this.options.keyPathSeparator);c[0]===""&&c.shift();if(c[0]==this.tnRoot.data.key){this.logDebug("Removed leading root key.");c.shift()}a=c.join(this.options.keyPathSeparator);return this.tnRoot._loadKeyPath(a,b)},selectKey:function(a,b){var c=this.getNodeByKey(a);if(!c)return null;c.select(b);return c},enableUpdate:function(a){if(this.bEnableUpdate==a)return a;(this.bEnableUpdate=a)&&this.redraw();return!a},visit:function(a,
b){return this.tnRoot.visit(a,b)},_createFromTag:function(a,b){var c=this;b.find(">li").each(function(){var d=f(this),e=d.find(">span:first");if(e.length)e=e.html();else{e=d.html();var g=e.search(/<ul/i);e=g>=0?f.trim(e.substring(0,g)):f.trim(e)}e={title:e,isFolder:d.hasClass("folder"),isLazy:d.hasClass("lazy"),expand:d.hasClass("expanded"),select:d.hasClass("selected"),activate:d.hasClass("active"),focus:d.hasClass("focused"),noLink:d.hasClass("noLink")};if(d.attr("title"))e.tooltip=d.attr("title");
if(d.attr("id"))e.key=d.attr("id");if(d.attr("data"))if(g=f.trim(d.attr("data"))){if(g.charAt(0)!="{")g="{"+g+"}";try{f.extend(e,eval("("+g+")"))}catch(i){throw"Error parsing node data: "+i+"\ndata:\n'"+g+"'";}}e=a.addChild(e);d=d.find(">ul:first");d.length&&c._createFromTag(e,d)})},_checkConsistency:function(){},_setDndStatus:function(a,b,c,d,e){a=a?f(a.span):null;b=f(b.span);if(!this.$dndMarker)this.$dndMarker=f("<div id='dynatree-drop-marker'></div>").hide().prependTo(f(this.divTree).parent());
...
g.left+=8}this.$dndMarker.css({left:g.left+"px",top:g.top+"px"}).show()}else{b.removeClass("dynatree-drop-target");this.$dndMarker.hide()}d==="after"?b.addClass("dynatree-drop-after"):b.removeClass("dynatree-drop-after");d==="before"?b.addClass("dynatree-drop-before"):b.removeClass("dynatree-drop-before");if(e===true){a&&a.addClass("dynatree-drop-accept");b.addClass("dynatree-drop-accept");c.addClass("dynatree-drop-accept")}else{a&&a.removeClass("dynatree-drop-accept");b.removeClass("dynatree-drop-accept");
c.removeClass("dynatree-drop-accept")}if(e===false){a&&a.addClass("dynatree-drop-reject");b.addClass("dynatree-drop-reject");c.addClass("dynatree-drop-reject")}else{a&&a.removeClass("dynatree-drop-reject");b.removeClass("dynatree-drop-reject");c.removeClass("dynatree-drop-reject")}},_onDragEvent:function(a,b,c,d,e,g){var i=this.options.dnd,h=null,j=f(b.span);switch(a){case "helper":c=f("<div class='dynatree-drag-helper'><span class='dynatree-drag-helper-img' /></div>").append(f(d.target).closest("a").clone());
c.data("dtSourceNode",b);h=c;break;case "start":if(b.isStatusNode())h=false;else if(i.onDragStart)h=i.onDragStart(b);if(h===false){this.logDebug("tree.onDragStart() cancelled");e.helper.trigger("mouseup");e.helper.hide()}else j.addClass("dynatree-drag-source");break;case "enter":h=i.onDragEnter?i.onDragEnter(b,c):null;h={over:h!==false&&(h===true||h==="over"||f.inArray("over",h)>=0),before:h!==false&&(h===true||h==="before"||f.inArray("before",h)>=0),after:h!==false&&(h===true||h==="after"||f.inArray("after",
h)>=0)};e.helper.data("enterResponse",h);break;case "over":g=e.helper.data("enterResponse");a=null;if(g===false)break;else if(typeof g==="string")a=g;else{var k=j.offset();d={x:d.pageX-k.left,y:d.pageY-k.top};j={x:d.x/j.width(),y:d.y/j.height()};if(g.after&&j.y>0.75)a="after";else if(!g.over&&g.after&&j.y>0.5)a="after";else if(g.before&&j.y<=0.25)a="before";else if(!g.over&&g.before&&j.y<=0.5)a="before";else if(g.over)a="over";if(i.preventVoidMoves)if(b===c)a=null;else if(a==="before"&&c&&b===c.getNextSibling())a=
null;else if(a==="after"&&c&&b===c.getPrevSibling())a=null;else if(a==="over"&&c&&c.parent===b&&c.isLastSibling())a=null;e.helper.data("hitMode",a)}a==="over"&&i.autoExpandMS&&b.hasChildren()!==false&&!b.bExpanded&&b.scheduleAction("expand",i.autoExpandMS);if(a&&i.onDragOver)h=i.onDragOver(b,c,a);this._setDndStatus(c,b,e.helper,a,h!==false);break;case "drop":(a=e.helper.data("hitMode"))&&i.onDrop&&i.onDrop(b,c,a,e,g);break;case "leave":b.scheduleAction("cancel");e.helper.data("enterResponse",null);
e.helper.data("hitMode",null);this._setDndStatus(c,b,e.helper,"out",undefined);i.onDragLeave&&i.onDragLeave(b,c);break;case "stop":j.removeClass("dynatree-drag-source");i.onDragStop&&i.onDragStop(b);break;default:throw"Unsupported drag event: "+a;}return h},cancelDrag:function(){var a=f.ui.ddmanager.current;a&&a.cancel()},lastentry:undefined};f.widget("ui.dynatree",{_init:function(){if(parseFloat(f.ui.version)<1.8){_log("warn","ui.dynatree._init() was called; you should upgrade to jquery.ui.core.js v1.8 or higher.");
return this._create()}_log("debug","ui.dynatree._init() was called; no current default functionality.")},_create:function(){logMsg("Dynatree._create(): version='%s', debugLevel=%o.",q.version,this.options.debugLevel);this.options.event+=".dynatree";this.element.get(0);this.tree=new q(this);this.tree._load();this.tree.logDebug("Dynatree._init(): done.")},bind:function(){function a(c){c=f.event.fix(c||window.event);var d=l(c.target);return d?d._onFocus(c):false}this.unbind();var b="click.dynatree dblclick.dynatree";
if(this.options.keyboard)b+=" keypress.dynatree keydown.dynatree";this.element.bind(b,function(c){var d=l(c.target);if(!d)return true;var e=d.tree,g=e.options;e.logDebug("event(%s): dtnode: %s",c.type,d);var i=e.phase;e.phase="userEvent";try{switch(c.type){case "click":return g.onClick&&g.onClick.call(e,d,c)===false?false:d._onClick(c);case "dblclick":return g.onDblClick&&g.onDblClick.call(e,d,c)===false?false:d._onDblClick(c);case "keydown":return g.onKeydown&&g.onKeydown.call(e,d,c)===false?false:
...
f.Widget.prototype.disable.apply(this,arguments)},getTree:function(){return this.tree},getRoot:function(){return this.tree.getRoot()},getActiveNode:function(){return this.tree.getActiveNode()},getSelectedNodes:function(){return this.tree.getSelectedNodes()},lastentry:undefined});if(parseFloat(f.ui.version)<1.8)f.ui.dynatree.getter="getTree getRoot getActiveNode getSelectedNodes";f.ui.dynatree.prototype.options={title:"Dynatree",minExpandLevel:1,imagePath:null,children:null,initId:null,initAjax:null,
autoFocus:true,keyboard:true,persist:false,autoCollapse:false,clickFolderMode:3,activeVisible:true,checkbox:false,selectMode:2,fx:null,noLink:false,onClick:null,onDblClick:null,onKeydown:null,onKeypress:null,onFocus:null,onBlur:null,onQueryActivate:null,onQuerySelect:null,onQueryExpand:null,onPostInit:null,onActivate:null,onDeactivate:null,onSelect:null,onExpand:null,onLazyRead:null,dnd:{onDragStart:null,onDragStop:null,autoExpandMS:1E3,preventVoidMoves:true,onDragEnter:null,onDragOver:null,onDrop:null,
onDragLeave:null},ajaxDefaults:{cache:false,dataType:"json"},strings:{loading:"Loading&#8230;",loadError:"Load error!"},generateIds:false,idPrefix:"dynatree-id-",keyPathSeparator:"/",cookieId:"dynatree",cookie:{expires:null},classNames:{container:"dynatree-container",node:"dynatree-node",folder:"dynatree-folder",empty:"dynatree-empty",vline:"dynatree-vline",expander:"dynatree-expander",connector:"dynatree-connector",checkbox:"dynatree-checkbox",nodeIcon:"dynatree-icon",title:"dynatree-title",noConnector:"dynatree-no-connector",
nodeError:"dynatree-statusnode-error",nodeWait:"dynatree-statusnode-wait",hidden:"dynatree-hidden",combinedExpanderPrefix:"dynatree-exp-",combinedIconPrefix:"dynatree-ico-",nodeLoading:"dynatree-loading",hasChildren:"dynatree-has-children",active:"dynatree-active",selected:"dynatree-selected",expanded:"dynatree-expanded",lazy:"dynatree-lazy",focused:"dynatree-focused",partsel:"dynatree-partsel",lastsib:"dynatree-lastsib"},debugLevel:2,lastentry:undefined};if(parseFloat(f.ui.version)<1.8)f.ui.dynatree.defaults=
f.ui.dynatree.prototype.options;f.ui.dynatree.nodedatadefaults={title:null,key:null,isFolder:false,isLazy:false,tooltip:null,icon:null,addClass:null,noLink:false,activate:false,focus:false,expand:false,select:false,hideCheckbox:false,unselectable:false,children:null,lastentry:undefined};var s=false,t=function(){if(!s){f.ui.plugin.add("draggable","connectToDynatree",{start:function(a,b){var c=f(this).data("draggable"),d=b.helper.data("dtSourceNode")||null;if(d){c.offset.click.top=-2;c.offset.click.left=
+16;return d.tree._onDragEvent("start",d,null,a,b,c)}},drag:function(a,b){var c=f(this).data("draggable"),d=b.helper.data("dtSourceNode")||null,e=b.helper.data("dtTargetNode")||null,g=l(a.target);if(a.target&&!g)if(f(a.target).closest("div.dynatree-drag-helper,#dynatree-drop-marker").length>0)return;b.helper.data("dtTargetNode",g);e&&e!==g&&e.tree._onDragEvent("leave",e,d,a,b,c);if(g)if(g.tree.options.dnd.onDrop)g===e?g.tree._onDragEvent("over",g,d,a,b,c):g.tree._onDragEvent("enter",g,d,a,b,c)},stop:function(a,
b){var c=f(this).data("draggable"),d=b.helper.data("dtSourceNode")||null,e=b.helper.data("dtTargetNode")||null,g=a.type=="mouseup"&&a.which==1;g||logMsg("Drag was cancelled");if(e){g&&e.tree._onDragEvent("drop",e,d,a,b,c);e.tree._onDragEvent("leave",e,d,a,b,c)}d&&d.tree._onDragEvent("stop",d,null,a,b,c)}});s=true}}})(jQuery);
