$.fn.themeswitcher=function(e){function g(d){d=$('<link href="/stylesheets/'+d+'" type="text/css" rel="Stylesheet" class="ui-theme" />');$("head").append(d);$("link.ui-theme").size()>3&&$("link.ui-theme:first").remove()}var a=jQuery.extend({loadTheme:null,initialText:"Switch Theme",width:150,height:200,buttonPreText:"Theme: ",closeOnSelect:true,buttonHeight:14,cookieName:"jquery-ui-theme",onOpen:function(){},onClose:function(){},onSelect:function(){}},e),c=$('<a href="#" class="jquery-ui-themeswitcher-trigger"><span class="jquery-ui-themeswitcher-icon"></span><span class="jquery-ui-themeswitcher-title">'+
