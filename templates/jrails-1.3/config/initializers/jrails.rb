...
ActionView::Helpers::AssetTagHelper::JAVASCRIPT_DEFAULT_SOURCES = ['jquery-1.3.2.min', 'jquery-ui-1.7.3.min', 'jrails.min']
ActionView::Helpers::AssetTagHelper::reset_javascript_include_default

ActionView::Helpers::AssetTagHelper.register_javascript_expansion :jquery_132 => ['jquery-1.3.2.min', 'jquery-ui-1.7.3.min']
