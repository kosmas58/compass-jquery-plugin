...
h=a.getState(!1),f=a.getStateByIndex(-2);a.discardState(h,d,f);a.pushState(d.data,d.title,d.url,!1);return!0};if(a.emulated.pushState&&a.getHash()&&!a.emulated.hashChange)a.Adapter.onDomLoad(function(){a.Adapter.trigger(f,"hashchange")})};typeof a.init!=="undefined"&&a.init()})(window);
