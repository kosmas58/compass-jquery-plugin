...
a(this,l,true,o)+"px")})}});b.extend(b.expr[":"],{data:function(h,g,a){return!!b.data(h,a[3])},focusable:function(h){var g=h.nodeName.toLowerCase(),a=b.attr(h,"tabindex");if("area"===g){g=h.parentNode;a=g.name;if(!h.href||!a||g.nodeName.toLowerCase()!=="map")return false;h=b("img[usemap=#"+a+"]")[0];return!!h&&e(h)}return(/input|select|textarea|button|object/.test(g)?!h.disabled:"a"==g?h.href||!isNaN(a):!isNaN(a))&&e(h)},tabbable:function(h){var g=b.attr(h,"tabindex");return(isNaN(g)||g>=0)&&b(h).is(":focusable")}});
b(function(){var h=document.body,g=h.appendChild(g=document.createElement("div"));b.extend(g.style,{minHeight:"100px",height:"auto",padding:0,borderWidth:0});b.support.minHeight=g.offsetHeight===100;b.support.selectstart="onselectstart"in g;h.removeChild(g).style.display="none"});b.extend(b.ui,{plugin:{add:function(h,g,a){h=b.ui[h].prototype;for(var f in a){h.plugins[f]=h.plugins[f]||[];h.plugins[f].push([g,a[f]])}},call:function(h,g,a){if((g=h.plugins[g])&&h.element[0].parentNode)for(var f=0;f<g.length;f++)h.options[g[f][0]]&&
g[f][1].apply(h.element,a)}},contains:function(h,g){return document.compareDocumentPosition?h.compareDocumentPosition(g)&16:h!==g&&h.contains(g)},hasScroll:function(h,g){if(b(h).css("overflow")==="hidden")return false;var a=g&&g==="left"?"scrollLeft":"scrollTop",f=false;if(h[a]>0)return true;h[a]=1;f=h[a]>0;h[a]=0;return f},isOverAxis:function(h,g,a){return h>g&&h<g+a},isOver:function(h,g,a,f,i,j){return b.ui.isOverAxis(h,a,i)&&b.ui.isOverAxis(g,f,j)}})}})(jQuery);
(function(b,d){if(b.cleanData){var e=b.cleanData;b.cleanData=function(g){for(var a=0,f;(f=g[a])!=null;a++)b(f).triggerHandler("remove");e(g)}}else{var h=b.fn.remove;b.fn.remove=function(g,a){return this.each(function(){if(!a)if(!g||b.filter(g,[this]).length)b("*",this).add([this]).each(function(){b(this).triggerHandler("remove")});return h.call(b(this),g,a)})}}b.widget=function(g,a,f){var i=g.split(".")[0],j;g=g.split(".")[1];j=i+"-"+g;if(!f){f=a;a=b.Widget}b.expr[":"][j]=function(l){return!!b.data(l,
g)};b[i]=b[i]||{};b[i][g]=function(l,o){arguments.length&&this._createWidget(l,o)};a=new a;a.options=b.extend(true,{},a.options);b[i][g].prototype=b.extend(true,a,{namespace:i,widgetName:g,widgetEventPrefix:b[i][g].prototype.widgetEventPrefix||g,widgetBaseClass:j},f);b.widget.bridge(g,b[i][g])};b.widget.bridge=function(g,a){b.fn[g]=function(f){var i=typeof f==="string",j=Array.prototype.slice.call(arguments,1),l=this;f=!i&&j.length?b.extend.apply(null,[true,f].concat(j)):f;if(i&&f.charAt(0)==="_")return l;
i?this.each(function(){var o=b.data(this,g),m=o&&b.isFunction(o[f])?o[f].apply(o,j):o;if(m!==o&&m!==d){l=m;return false}}):this.each(function(){var o=b.data(this,g);o?o.option(f||{})._init():b.data(this,g,new a(f,this))});return l}};b.Widget=function(g,a){arguments.length&&this._createWidget(g,a)};b.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:false},_createWidget:function(g,a){b.data(a,this.widgetName,this);this.element=b(a);this.options=b.extend(true,{},this.options,
this._getCreateOptions(),g);var f=this;this.element.bind("remove."+this.widgetName,function(){f.destroy()});this._create();this._trigger("create");this._init()},_getCreateOptions:function(){return b.metadata&&b.metadata.get(this.element[0])[this.widgetName]},_create:function(){},_init:function(){},destroy:function(){this.element.unbind("."+this.widgetName).removeData(this.widgetName);this.widget().unbind("."+this.widgetName).removeAttr("aria-disabled").removeClass(this.widgetBaseClass+"-disabled ui-state-disabled")},
widget:function(){return this.element},option:function(g,a){var f=g;if(arguments.length===0)return b.extend({},this.options);if(typeof g==="string"){if(a===d)return this.options[g];f={};f[g]=a}this._setOptions(f);return this},_setOptions:function(g){var a=this;b.each(g,function(f,i){a._setOption(f,i)});return this},_setOption:function(g,a){this.options[g]=a;if(g==="disabled")this.widget()[a?"addClass":"removeClass"](this.widgetBaseClass+"-disabled ui-state-disabled").attr("aria-disabled",a);return this},
...
b(this).height()))}).css("overflow","auto")}else if(d.autoHeight){e=0;this.headers.next().each(function(){e=Math.max(e,b(this).height("").height())}).height(e)}return this},activate:function(d){this.options.active=d;d=this._findActive(d)[0];this._clickHandler({target:d},d);return this},_findActive:function(d){return d?typeof d==="number"?this.headers.filter(":eq("+d+")"):this.headers.not(this.headers.not(d)):d===false?b([]):this.headers.filter(":eq(0)")},_clickHandler:function(d,e){var h=this.options;
if(!h.disabled)if(d.target){var g=b(d.currentTarget||e),a=g[0]===this.active[0];h.active=h.collapsible&&a?false:this.headers.index(g);if(!(this.running||!h.collapsible&&a)){var f=this.active;o=g.next();j=this.active.next();l={options:h,newHeader:a&&h.collapsible?b([]):g,oldHeader:this.active,newContent:a&&h.collapsible?b([]):o,oldContent:j};var i=this.headers.index(this.active[0])>this.headers.index(g[0]);this.active=a?b([]):g;this._toggle(o,j,l,a,i);f.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(h.icons.headerSelected).addClass(h.icons.header);
...
d.length?this.activate(h,d):this.activate(h,this.element.children(e))}else this.activate(h,this.element.children(e))},nextPage:function(d){if(this.hasScroll())if(!this.active||this.last())this.activate(d,this.element.children(".ui-menu-item:first"));else{var e=this.active.offset().top,h=this.element.height(),g=this.element.children(".ui-menu-item").filter(function(){var a=b(this).offset().top-e-h+b(this).height();return a<10&&a>-10});g.length||(g=this.element.children(".ui-menu-item:last"));this.activate(d,
g)}else this.activate(d,this.element.children(".ui-menu-item").filter(!this.active||this.last()?":first":":last"))},previousPage:function(d){if(this.hasScroll())if(!this.active||this.first())this.activate(d,this.element.children(".ui-menu-item:last"));else{var e=this.active.offset().top,h=this.element.height();result=this.element.children(".ui-menu-item").filter(function(){var g=b(this).offset().top-e+h-b(this).height();return g<10&&g>-10});result.length||(result=this.element.children(".ui-menu-item:first"));
...
(function(b){var d,e=function(g){b(":ui-button",g.target.form).each(function(){var a=b(this).data("button");setTimeout(function(){a.refresh()},1)})},h=function(g){var a=g.name,f=g.form,i=b([]);if(a)i=f?b(f).find("[name='"+a+"']"):b("[name='"+a+"']",g.ownerDocument).filter(function(){return!this.form});return i};b.widget("ui.button",{options:{disabled:null,text:true,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset.button").bind("reset.button",
e);if(typeof this.options.disabled!=="boolean")this.options.disabled=this.element.attr("disabled");this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var g=this,a=this.options,f=this.type==="checkbox"||this.type==="radio",i="ui-state-hover"+(!f?" ui-state-active":"");if(a.label===null)a.label=this.buttonElement.html();if(this.element.is(":disabled"))a.disabled=true;this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role","button").bind("mouseenter.button",
...
""?i:b("<img/>").attr({src:l,alt:i,title:i})));a[j?"before":"after"](f.trigger);f.trigger.click(function(){b.datepicker._datepickerShowing&&b.datepicker._lastInput==a[0]?b.datepicker._hideDatepicker():b.datepicker._showDatepicker(a[0]);return false})}},_autoSize:function(a){if(this._get(a,"autoSize")&&!a.inline){var f=new Date(2009,11,20),i=this._get(a,"dateFormat");if(i.match(/[DM]/)){var j=function(l){for(var o=0,m=0,k=0;k<l.length;k++)if(l[k].length>o){o=l[k].length;m=k}return m};f.setMonth(j(this._get(a,
i.match(/MM/)?"monthNames":"monthNamesShort")));f.setDate(j(this._get(a,i.match(/DD/)?"dayNames":"dayNamesShort"))+20-f.getDay())}a.input.attr("size",this._formatDate(a,f).length)}},_inlineDatepicker:function(a,f){var i=b(a);if(!i.hasClass(this.markerClassName)){i.addClass(this.markerClassName).append(f.dpDiv).bind("setData.datepicker",function(j,l,o){f.settings[l]=o}).bind("getData.datepicker",function(j,l){return this._get(f,l)});b.data(a,"datepicker",f);this._setDate(f,this._getDefaultDate(f),
true);this._updateDatepicker(f);this._updateAlternate(f);f.dpDiv.show()}},_dialogDatepicker:function(a,f,i,j,l){a=this._dialogInst;if(!a){this.uuid+=1;this._dialogInput=b('<input type="text" id="'+("dp"+this.uuid)+'" style="position: absolute; top: -100px; width: 0px; z-index: -10;"/>');this._dialogInput.keydown(this._doKeyDown);b("body").append(this._dialogInput);a=this._dialogInst=this._newInst(this._dialogInput,false);a.settings={};b.data(this._dialogInput[0],"datepicker",a)}h(a.settings,j||{});
...
this._showDatepicker(this._dialogInput[0]);b.blockUI&&b.blockUI(this.dpDiv);b.data(this._dialogInput[0],"datepicker",a);return this},_destroyDatepicker:function(a){var f=b(a),i=b.data(a,"datepicker");if(f.hasClass(this.markerClassName)){var j=a.nodeName.toLowerCase();b.removeData(a,"datepicker");if(j=="input"){i.append.remove();i.trigger.remove();f.removeClass(this.markerClassName).unbind("focus",this._showDatepicker).unbind("keydown",this._doKeyDown).unbind("keypress",this._doKeyPress).unbind("keyup",
...
this.originalTitle&&this.element.attr("title",this.originalTitle);return this},widget:function(){return this.uiDialog},close:function(g){var a=this,f,i;if(false!==a._trigger("beforeClose",g)){a.overlay&&a.overlay.destroy();a.uiDialog.unbind("keypress.ui-dialog");a._isOpen=false;if(a.options.hide)a.uiDialog.hide(a.options.hide,function(){a._trigger("close",g)});else{a.uiDialog.hide();a._trigger("close",g)}b.ui.dialog.overlay.resize();if(a.options.modal){f=0;b(".ui-dialog").each(function(){if(this!==
...
b.ui.dialog.maxZ+=1;this.uiDialog.css("z-index",b.ui.dialog.maxZ);this.element.attr(f);this._trigger("focus",a);return this},open:function(){if(!this._isOpen){var g=this.options,a=this.uiDialog;this.overlay=g.modal?new b.ui.dialog.overlay(this):null;this._size();this._position(g.position);a.show(g.show);this.moveToTop(true);g.modal&&a.bind("keypress.ui-dialog",function(f){if(f.keyCode===b.ui.keyCode.TAB){var i=b(":tabbable",this),j=i.filter(":first");i=i.filter(":last");if(f.target===i[0]&&!f.shiftKey){j.focus(1);
return false}else if(f.target===j[0]&&f.shiftKey){i.focus(1);return false}}});b(this.element.find(":tabbable").get().concat(a.find(".ui-dialog-buttonpane :tabbable").get().concat(a.get()))).eq(0).focus();this._isOpen=true;this._trigger("open");return this}},_createButtons:function(g){var a=this,f=false,i=b("<div></div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"),j=b("<div></div>").addClass("ui-dialog-buttonset").appendTo(i);a.uiDialog.find(".ui-dialog-buttonpane").remove();
typeof g==="object"&&g!==null&&b.each(g,function(){return!(f=true)});if(f){b.each(g,function(l,o){o=b.isFunction(o)?{click:o,text:l}:o;var m=b('<button type="button"></button>').attr(o,true).unbind("click").click(function(){o.click.apply(a.element[0],arguments)}).appendTo(j);b.fn.button&&m.button()});i.appendTo(a.uiDialog)}},_makeDraggable:function(){function g(l){return{position:l.position,offset:l.offset}}var a=this,f=a.options,i=b(document),j;a.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",
handle:".ui-dialog-titlebar",containment:"document",start:function(l,o){j=f.height==="auto"?"auto":b(this).height();b(this).height(b(this).height()).addClass("ui-dialog-dragging");a._trigger("dragStart",l,g(o))},drag:function(l,o){a._trigger("drag",l,g(o))},stop:function(l,o){f.position=[o.position.left-i.scrollLeft(),o.position.top-i.scrollTop()];b(this).removeClass("ui-dialog-dragging").height(j);a._trigger("dragStop",l,g(o));b.ui.dialog.overlay.resize()}})},_makeResizable:function(g){function a(l){return{originalPosition:l.originalPosition,
...
[g[0],g[1]];if(a.length===1)a[1]=a[0];b.each(["left","top"],function(j,l){if(+a[j]===a[j]){f[j]=a[j];a[j]=l}});g={my:a.join(" "),at:a.join(" "),offset:f.join(" ")}}g=b.extend({},b.ui.dialog.prototype.options.position,g)}else g=b.ui.dialog.prototype.options.position;(i=this.uiDialog.is(":visible"))||this.uiDialog.show();this.uiDialog.css({top:0,left:0}).position(b.extend({of:window},g));i||this.uiDialog.hide()},_setOptions:function(g){var a=this,f={},i=false;b.each(g,function(j,l){a._setOption(j,l);
...
b.ui.ddmanager&&!e.dropBehaviour&&b.ui.ddmanager.prepareOffsets(this,d);this.helper.addClass("ui-draggable-dragging");this._mouseDrag(d,true);return true},_mouseDrag:function(d,e){this.position=this._generatePosition(d);this.positionAbs=this._convertPositionTo("absolute");if(!e){var h=this._uiHash();if(this._trigger("drag",d,h)===false){this._mouseUp({});return false}this.position=h.position}if(!this.options.axis||this.options.axis!="y")this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||
...
this.headerBox.children(":first");this.titleTextBox=this.titleBox.children(":first");this.titleText=this.titleTextBox.html();this.headerBox.prepend("<span/>");this.rightBox=this.headerBox.children(":first").addClass(e.rightboxClass);if(e.controls!=false){this.rightBox.append("<span/>");this.controlsBox=this.rightBox.children(":first").addClass(e.controlsClass).html(e.controls)}else this.controlsBox=null;this.panelBox.addClass(e.widgetClass);this.headerBox.addClass(e.headerClass);this.titleBox.addClass(e.titleClass);
this.titleTextBox.addClass(e.titleTextClass);this.contentBox.addClass(e.contentClass);if(e.collapsible){switch(e.collapseType){case "slide-right":var h=0;if(e.controls)h=1;this.rightBox.append("<span><span/></span>");this.collapsePanel=this.rightBox.children().eq(h).addClass(e.collapsePnlClass);this.collapseButton=this.collapsePanel.children(":first").addClass(e.slideRIcon);this.iconBtnClpsd=e.slideRIconClpsd;this.iconBtn=e.slideRIcon;this.ctrlBox=this.controlsBox;break;case "slide-left":this.headerBox.prepend("<span><span/></span>");
...
i.css("font-weight")+";font-family:"+i.css("font-family").replace(/"/g,"")+";font-size:"+i.css("font-size")+";fill:"+i.css("color")+";' transform='rotate(-90)' text-rendering='optimizeSpeed'>"+j+'</text></svg>"></object>').css("height",h.vHeight)}i.toggleClass("ui-panel-vtext"+m)}else{f.attr("align","center");i.html(i.text().replace(/(.)/g,"$1<BR>"))}g.animate({width:"2.4em"},d);if(h.stackable)e?o.append(g):o.prepend(g)}else{h.stackable&&this.panelFrame.append(g);if(h.trueVerticalText){f.toggleClass("ui-panel-vtitle").css("height",
"auto");i.empty().append(j);i.toggleClass("ui-panel-vtext"+m)}else{f.attr("align","left");i.html(i.text().replace(/<BR>/g," "))}g.animate({width:h.width},d)}}if((d!=0||h.trueVerticalText)&&h.cookie==null||!e&&h.cookie!=null)h.collapsed=!h.collapsed;this.panelBox.data("collapsed",h.collapsed);if(!e){h.cookie&&this._cookie(Number(h.collapsed),h.cookie);h.accordion&&b("."+h.accordion+"[role='panel'][id!='"+h.id+"']:not(:data(collapsed))").panel("toggle",d,true)}this.collapseButton.toggleClass(this.iconBtnClpsd).toggleClass(this.iconBtn);
...
nw:".ui-resizable-nw"});if(this.handles.constructor==String){if(this.handles=="all")this.handles="n,e,s,w,se,sw,ne,nw";var a=this.handles.split(",");this.handles={};for(var f=0;f<a.length;f++){var i=b.trim(a[f]),j=b('<div class="ui-resizable-handle '+("ui-resizable-"+i)+'"></div>');/sw|se|ne|nw/.test(i)&&j.css({zIndex:++g.zIndex});"se"==i&&j.addClass("ui-icon ui-icon-gripsmall-diagonal-se");this.handles[i]=".ui-resizable-"+i;this.element.append(j)}}this._renderAxis=function(l){l=l||this.element;for(var o in this.handles){if(this.handles[o].constructor==
...
if(this.elementIsWrapper){h(this.element);var g=this.element;g.after(this.originalElement.css({position:g.css("position"),width:g.outerWidth(),height:g.outerHeight(),top:g.css("top"),left:g.css("left")})).remove()}this.originalElement.css("resize",this.originalResizeStyle);h(this.originalElement);return this},_mouseCapture:function(h){var g=false,a;for(a in this.handles)if(b(this.handles[a])[0]==h.target)g=true;return!this.options.disabled&&g},_mouseStart:function(h){var g=this.options,a=this.element.position(),
f=this.element;this.resizing=true;this.documentScroll={top:b(document).scrollTop(),left:b(document).scrollLeft()};if(f.is(".ui-draggable")||/absolute/.test(f.css("position")))f.css({position:"absolute",top:a.top,left:a.left});b.browser.opera&&/relative/.test(f.css("position"))&&f.css({position:"relative",top:"auto",left:"auto"});this._renderProxy();a=d(this.helper.css("left"));var i=d(this.helper.css("top"));if(g.containment){a+=b(g.containment).scrollLeft()||0;i+=b(g.containment).scrollTop()||0}this.offset=
this.helper.offset();this.position={left:a,top:i};this.size=this._helper?{width:f.outerWidth(),height:f.outerHeight()}:{width:f.width(),height:f.height()};this.originalSize=this._helper?{width:f.outerWidth(),height:f.outerHeight()}:{width:f.width(),height:f.height()};this.originalPosition={left:a,top:i};this.sizeDiff={width:f.outerWidth()-f.width(),height:f.outerHeight()-f.height()};this.originalMousePosition={left:h.pageX,top:h.pageY};this.aspectRatio=typeof g.aspectRatio=="number"?g.aspectRatio:
this.originalSize.width/this.originalSize.height||1;g=b(".ui-resizable-"+this.axis).css("cursor");b("body").css("cursor",g=="auto"?this.axis+"-resize":g);f.addClass("ui-resizable-resizing");this._propagate("start",h);return true},_mouseDrag:function(h){var g=this.helper,a=this.originalMousePosition,f=this._change[this.axis];if(!f)return false;a=f.apply(this,[h,h.pageX-a.left||0,h.pageY-a.top||0]);if(this._aspectRatio||h.shiftKey)a=this._updateRatio(a,h);a=this._respectSize(a,h);this._propagate("resize",
h);g.css({top:this.position.top+"px",left:this.position.left+"px",width:this.size.width+"px",height:this.size.height+"px"});!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize();this._updateCache(a);this._trigger("resize",h,this.ui());return false},_mouseStop:function(h){this.resizing=false;var g=this.options;if(this._helper){var a=this._proportionallyResizeElements,f=a.length&&/textarea/i.test(a[0].nodeName);a=f&&b.ui.hasScroll(a[0],"left")?0:this.sizeDiff.height;
...
this._propagate("stop",h);this._helper&&this.helper.remove();return false},_updateCache:function(h){this.offset=this.helper.offset();if(e(h.left))this.position.left=h.left;if(e(h.top))this.position.top=h.top;if(e(h.height))this.size.height=h.height;if(e(h.width))this.size.width=h.width},_updateRatio:function(h){var g=this.position,a=this.size,f=this.axis;if(h.height)h.width=a.height*this.aspectRatio;else if(h.width)h.height=a.width/this.aspectRatio;if(f=="sw"){h.left=g.left+(a.width-h.width);h.top=
null}if(f=="nw"){h.top=g.top+(a.height-h.height);h.left=g.left+(a.width-h.width)}return h},_respectSize:function(h){var g=this.options,a=this.axis,f=e(h.width)&&g.maxWidth&&g.maxWidth<h.width,i=e(h.height)&&g.maxHeight&&g.maxHeight<h.height,j=e(h.width)&&g.minWidth&&g.minWidth>h.width,l=e(h.height)&&g.minHeight&&g.minHeight>h.height;if(j)h.width=g.minWidth;if(l)h.height=g.minHeight;if(f)h.width=g.maxWidth;if(i)h.height=g.maxHeight;var o=this.originalPosition.left+this.originalSize.width,m=this.position.top+
this.size.height,k=/sw|nw|w/.test(a);a=/nw|ne|n/.test(a);if(j&&k)h.left=o-g.minWidth;if(f&&k)h.left=o-g.maxWidth;if(l&&a)h.top=m-g.minHeight;if(i&&a)h.top=m-g.maxHeight;if((g=!h.width&&!h.height)&&!h.left&&h.top)h.top=null;else if(g&&!h.top&&h.left)h.left=null;return h},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var h=this.helper||this.element,g=0;g<this._proportionallyResizeElements.length;g++){var a=this._proportionallyResizeElements[g];if(!this.borderDif){var f=
[a.css("borderTopWidth"),a.css("borderRightWidth"),a.css("borderBottomWidth"),a.css("borderLeftWidth")],i=[a.css("paddingTop"),a.css("paddingRight"),a.css("paddingBottom"),a.css("paddingLeft")];this.borderDif=b.map(f,function(j,l){var o=parseInt(j,10)||0,m=parseInt(i[l],10)||0;return o+m})}b.browser.msie&&(b(h).is(":hidden")||b(h).parents(":hidden").length)||a.css({height:h.height()-this.borderDif[0]-this.borderDif[2]||0,width:h.width()-this.borderDif[1]-this.borderDif[3]||0})}},_renderProxy:function(){var h=
...
h.ghost&&h.ghost.css({position:"relative",height:h.size.height,width:h.size.width})},stop:function(){var h=b(this).data("resizable");h.ghost&&h.helper&&h.helper.get(0).removeChild(h.ghost.get(0))}});b.ui.plugin.add("resizable","grid",{resize:function(){var h=b(this).data("resizable"),g=h.options,a=h.size,f=h.originalSize,i=h.originalPosition,j=h.axis;g.grid=typeof g.grid=="number"?[g.grid,g.grid]:g.grid;var l=Math.round((a.width-f.width)/(g.grid[0]||1))*(g.grid[0]||1);g=Math.round((a.height-f.height)/
(g.grid[1]||1))*(g.grid[1]||1);if(/^(se|s|e)$/.test(j)){h.size.width=f.width+l;h.size.height=f.height+g}else if(/^(ne)$/.test(j)){h.size.width=f.width+l;h.size.height=f.height+g;h.position.top=i.top-g}else{if(/^(sw)$/.test(j)){h.size.width=f.width+l;h.size.height=f.height+g}else{h.size.width=f.width+l;h.size.height=f.height+g;h.position.top=i.top-g}h.position.left=i.left-l}}});var d=function(h){return parseInt(h,10)||0},e=function(h){return!isNaN(parseInt(h,10))}})(jQuery);
(function(b){b.widget("ui.selectable",b.ui.mouse,{options:{appendTo:"body",autoRefresh:true,distance:0,filter:"*",tolerance:"touch"},_create:function(){var d=this;this.element.addClass("ui-selectable");this.dragged=false;var e;this.refresh=function(){e=b(d.options.filter,d.element[0]);e.each(function(){var h=b(this),g=h.offset();b.data(this,"selectable-item",{element:this,$element:h,left:g.left,top:g.top,right:g.left+h.outerWidth(),bottom:g.top+h.outerHeight(),startselected:false,selected:h.hasClass("ui-selected"),
...
d.pageY];if(!this.options.disabled){var h=this.options;this.selectees=b(h.filter,this.element[0]);this._trigger("start",d);b(h.appendTo).append(this.helper);this.helper.css({left:d.clientX,top:d.clientY,width:0,height:0});h.autoRefresh&&this.refresh();this.selectees.filter(".ui-selected").each(function(){var g=b.data(this,"selectable-item");g.startselected=true;if(!d.metaKey){g.$element.removeClass("ui-selected");g.selected=false;g.$element.addClass("ui-unselecting");g.unselecting=true;e._trigger("unselecting",
d,{unselecting:g.element})}});b(d.target).parents().andSelf().each(function(){var g=b.data(this,"selectable-item");if(g){var a=!d.metaKey||!g.$element.hasClass("ui-selected");g.$element.removeClass(a?"ui-unselecting":"ui-selected").addClass(a?"ui-selecting":"ui-unselecting");g.unselecting=!a;g.selecting=a;(g.selected=a)?e._trigger("selecting",d,{selecting:g.element}):e._trigger("unselecting",d,{unselecting:g.element});return false}})}},_mouseDrag:function(d){var e=this;this.dragged=true;if(!this.options.disabled){var h=
...
d.widgetBaseClass+"-item-icon ui-icon "+i+'"></span>');h[a].bgImage&&f.find("span").css("background-image",h[a].bgImage)}}a=e.style=="dropdown";this.newelement.toggleClass(d.widgetBaseClass+"-dropdown",a).toggleClass(d.widgetBaseClass+"-popup",!a);this.list.toggleClass(d.widgetBaseClass+"-menu-dropdown ui-corner-bottom",a).toggleClass(d.widgetBaseClass+"-menu-popup ui-corner-all",!a).find("li:first").toggleClass("ui-corner-top",!a).end().find("li:last").addClass("ui-corner-bottom");this.selectmenuIcon.toggleClass("ui-icon-triangle-1-s",
a).toggleClass("ui-icon-triangle-2-n-s",!a);if(e.transferClasses){a=this.element.attr("class")||"";this.newelement.add(this.list).addClass(a)}a=this.element.width();e.style=="dropdown"?this.list.width(e.menuWidth?e.menuWidth:e.width?e.width:a):this.list.width(e.menuWidth?e.menuWidth:e.width?e.width-e.handleWidth:a-e.handleWidth);if(e.maxHeight)e.maxHeight<this.list.height()&&this.list.height(e.maxHeight);else if(!e.format&&b(window).height()/3<this.list.height()){e.maxHeight=b(window).height()/3;
this.list.height(e.maxHeight)}this._optionLis=this.list.find("li:not(."+d.widgetBaseClass+"-group)");this.element.attr("disabled")===true&&this.disable();this.index(this._selectedIndex());window.setTimeout(function(){d._refreshPosition()},200)},destroy:function(){this.element.removeData(this.widgetName).removeClass(this.widgetBaseClass+"-disabled "+this.namespace+"-state-disabled").removeAttr("aria-disabled").unbind(".selectmenu");b(window).unbind(".selectmenu");b(document).unbind(".selectmenu");
b("label[for="+this.newelement.attr("id")+"]").attr("for",this.element.attr("id")).unbind(".selectmenu");if(this.options.wrapperElement){this.newelement.find(this.options.wrapperElement).remove();this.list.find(this.options.wrapperElement).remove()}else{this.newelement.remove();this.list.remove()}this.element.show();b.Widget.prototype.destroy.apply(this,arguments)},_typeAhead:function(d,e){var h=this,g=false,a=String.fromCharCode(d);c=a.toLowerCase();if(h.options.typeAhead=="sequential"){window.clearTimeout("ui.selectmenu-"+
h.selectmenuId);var f=typeof h._prevChar=="undefined"?"":h._prevChar.join(""),i=function(j,l,o){g=true;b(j).trigger(e);typeof h._prevChar=="undefined"?h._prevChar=[o]:h._prevChar[h._prevChar.length]=o};this.list.find("li a").each(function(j){if(!g){var l=b(this).attr("typeahead")||b(this).text();if(l.indexOf(f+a)==0)i(this,j,a);else l.indexOf(f+c)==0&&i(this,j,c)}});window.setTimeout(function(j){j._prevChar=undefined},1E3,h)}else{if(!h._prevChar)h._prevChar=["",0];g=false;this.list.find("li a").each(function(j){if(!g){var l=
b(this).text();if(l.indexOf(a)==0||l.indexOf(c)==0)if(h._prevChar[0]==a){if(h._prevChar[1]<j){g=true;b(this).trigger(e);h._prevChar[1]=j}}else{g=true;b(this).trigger(e);h._prevChar[1]=j}}});this._prevChar[0]=a}},_uiHash:function(){var d=this.index();return{index:d,option:b("option",this.element).get(d),value:this.element[0].value}},open:function(d){if(this.newelement.attr("aria-disabled")!="true"){this._closeOthers(d);this.newelement.addClass("ui-state-active");this.options.wrapperElement?this.list.parent().appendTo("body"):
...
"-open");this.options.style=="dropdown"&&this.newelement.removeClass("ui-corner-top").addClass("ui-corner-all");e&&this.newelement.focus();this._trigger("close",d,this._uiHash())}},change:function(d){this.element.trigger("change");this._trigger("change",d,this._uiHash())},select:function(d){this._trigger("select",d,this._uiHash())},_closeOthers:function(d){b("."+this.widgetBaseClass+".ui-state-active").not(this.newelement).each(function(){b(this).data("selectelement").selectmenu("close",d)});b("."+
...
this.list.find("li:first").outerHeight());e=d=="up"?-e:e;this._moveFocus(e)},_setOption:function(d,e){this.options[d]=e;if(d=="disabled"){this.close();this.element.add(this.newelement).add(this.list)[e?"addClass":"removeClass"](this.widgetBaseClass+"-disabled "+this.namespace+"-state-disabled").attr("aria-disabled",e)}},index:function(d){if(arguments.length){this.element[0].selectedIndex=d;this._refreshValue()}else return this._selectedIndex()},value:function(d){if(arguments.length){this.element[0].value=
...
else{b(".ui-slider .ui-state-focus").removeClass("ui-state-focus");b(this).addClass("ui-state-focus")}}).blur(function(){b(this).removeClass("ui-state-focus")});this.handles.each(function(h){b(this).data("index.ui-slider-handle",h)});this.handles.keydown(function(h){var g=true,a=b(this).data("index.ui-slider-handle"),f,i,j;if(!d.options.disabled){switch(h.keyCode){case b.ui.keyCode.HOME:case b.ui.keyCode.END:case b.ui.keyCode.PAGE_UP:case b.ui.keyCode.PAGE_DOWN:case b.ui.keyCode.UP:case b.ui.keyCode.RIGHT:case b.ui.keyCode.DOWN:case b.ui.keyCode.LEFT:g=
false;if(!d._keySliding){d._keySliding=true;b(this).addClass("ui-state-active");f=d._start(h,a);if(f===false)return}}j=d.options.step;f=d.options.values&&d.options.values.length?i=d.values(a):i=d.value();switch(h.keyCode){case b.ui.keyCode.HOME:i=d._valueMin();break;case b.ui.keyCode.END:i=d._valueMax();break;case b.ui.keyCode.PAGE_UP:i=d._trimAlignValue(f+(d._valueMax()-d._valueMin())/5);break;case b.ui.keyCode.PAGE_DOWN:i=d._trimAlignValue(f-(d._valueMax()-d._valueMin())/5);break;case b.ui.keyCode.UP:case b.ui.keyCode.RIGHT:if(f===
d._valueMax())return;i=d._trimAlignValue(f+j);break;case b.ui.keyCode.DOWN:case b.ui.keyCode.LEFT:if(f===d._valueMin())return;i=d._trimAlignValue(f-j)}d._slide(h,a,i);return g}}).keyup(function(h){var g=b(this).data("index.ui-slider-handle");if(d._keySliding){d._keySliding=false;d._stop(h,g);d._change(h,g);b(this).removeClass("ui-state-active")}});this._refreshValue();this._animateOff=false},destroy:function(){this.handles.remove();this.range.remove();this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-slider-disabled ui-widget ui-widget-content ui-corner-all").removeData("slider").unbind(".slider");
this._mouseDestroy();return this},_mouseCapture:function(d){var e=this.options,h,g,a,f,i;if(e.disabled)return false;this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();h=this._normValueFromMouse({x:d.pageX,y:d.pageY});g=this._valueMax()-this._valueMin()+1;f=this;this.handles.each(function(j){var l=Math.abs(h-f.values(j));if(g>l){g=l;a=b(this);i=j}});if(e.range===true&&this.values(1)===e.min){i+=1;a=b(this.handles[i])}if(this._start(d,
i)===false)return false;this._mouseSliding=true;f._handleIndex=i;a.addClass("ui-state-active").focus();e=a.offset();this._clickOffset=!b(d.target).parents().andSelf().is(".ui-slider-handle")?{left:0,top:0}:{left:d.pageX-e.left-a.width()/2,top:d.pageY-e.top-a.height()/2-(parseInt(a.css("borderTopWidth"),10)||0)-(parseInt(a.css("borderBottomWidth"),10)||0)+(parseInt(a.css("marginTop"),10)||0)};this.handles.hasClass("ui-state-hover")||this._slide(d,i,h);return this._animateOff=true},_mouseStart:function(){return true},
...
if(this.orientation==="horizontal"){e=this.elementSize.width;d=d.x-this.elementOffset.left-(this._clickOffset?this._clickOffset.left:0)}else{e=this.elementSize.height;d=d.y-this.elementOffset.top-(this._clickOffset?this._clickOffset.top:0)}e=d/e;if(e>1)e=1;if(e<0)e=0;if(this.orientation==="vertical")e=1-e;d=this._valueMax()-this._valueMin();return this._trimAlignValue(this._valueMin()+e*d)},_start:function(d,e){var h={handle:this.handles[e],value:this.value()};if(this.options.values&&this.options.values.length){h.value=
this.values(e);h.values=this.values()}return this._trigger("start",d,h)},_slide:function(d,e,h){var g;if(this.options.values&&this.options.values.length){g=this.values(e?0:1);if(this.options.values.length===2&&this.options.range===true&&(e===0&&h>g||e===1&&h<g))h=g;if(h!==this.values(e)){g=this.values();g[e]=h;d=this._trigger("slide",d,{handle:this.handles[e],value:h,values:g});this.values(e?0:1);d!==false&&this.values(e,h,true)}}else if(h!==this.value()){d=this._trigger("slide",d,{handle:this.handles[e],
value:h});d!==false&&this.value(h)}},_stop:function(d,e){var h={handle:this.handles[e],value:this.value()};if(this.options.values&&this.options.values.length){h.value=this.values(e);h.values=this.values()}this._trigger("stop",d,h)},_change:function(d,e){if(!this._keySliding&&!this._mouseSliding){var h={handle:this.handles[e],value:this.value()};if(this.options.values&&this.options.values.length){h.value=this.values(e);h.values=this.values()}this._trigger("change",d,h)}},value:function(d){if(arguments.length){this.options.value=
this._trimAlignValue(d);this._refreshValue();this._change(null,0)}return this._value()},values:function(d,e){var h,g,a;if(arguments.length>1){this.options.values[d]=this._trimAlignValue(e);this._refreshValue();this._change(null,d)}if(arguments.length)if(b.isArray(arguments[0])){h=this.options.values;g=arguments[0];for(a=0;a<h.length;a+=1){h[a]=this._trimAlignValue(g[a]);this._change(null,a)}this._refreshValue()}else return this.options.values&&this.options.values.length?this._values(d):this.value();
else return this._values()},_setOption:function(d,e){var h,g=0;if(b.isArray(this.options.values))g=this.options.values.length;b.Widget.prototype._setOption.apply(this,arguments);switch(d){case "disabled":if(e){this.handles.filter(".ui-state-focus").blur();this.handles.removeClass("ui-state-hover");this.handles.attr("disabled","disabled");this.element.addClass("ui-disabled")}else{this.handles.removeAttr("disabled");this.element.removeClass("ui-disabled")}break;case "orientation":this._detectOrientation();
this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addClass("ui-slider-"+this.orientation);this._refreshValue();break;case "value":this._animateOff=true;this._refreshValue();this._change(null,0);this._animateOff=false;break;case "values":this._animateOff=true;this._refreshValue();for(h=0;h<g;h+=1)this._change(null,h);this._animateOff=false}},_value:function(){var d=this.options.value;return d=this._trimAlignValue(d)},_values:function(d){var e,h;if(arguments.length){e=this.options.values[d];
...
this.element[i.collapsible?"addClass":"removeClass"]("ui-tabs-collapsible");i.cookie&&this._cookie(i.selected,i.cookie);g=0;for(var l;l=this.lis[g];g++)b(l)[b.inArray(g,i.disabled)!=-1&&!b(l).hasClass("ui-tabs-selected")?"addClass":"removeClass"]("ui-state-disabled");i.cache===false&&this.anchors.removeData("cache.tabs");this.lis.add(this.anchors).unbind(".tabs");if(i.event!=="mouseover"){var o=function(q,r){r.is(":not(.ui-state-disabled)")&&r.addClass("ui-state-"+q)};this.lis.bind("mouseover.tabs",
...
a,f){if(f===d)f=this.anchors.length;var i=this,j=this.options;a=b(j.tabTemplate.replace(/#\{href\}/g,g).replace(/#\{label\}/g,a));g=!g.indexOf("#")?g.replace("#",""):this._tabId(b("a",a)[0]);a.addClass("ui-state-default ui-corner-top").data("destroy.tabs",true);var l=i.element.find("#"+g);l.length||(l=b(j.panelTemplate).attr("id",g).data("destroy.tabs",true));l.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide");if(f>=this.lis.length){a.appendTo(this.list);l.appendTo(this.list[0].parentNode)}else{a.insertBefore(this.lis[f]);
l.insertBefore(this.panels[f])}j.disabled=b.map(j.disabled,function(o){return o>=f?++o:o});this._tabify();if(this.anchors.length==1){j.selected=0;a.addClass("ui-tabs-selected ui-state-active");l.removeClass("ui-tabs-hide");this.element.queue("tabs",function(){i._trigger("show",null,i._ui(i.anchors[0],i.panels[0]))});this.load(0)}this._trigger("add",null,this._ui(this.anchors[f],this.panels[f]));return this},remove:function(g){g=this._getIndex(g);var a=this.options,f=this.lis.eq(g).remove(),i=this.panels.eq(g).remove();
if(f.hasClass("ui-tabs-selected")&&this.anchors.length>1)this.select(g+(g+1<this.anchors.length?1:-1));a.disabled=b.map(b.grep(a.disabled,function(j){return j!=g}),function(j){return j>=g?--j:j});this._tabify();this._trigger("remove",null,this._ui(f.find("a")[0],i[0]));return this},enable:function(g){g=this._getIndex(g);var a=this.options;if(b.inArray(g,a.disabled)!=-1){this.lis.eq(g).removeClass("ui-state-disabled");a.disabled=b.grep(a.disabled,function(f){return f!=g});this._trigger("enable",null,
...
k[p]=m[n]}}else for(n in m)if(typeof m[n]==="string")k[n]=m[n];return k}function g(m){var k,n;for(k in m){n=m[k];if(n==null||b.isFunction(n)||k in o||/scrollbar/.test(k)||!/color/i.test(k)&&isNaN(parseFloat(n)))delete m[k]}return m}function a(m,k){var n={_:0},p;for(p in k)if(m[p]!=k[p])n[p]=k[p];return n}function f(m,k,n,p){if(typeof m=="object"){p=k;n=null;k=m;m=k.effect}if(b.isFunction(k)){p=k;n=null;k={}}if(typeof k=="number"||b.fx.speeds[k]){p=n;n=k;k={}}if(b.isFunction(n)){p=n;n=null}k=k||{};
n=n||k.duration;n=b.fx.off?0:typeof n=="number"?n:n in b.fx.speeds?b.fx.speeds[n]:b.fx.speeds._default;p=p||k.complete;return[m,k,n,p]}function i(m){if(!m||typeof m==="number"||b.fx.speeds[m])return true;if(typeof m==="string"&&!b.effects[m])return true;return false}b.effects={};b.each(["backgroundColor","borderBottomColor","borderLeftColor","borderRightColor","borderTopColor","borderColor","color","outlineColor"],function(m,k){b.fx.step[k]=function(n){if(!n.colorInit){var p;p=n.elem;var q=k,r;do{r=
b.curCSS(p,q);if(r!=""&&r!="transparent"||b.nodeName(p,"body"))break;q="backgroundColor"}while(p=p.parentNode);p=e(r);n.start=p;n.end=e(n.end);n.colorInit=true}n.elem.style[k]="rgb("+Math.max(Math.min(parseInt(n.pos*(n.end[0]-n.start[0])+n.start[0],10),255),0)+","+Math.max(Math.min(parseInt(n.pos*(n.end[1]-n.start[1])+n.start[1],10),255),0)+","+Math.max(Math.min(parseInt(n.pos*(n.end[2]-n.start[2])+n.start[2],10),255),0)+")"}});var j={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,
...
else{var k=f.apply(this,arguments);k[1].mode="show";return this.effect.apply(this,k)}},_hide:b.fn.hide,hide:function(m){if(i(m))return this._hide.apply(this,arguments);else{var k=f.apply(this,arguments);k[1].mode="hide";return this.effect.apply(this,k)}},__toggle:b.fn.toggle,toggle:function(m){if(i(m)||typeof m==="boolean"||b.isFunction(m))return this.__toggle.apply(this,arguments);else{var k=f.apply(this,arguments);k[1].mode="toggle";return this.effect.apply(this,k)}},cssUnit:function(m){var k=this.css(m),
n=[];b.each(["em","px","%","pt"],function(p,q){if(k.indexOf(q)>0)n=[parseFloat(k),q]});return n}});b.easing.jswing=b.easing.swing;b.extend(b.easing,{def:"easeOutQuad",swing:function(m,k,n,p,q){return b.easing[b.easing.def](m,k,n,p,q)},easeInQuad:function(m,k,n,p,q){return p*(k/=q)*k+n},easeOutQuad:function(m,k,n,p,q){return-p*(k/=q)*(k-2)+n},easeInOutQuad:function(m,k,n,p,q){if((k/=q/2)<1)return p/2*k*k+n;return-p/2*(--k*(k-2)-1)+n},easeInCubic:function(m,k,n,p,q){return p*(k/=q)*k*k+n},easeOutCubic:function(m,
k,n,p,q){return p*((k=k/q-1)*k*k+1)+n},easeInOutCubic:function(m,k,n,p,q){if((k/=q/2)<1)return p/2*k*k*k+n;return p/2*((k-=2)*k*k+2)+n},easeInQuart:function(m,k,n,p,q){return p*(k/=q)*k*k*k+n},easeOutQuart:function(m,k,n,p,q){return-p*((k=k/q-1)*k*k*k-1)+n},easeInOutQuart:function(m,k,n,p,q){if((k/=q/2)<1)return p/2*k*k*k*k+n;return-p/2*((k-=2)*k*k*k-2)+n},easeInQuint:function(m,k,n,p,q){return p*(k/=q)*k*k*k*k+n},easeOutQuint:function(m,k,n,p,q){return p*((k=k/q-1)*k*k*k*k+1)+n},easeInOutQuint:function(m,
k,n,p,q){if((k/=q/2)<1)return p/2*k*k*k*k*k+n;return p/2*((k-=2)*k*k*k*k+2)+n},easeInSine:function(m,k,n,p,q){return-p*Math.cos(k/q*(Math.PI/2))+p+n},easeOutSine:function(m,k,n,p,q){return p*Math.sin(k/q*(Math.PI/2))+n},easeInOutSine:function(m,k,n,p,q){return-p/2*(Math.cos(Math.PI*k/q)-1)+n},easeInExpo:function(m,k,n,p,q){return k==0?n:p*Math.pow(2,10*(k/q-1))+n},easeOutExpo:function(m,k,n,p,q){return k==q?n+p:p*(-Math.pow(2,-10*k/q)+1)+n},easeInOutExpo:function(m,k,n,p,q){if(k==0)return n;if(k==
q)return n+p;if((k/=q/2)<1)return p/2*Math.pow(2,10*(k-1))+n;return p/2*(-Math.pow(2,-10*--k)+2)+n},easeInCirc:function(m,k,n,p,q){return-p*(Math.sqrt(1-(k/=q)*k)-1)+n},easeOutCirc:function(m,k,n,p,q){return p*Math.sqrt(1-(k=k/q-1)*k)+n},easeInOutCirc:function(m,k,n,p,q){if((k/=q/2)<1)return-p/2*(Math.sqrt(1-k*k)-1)+n;return p/2*(Math.sqrt(1-(k-=2)*k)+1)+n},easeInElastic:function(m,k,n,p,q){m=1.70158;var r=0,s=p;if(k==0)return n;if((k/=q)==1)return n+p;r||(r=q*0.3);if(s<Math.abs(p)){s=p;m=r/4}else m=
r/(2*Math.PI)*Math.asin(p/s);return-(s*Math.pow(2,10*(k-=1))*Math.sin((k*q-m)*2*Math.PI/r))+n},easeOutElastic:function(m,k,n,p,q){m=1.70158;var r=0,s=p;if(k==0)return n;if((k/=q)==1)return n+p;r||(r=q*0.3);if(s<Math.abs(p)){s=p;m=r/4}else m=r/(2*Math.PI)*Math.asin(p/s);return s*Math.pow(2,-10*k)*Math.sin((k*q-m)*2*Math.PI/r)+p+n},easeInOutElastic:function(m,k,n,p,q){m=1.70158;var r=0,s=p;if(k==0)return n;if((k/=q/2)==2)return n+p;r||(r=q*0.3*1.5);if(s<Math.abs(p)){s=p;m=r/4}else m=r/(2*Math.PI)*Math.asin(p/
s);if(k<1)return-0.5*s*Math.pow(2,10*(k-=1))*Math.sin((k*q-m)*2*Math.PI/r)+n;return s*Math.pow(2,-10*(k-=1))*Math.sin((k*q-m)*2*Math.PI/r)*0.5+p+n},easeInBack:function(m,k,n,p,q,r){if(r==d)r=1.70158;return p*(k/=q)*k*((r+1)*k-r)+n},easeOutBack:function(m,k,n,p,q,r){if(r==d)r=1.70158;return p*((k=k/q-1)*k*((r+1)*k+r)+1)+n},easeInOutBack:function(m,k,n,p,q,r){if(r==d)r=1.70158;if((k/=q/2)<1)return p/2*k*k*(((r*=1.525)+1)*k-r)+n;return p/2*((k-=2)*k*(((r*=1.525)+1)*k+r)+2)+n},easeInBounce:function(m,
k,n,p,q){return p-b.easing.easeOutBounce(m,q-k,0,p,q)+n},easeOutBounce:function(m,k,n,p,q){return(k/=q)<1/2.75?p*7.5625*k*k+n:k<2/2.75?p*(7.5625*(k-=1.5/2.75)*k+0.75)+n:k<2.5/2.75?p*(7.5625*(k-=2.25/2.75)*k+0.9375)+n:p*(7.5625*(k-=2.625/2.75)*k+0.984375)+n},easeInOutBounce:function(m,k,n,p,q){if(k<q/2)return b.easing.easeInBounce(m,k*2,0,p,q)*0.5+n;return b.easing.easeOutBounce(m,k*2-q,0,p,q)*0.5+p*0.5+n}})}(jQuery);
(function(b){b.effects.blind=function(d){return this.queue(function(){var e=b(this),h=["position","top","bottom","left","right"],g=b.effects.setMode(e,d.options.mode||"hide"),a=d.options.direction||"vertical";b.effects.save(e,h);e.show();var f=b.effects.createWrapper(e).css({overflow:"hidden"}),i=a=="vertical"?"height":"width";a=a=="vertical"?f.height():f.width();g=="show"&&f.css(i,0);var j={};j[i]=g=="show"?a:0;f.animate(j,d.duration,d.options.easing,function(){g=="hide"&&e.hide();b.effects.restore(e,
h);b.effects.removeWrapper(e);d.callback&&d.callback.apply(e[0],arguments);e.dequeue()})})}})(jQuery);
(function(b){b.effects.bounce=function(d){return this.queue(function(){var e=b(this),h=["position","top","bottom","left","right"],g=b.effects.setMode(e,d.options.mode||"effect"),a=d.options.direction||"up",f=d.options.distance||20,i=d.options.times||5,j=d.duration||250;/show|hide/.test(g)&&h.push("opacity");b.effects.save(e,h);e.show();b.effects.createWrapper(e);var l=a=="up"||a=="down"?"top":"left";a=a=="up"||a=="left"?"pos":"neg";f=d.options.distance||(l=="top"?e.outerHeight({margin:true})/3:e.outerWidth({margin:true})/
3);if(g=="show")e.css("opacity",0).css(l,a=="pos"?-f:f);if(g=="hide")f/=i*2;g!="hide"&&i--;if(g=="show"){var o={opacity:1};o[l]=(a=="pos"?"+=":"-=")+f;e.animate(o,j/2,d.options.easing);f/=2;i--}for(o=0;o<i;o++){var m={},k={};m[l]=(a=="pos"?"-=":"+=")+f;k[l]=(a=="pos"?"+=":"-=")+f;e.animate(m,j/2,d.options.easing).animate(k,j/2,d.options.easing);f=g=="hide"?f*2:f/2}if(g=="hide"){o={opacity:0};o[l]=(a=="pos"?"-=":"+=")+f;e.animate(o,j/2,d.options.easing,function(){e.hide();b.effects.restore(e,h);b.effects.removeWrapper(e);
d.callback&&d.callback.apply(this,arguments)})}else{m={};k={};m[l]=(a=="pos"?"-=":"+=")+f;k[l]=(a=="pos"?"+=":"-=")+f;e.animate(m,j/2,d.options.easing).animate(k,j/2,d.options.easing,function(){b.effects.restore(e,h);b.effects.removeWrapper(e);d.callback&&d.callback.apply(this,arguments)})}e.queue("fx",function(){e.dequeue()});e.dequeue()})}})(jQuery);
(function(b){b.effects.clip=function(d){return this.queue(function(){var e=b(this),h=["position","top","bottom","left","right","height","width"],g=b.effects.setMode(e,d.options.mode||"hide"),a=d.options.direction||"vertical";b.effects.save(e,h);e.show();var f=b.effects.createWrapper(e).css({overflow:"hidden"});f=e[0].tagName=="IMG"?f:e;var i={size:a=="vertical"?"height":"width",position:a=="vertical"?"top":"left"};a=a=="vertical"?f.height():f.width();if(g=="show"){f.css(i.size,0);f.css(i.position,
a/2)}var j={};j[i.size]=g=="show"?a:0;j[i.position]=g=="show"?0:a/2;f.animate(j,{queue:false,duration:d.duration,easing:d.options.easing,complete:function(){g=="hide"&&e.hide();b.effects.restore(e,h);b.effects.removeWrapper(e);d.callback&&d.callback.apply(e[0],arguments);e.dequeue()}})})}})(jQuery);
(function(b){b.effects.drop=function(d){return this.queue(function(){var e=b(this),h=["position","top","bottom","left","right","opacity"],g=b.effects.setMode(e,d.options.mode||"hide"),a=d.options.direction||"left";b.effects.save(e,h);e.show();b.effects.createWrapper(e);var f=a=="up"||a=="down"?"top":"left";a=a=="up"||a=="left"?"pos":"neg";var i=d.options.distance||(f=="top"?e.outerHeight({margin:true})/2:e.outerWidth({margin:true})/2);if(g=="show")e.css("opacity",0).css(f,a=="pos"?-i:i);var j={opacity:g==
"show"?1:0};j[f]=(g=="show"?a=="pos"?"+=":"-=":a=="pos"?"-=":"+=")+i;e.animate(j,{queue:false,duration:d.duration,easing:d.options.easing,complete:function(){g=="hide"&&e.hide();b.effects.restore(e,h);b.effects.removeWrapper(e);d.callback&&d.callback.apply(this,arguments);e.dequeue()}})})}})(jQuery);
(function(b){b.effects.explode=function(d){return this.queue(function(){var e=d.options.pieces?Math.round(Math.sqrt(d.options.pieces)):3,h=d.options.pieces?Math.round(Math.sqrt(d.options.pieces)):3;d.options.mode=d.options.mode=="toggle"?b(this).is(":visible")?"hide":"show":d.options.mode;var g=b(this).show().css("visibility","hidden"),a=g.offset();a.top-=parseInt(g.css("marginTop"),10)||0;a.left-=parseInt(g.css("marginLeft"),10)||0;for(var f=g.outerWidth(true),i=g.outerHeight(true),j=0;j<e;j++)for(var l=
0;l<h;l++)g.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-l*(f/h),top:-j*(i/e)}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:f/h,height:i/e,left:a.left+l*(f/h)+(d.options.mode=="show"?(l-Math.floor(h/2))*(f/h):0),top:a.top+j*(i/e)+(d.options.mode=="show"?(j-Math.floor(e/2))*(i/e):0),opacity:d.options.mode=="show"?0:1}).animate({left:a.left+l*(f/h)+(d.options.mode=="show"?0:(l-Math.floor(h/2))*(f/h)),top:a.top+
j*(i/e)+(d.options.mode=="show"?0:(j-Math.floor(e/2))*(i/e)),opacity:d.options.mode=="show"?1:0},d.duration||500);setTimeout(function(){d.options.mode=="show"?g.css({visibility:"visible"}):g.css({visibility:"visible"}).hide();d.callback&&d.callback.apply(g[0]);g.dequeue();b("div.ui-effects-explode").remove()},d.duration||500)})}})(jQuery);
(function(b){b.effects.fade=function(d){return this.queue(function(){var e=b(this),h=b.effects.setMode(e,d.options.mode||"hide");e.animate({opacity:h},{queue:false,duration:d.duration,easing:d.options.easing,complete:function(){d.callback&&d.callback.apply(this,arguments);e.dequeue()}})})}})(jQuery);
(function(b){b.effects.fold=function(d){return this.queue(function(){var e=b(this),h=["position","top","bottom","left","right"],g=b.effects.setMode(e,d.options.mode||"hide"),a=d.options.size||15,f=!!d.options.horizFirst,i=d.duration?d.duration/2:b.fx.speeds._default/2;b.effects.save(e,h);e.show();var j=b.effects.createWrapper(e).css({overflow:"hidden"}),l=g=="show"!=f,o=l?["width","height"]:["height","width"];l=l?[j.width(),j.height()]:[j.height(),j.width()];var m=/([0-9]+)%/.exec(a);if(m)a=parseInt(m[1],
10)/100*l[g=="hide"?0:1];if(g=="show")j.css(f?{height:0,width:a}:{height:a,width:0});f={};m={};f[o[0]]=g=="show"?l[0]:a;m[o[1]]=g=="show"?l[1]:0;j.animate(f,i,d.options.easing).animate(m,i,d.options.easing,function(){g=="hide"&&e.hide();b.effects.restore(e,h);b.effects.removeWrapper(e);d.callback&&d.callback.apply(e[0],arguments);e.dequeue()})})}})(jQuery);
(function(b){b.effects.highlight=function(d){return this.queue(function(){var e=b(this),h=["backgroundImage","backgroundColor","opacity"],g=b.effects.setMode(e,d.options.mode||"show"),a={backgroundColor:e.css("backgroundColor")};if(g=="hide")a.opacity=0;b.effects.save(e,h);e.show().css({backgroundImage:"none",backgroundColor:d.options.color||"#ffff99"}).animate(a,{queue:false,duration:d.duration,easing:d.options.easing,complete:function(){g=="hide"&&e.hide();b.effects.restore(e,h);g=="show"&&!b.support.opacity&&
this.style.removeAttribute("filter");d.callback&&d.callback.apply(this,arguments);e.dequeue()}})})}})(jQuery);
(function(b){b.effects.pulsate=function(d){return this.queue(function(){var e=b(this),h=b.effects.setMode(e,d.options.mode||"show");times=(d.options.times||5)*2-1;duration=d.duration?d.duration/2:b.fx.speeds._default/2;isVisible=e.is(":visible");animateTo=0;if(!isVisible){e.css("opacity",0).show();animateTo=1}if(h=="hide"&&isVisible||h=="show"&&!isVisible)times--;for(h=0;h<times;h++){e.animate({opacity:animateTo},duration,d.options.easing);animateTo=(animateTo+1)%2}e.animate({opacity:animateTo},duration,
...
(function(b){b.effects.puff=function(d){return this.queue(function(){var e=b(this),h=b.effects.setMode(e,d.options.mode||"hide"),g=parseInt(d.options.percent,10)||150,a=g/100,f={height:e.height(),width:e.width()};b.extend(d.options,{fade:true,mode:h,percent:h=="hide"?g:100,from:h=="hide"?f:{height:f.height*a,width:f.width*a}});e.effect("scale",d.options,d.duration,d.callback);e.dequeue()})};b.effects.scale=function(d){return this.queue(function(){var e=b(this),h=b.extend(true,{},d.options),g=b.effects.setMode(e,
d.options.mode||"effect"),a=parseInt(d.options.percent,10)||(parseInt(d.options.percent,10)==0?0:g=="hide"?0:100),f=d.options.direction||"both",i=d.options.origin;if(g!="effect"){h.origin=i||["middle","center"];h.restore=true}i={height:e.height(),width:e.width()};e.from=d.options.from||(g=="show"?{height:0,width:0}:i);a={y:f!="horizontal"?a/100:1,x:f!="vertical"?a/100:1};e.to={height:i.height*a.y,width:i.width*a.x};if(d.options.fade){if(g=="show"){e.from.opacity=0;e.to.opacity=1}if(g=="hide"){e.from.opacity=
1;e.to.opacity=0}}h.from=e.from;h.to=e.to;h.mode=g;e.effect("size",h,d.duration,d.callback);e.dequeue()})};b.effects.size=function(d){return this.queue(function(){var e=b(this),h=["position","top","bottom","left","right","width","height","overflow","opacity"],g=["position","top","bottom","left","right","overflow","opacity"],a=["width","height","overflow"],f=["fontSize"],i=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],j=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],
l=b.effects.setMode(e,d.options.mode||"effect"),o=d.options.restore||false,m=d.options.scale||"both",k=d.options.origin,n={height:e.height(),width:e.width()};e.from=d.options.from||n;e.to=d.options.to||n;if(k){k=b.effects.getBaseline(k,n);e.from.top=(n.height-e.from.height)*k.y;e.from.left=(n.width-e.from.width)*k.x;e.to.top=(n.height-e.to.height)*k.y;e.to.left=(n.width-e.to.width)*k.x}var p={from:{y:e.from.height/n.height,x:e.from.width/n.width},to:{y:e.to.height/n.height,x:e.to.width/n.width}};
if(m=="box"||m=="both"){if(p.from.y!=p.to.y){h=h.concat(i);e.from=b.effects.setTransition(e,i,p.from.y,e.from);e.to=b.effects.setTransition(e,i,p.to.y,e.to)}if(p.from.x!=p.to.x){h=h.concat(j);e.from=b.effects.setTransition(e,j,p.from.x,e.from);e.to=b.effects.setTransition(e,j,p.to.x,e.to)}}if(m=="content"||m=="both")if(p.from.y!=p.to.y){h=h.concat(f);e.from=b.effects.setTransition(e,f,p.from.y,e.from);e.to=b.effects.setTransition(e,f,p.to.y,e.to)}b.effects.save(e,o?h:g);e.show();b.effects.createWrapper(e);
e.css("overflow","hidden").css(e.from);if(m=="content"||m=="both"){i=i.concat(["marginTop","marginBottom"]).concat(f);j=j.concat(["marginLeft","marginRight"]);a=h.concat(i).concat(j);e.find("*[width]").each(function(){child=b(this);o&&b.effects.save(child,a);var q={height:child.height(),width:child.width()};child.from={height:q.height*p.from.y,width:q.width*p.from.x};child.to={height:q.height*p.to.y,width:q.width*p.to.x};if(p.from.y!=p.to.y){child.from=b.effects.setTransition(child,i,p.from.y,child.from);
child.to=b.effects.setTransition(child,i,p.to.y,child.to)}if(p.from.x!=p.to.x){child.from=b.effects.setTransition(child,j,p.from.x,child.from);child.to=b.effects.setTransition(child,j,p.to.x,child.to)}child.css(child.from);child.animate(child.to,d.duration,d.options.easing,function(){o&&b.effects.restore(child,a)})})}e.animate(e.to,{queue:false,duration:d.duration,easing:d.options.easing,complete:function(){e.to.opacity===0&&e.css("opacity",e.from.opacity);l=="hide"&&e.hide();b.effects.restore(e,
o?h:g);b.effects.removeWrapper(e);d.callback&&d.callback.apply(this,arguments);e.dequeue()}})})}})(jQuery);
(function(b){b.effects.shake=function(d){return this.queue(function(){var e=b(this),h=["position","top","bottom","left","right"];b.effects.setMode(e,d.options.mode||"effect");var g=d.options.direction||"left",a=d.options.distance||20,f=d.options.times||3,i=d.duration||d.options.duration||140;b.effects.save(e,h);e.show();b.effects.createWrapper(e);var j=g=="up"||g=="down"?"top":"left",l=g=="up"||g=="left"?"pos":"neg";g={};var o={},m={};g[j]=(l=="pos"?"-=":"+=")+a;o[j]=(l=="pos"?"+=":"-=")+a*2;m[j]=
(l=="pos"?"-=":"+=")+a*2;e.animate(g,i,d.options.easing);for(a=1;a<f;a++)e.animate(o,i,d.options.easing).animate(m,i,d.options.easing);e.animate(o,i,d.options.easing).animate(g,i/2,d.options.easing,function(){b.effects.restore(e,h);b.effects.removeWrapper(e);d.callback&&d.callback.apply(this,arguments)});e.queue("fx",function(){e.dequeue()});e.dequeue()})}})(jQuery);
(function(b){b.effects.slide=function(d){return this.queue(function(){var e=b(this),h=["position","top","bottom","left","right"],g=b.effects.setMode(e,d.options.mode||"show"),a=d.options.direction||"left";b.effects.save(e,h);e.show();b.effects.createWrapper(e).css({overflow:"hidden"});var f=a=="up"||a=="down"?"top":"left";a=a=="up"||a=="left"?"pos":"neg";var i=d.options.distance||(f=="top"?e.outerHeight({margin:true}):e.outerWidth({margin:true}));if(g=="show")e.css(f,a=="pos"?isNaN(i)?"-"+i:-i:i);
var j={};j[f]=(g=="show"?a=="pos"?"+=":"-=":a=="pos"?"-=":"+=")+i;e.animate(j,{queue:false,duration:d.duration,easing:d.options.easing,complete:function(){g=="hide"&&e.hide();b.effects.restore(e,h);b.effects.removeWrapper(e);d.callback&&d.callback.apply(this,arguments);e.dequeue()}})})}})(jQuery);
(function(b){b.effects.transfer=function(d){return this.queue(function(){var e=b(this),h=b(d.options.to),g=h.offset();h={top:g.top,left:g.left,height:h.innerHeight(),width:h.innerWidth()};g=e.offset();var a=b('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(d.options.className).css({top:g.top,left:g.left,height:e.innerHeight(),width:e.innerWidth(),position:"absolute"}).animate(h,d.duration,d.options.easing,function(){a.remove();d.callback&&d.callback.apply(e[0],arguments);
e.dequeue()})})}})(jQuery);
