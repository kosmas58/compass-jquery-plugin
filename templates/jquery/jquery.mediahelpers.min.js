...
g=b("<body>").append(f);return function(c){if(!(c in a)){var d=b("<style type='text/css'>@media "+c+"{#jquery-mediatest{position:absolute;}}</style>");i.prepend(g).prepend(d);a[c]="absolute"===f.css("position");g.add(d).remove()}return a[c]}}();var h,k;b.event.special.orientationchange={setup:function(){if("orientation"in j)return!1;k=h();e.bind("resize",l)},teardown:function(){if(b.support.orientation)return!1;e.unbind("resize",l)},add:function(a){var b=a.handler;a.handler=function(a){a.orientation=
h();return b.apply(this,arguments)}}};h=function(){var a=n.documentElement;return a&&1.1>a.clientWidth/a.clientHeight?"portrait":"landscape"};b.mh.addResolutionBreakpoints=function(a){"array"===b.type(a)?d=d.concat(a):d.push(a);d.sort(function(a,b){return a-b});m()};e.bind("orientationchange.htmlclass resize.htmlclass",function(a){a.orientation&&i.removeClass("portrait landscape").addClass(a.orientation);m()});e.trigger("orientationchange.htmlclass")})(jQuery,this);
