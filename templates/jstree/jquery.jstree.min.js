(function(){if(!jQuery||!jQuery.jstree){var o=!1,p=!1,q=!1;(function(c){c.vakata={};c.vakata.css={get_css:function(a,c,b){var a=a.toLowerCase(),e=b.cssRules||b.rules,d=0;do{if(e.length&&d>e.length+5)break;if(e[d].selectorText&&e[d].selectorText.toLowerCase()==a)return!0===c?(b.removeRule&&b.removeRule(d),b.deleteRule&&b.deleteRule(d),!0):e[d]}while(e[++d]);return!1},add_css:function(a,b){if(c.jstree.css.get_css(a,!1,b))return!1;b.insertRule?b.insertRule(a+" { }",0):b.addRule(a,null,0);return c.vakata.css.get_css(a)},
...
_get_children:function(a){a=this._get_node(a);return-1===a?this.get_container().children("ul:eq(0)").children("li"):!a.length?!1:a.children("ul:eq(0)").children("li")},get_path:function(a,c){var b=[],e=this,a=this._get_node(a);if(-1===a||!a||!a.length)return!1;a.parentsUntil(".jstree","li").each(function(){b.push(c?this.id:e.get_text(this))});b.reverse();b.push(c?a.attr("id"):this.get_text(a));return b},_get_string:function(a){return this._get_settings().core.strings[a]||a},is_open:function(a){return(a=
...
e.after_close(a);this.__callback({obj:a})},after_close:function(a){this.__callback({obj:a})},toggle_node:function(a){a=this._get_node(a);if(a.hasClass("jstree-closed"))return this.open_node(a);if(a.hasClass("jstree-open"))return this.close_node(a)},open_all:function(a,c,b){a=a?this._get_node(a):-1;if(!a||-1===a)a=this.get_container_ul();b?a=a.find("li.jstree-closed"):(b=a,a=a.is(".jstree-closed")?a.find("li.jstree-closed").andSelf():a.find("li.jstree-closed"));var e=this;a.each(function(){var a=this;
e._is_loaded(this)?e.open_node(this,!1,!c):e.open_node(this,function(){e.open_all(a,c,b)},!c)});0===b.find("li.jstree-closed").length&&this.__callback({obj:b})},close_all:function(a,c){var b=this,a=a?this._get_node(a):this.get_container();if(!a||-1===a)a=this.get_container_ul();a.find("li.jstree-open").andSelf().each(function(){b.close_node(this,!c)});this.__callback({obj:a})},clean_node:function(a){a=a&&-1!=a?c(a):this.get_container_ul();a=a.is("li")?a.find("li").andSelf():a.find("li");a.removeClass("jstree-last").filter("li:last-child").addClass("jstree-last").end().filter(":has(li)").not(".jstree-open").removeClass("jstree-leaf").addClass("jstree-closed");
a.not(".jstree-open, .jstree-closed").addClass("jstree-leaf").children("ul").remove();this.__callback({obj:a})},get_rollback:function(){this.__callback();return{i:this.get_index(),h:this.get_container().children("ul").clone(!0),d:this.data}},set_rollback:function(a,c){this.get_container().empty().append(a);this.data=c;this.__callback()},load_node:function(a){this.__callback({obj:a})},_is_loaded:function(){return!0},create_node:function(a,b,e,d,k){var a=this._get_node(a),b="undefined"===typeof b?"last":
b,i=c("<li />"),m=this._get_settings().core,l;if(-1!==a&&!a.length)return!1;if(!k&&!this._is_loaded(a))return this.load_node(a,function(){this.create_node(a,b,e,d,!0)}),!1;this.__rollback();"string"===typeof e&&(e={data:e});e||(e={});e.attr&&i.attr(e.attr);e.metadata&&i.data(e.metadata);e.state&&i.addClass("jstree-"+e.state);if(!e.data)e.data=this._get_string("new_node");if(!c.isArray(e.data))l=e.data,e.data=[],e.data.push(l);c.each(e.data,function(a,b){l=c("<a />");c.isFunction(b)&&(b=b.call(this,
e));if("string"==typeof b)l.attr("href","#")[m.html_titles?"html":"text"](b);else{if(!b.attr)b.attr={};if(!b.attr.href)b.attr.href="#";l.attr(b.attr)[m.html_titles?"html":"text"](b.title);b.language&&l.addClass(b.language)}l.prepend("<ins class='jstree-icon'>&#160;</ins>");if(!b.icon&&e.icon)b.icon=e.icon;b.icon&&(-1===b.icon.indexOf("/")?l.children("ins").addClass(b.icon):l.children("ins").css("background","url('"+b.icon+"') center center no-repeat"));i.append(l)});i.prepend("<ins class='jstree-icon'>&#160;</ins>");
...
if(!a.length)return!1;this.__rollback();var b=this._get_parent(a),e=c([]),d=this;a.each(function(){e=e.add(d._get_prev(this))});a=a.detach();-1!==b&&0===b.find("> ul > li").length&&b.removeClass("jstree-open jstree-closed").addClass("jstree-leaf");this.clean_node(b);this.__callback({obj:a,prev:e,parent:b});return a},prepare_move:function(a,b,d,h,k){var i={};i.ot=c.jstree._reference(a)||this;i.o=i.ot._get_node(a);i.r=-1===b?-1:this._get_node(b);i.p="undefined"===typeof d||!1===d?"last":d;if(k||!e.o||
!(e.o[0]===i.o[0]&&e.r[0]===i.r[0]&&e.p===i.p)){i.ot=c.jstree._reference(i.o)||this;i.rt=c.jstree._reference(i.r)||this;if(-1===i.r||!i.r)switch(i.cr=-1,i.p){case "first":case "before":case "inside":i.cp=0;break;case "after":case "last":i.cp=i.rt.get_container().find(" > ul > li").length;break;default:i.cp=i.p}else{if(!/^(before|after)$/.test(i.p)&&!this._is_loaded(i.r))return this.load_node(i.r,function(){this.prepare_move(a,b,d,h,!0)});switch(i.p){case "before":i.cp=i.r.index();i.cr=i.rt._get_parent(i.r);
break;case "after":i.cp=i.r.index()+1;i.cr=i.rt._get_parent(i.r);break;case "inside":case "first":i.cp=0;i.cr=i.r;break;case "last":i.cp=i.r.find(" > ul > li").length;i.cr=i.r;break;default:i.cp=i.p,i.cr=i.r}}i.np=-1==i.cr?i.rt.get_container():i.cr;i.op=i.ot._get_parent(i.o);i.cop=i.o.index();if(-1===i.op)i.op=i.ot?i.ot.get_container():this.get_container();!/^(before|after)$/.test(i.p)&&i.op&&i.np&&i.op[0]===i.np[0]&&i.o.index()<i.cp&&i.cp++;i.or=i.np.find(" > ul > li:nth-child("+(i.cp+1)+")");e=
i}this.__callback(e);h&&h.call(this,e)},check_move:function(){var a=e,b=!0,c=-1===a.r?this.get_container():a.r;if(!a||!a.o||a.or[0]===a.o[0]||a.op&&a.np&&a.op[0]===a.np[0]&&a.cp-1===a.o.index())return!1;a.o.each(function(){if(-1!==c.parentsUntil(".jstree","li").andSelf().index(this))return b=!1});return b},move_node:function(a,b,d,h,k,i){if(!k)return this.prepare_move(a,b,d,function(a){this.move_node(a,!1,!1,h,!0,i)});if(h)e.cy=!0;if(!i&&!this.check_move())return!1;this.__rollback();b=!1;h?(b=a.o.clone(!0),
b.find("*[id]").andSelf().each(function(){if(this.id)this.id="copy_"+this.id})):b=a.o;a.or.length?a.or.before(b):(a.np.children("ul").length||c("<ul />").appendTo(a.np),a.np.children("ul:eq(0)").append(b));try{a.ot.clean_node(a.op),a.rt.clean_node(a.np),a.op.find("> ul > li").length||a.op.removeClass("jstree-open jstree-closed").addClass("jstree-leaf").children("ul").remove()}catch(m){}if(h)e.cy=!0,e.oc=b;this.__callback(e);return e},_get_move:function(){return e}}})})(jQuery);(function(c){var a,
...
this.hover_node(a.target)},this)).delegate("a","mouseleave.jstree",c.proxy(function(a){c(a.currentTarget).hasClass("jstree-loading")||this.dehover_node(a.target)},this)).bind("reopen.jstree",c.proxy(function(){this.reselect()},this)).bind("get_rollback.jstree",c.proxy(function(){this.dehover_node();this.save_selected()},this)).bind("set_rollback.jstree",c.proxy(function(){this.reselect()},this)).bind("close_node.jstree",c.proxy(function(a,b){var d=this._get_settings().ui,j=this._get_node(b.rslt.obj),
h=j&&j.length?j.children("ul").find("a.jstree-clicked"):c(),k=this;!1!==d.selected_parent_close&&h.length&&h.each(function(){k.deselect_node(this);"select_parent"===d.selected_parent_close&&k.select_node(j)})},this)).bind("delete_node.jstree",c.proxy(function(a,b){var c=this._get_settings().ui.select_prev_on_delete,d=this._get_node(b.rslt.obj),d=d&&d.length?d.find("a.jstree-clicked"):[],h=this;d.each(function(){h.deselect_node(this)});c&&d.length&&b.rslt.prev.each(function(){if(this.parentNode)return h.select_node(this),
...
if(!a.length)return!1;a.hasClass("jstree-hovered")||this.dehover_node();this.data.ui.hovered=a.children("a").addClass("jstree-hovered").parent();this._fix_scroll(a);this.__callback({obj:a})},dehover_node:function(){var a=this.data.ui.hovered;if(!a||!a.length)return!1;if(this.data.ui.hovered[0]===a.children("a").removeClass("jstree-hovered").parent()[0])this.data.ui.hovered=null;this.__callback({obj:a})},select_node:function(a,b,c){a=this._get_node(a);if(-1==a||!a||!a.length)return!1;var d=this._get_settings().ui,
h="on"==d.select_multiple_modifier||!1!==d.select_multiple_modifier&&c&&c[d.select_multiple_modifier+"Key"],k=!1!==d.select_range_modifier&&c&&c[d.select_range_modifier+"Key"]&&this.data.ui.last_selected&&this.data.ui.last_selected[0]!==a[0]&&this.data.ui.last_selected.parent()[0]===a.parent()[0],i=this.is_selected(a),m=!0,l=this;if(b){if(d.disable_selecting_children&&h&&(a.parentsUntil(".jstree","li").children("a.jstree-clicked").length||a.children("ul").find("a.jstree-clicked:eq(0)").length))return!1;
m=!1;switch(!0){case k:this.data.ui.last_selected.addClass("jstree-last-selected");a=a[a.index()<this.data.ui.last_selected.index()?"nextUntil":"prevUntil"](".jstree-last-selected").andSelf();-1==d.select_limit||a.length<d.select_limit?(this.data.ui.last_selected.removeClass("jstree-last-selected"),this.data.ui.selected.each(function(){this!==l.data.ui.last_selected[0]&&l.deselect_node(this)}),i=!1,m=!0):m=!1;break;case i&&!h:this.deselect_all();i=!1;m=!0;break;case !i&&!h:if(-1==d.select_limit||
0<d.select_limit)this.deselect_all(),m=!0;break;case i&&h:this.deselect_node(a);break;case !i&&h:if(-1==d.select_limit||this.data.ui.selected.length+1<=d.select_limit)m=!0}}if(m&&!i){if(!k)this.data.ui.last_selected=a;a.children("a").addClass("jstree-clicked");d.selected_parent_open&&a.parents(".jstree-closed").each(function(){l.open_node(this,!1,!0)});this.data.ui.selected=this.data.ui.selected.add(a);this._fix_scroll(a.eq(0));this.__callback({obj:a,e:c})}},_fix_scroll:function(b){var c=this.get_container()[0];
if(c.scrollHeight>c.offsetHeight&&(b=this._get_node(b))&&!(-1===b||!b.length||!b.is(":visible"))){b=b.offset().top-this.get_container().offset().top;if(0>b)c.scrollTop=c.scrollTop+b-1;if(b+this.data.core.li_height+(c.scrollWidth>c.offsetWidth?a:0)>c.offsetHeight)c.scrollTop+=b-c.offsetHeight+this.data.core.li_height+1+(c.scrollWidth>c.offsetWidth?a:0)}},deselect_node:function(a){a=this._get_node(a);if(!a.length)return!1;if(this.is_selected(a)){a.children("a").removeClass("jstree-clicked");this.data.ui.selected=
this.data.ui.selected.not(a);if(this.data.ui.last_selected.get(0)===a.get(0))this.data.ui.last_selected=this.data.ui.selected.eq(0);this.__callback({obj:a})}},toggle_select:function(a){a=this._get_node(a);if(!a.length)return!1;this.is_selected(a)?this.deselect_node(a):this.select_node(a)},is_selected:function(a){return 0<=this.data.ui.selected.index(this._get_node(a))},get_selected:function(a){return a?c(a).find("a.jstree-clicked").parent():this.data.ui.selected},deselect_all:function(a){a=a?c(a).find("a.jstree-clicked").parent():
...
!1,!0)})}},this))},defaults:{input_width_limit:200,move:{always_copy:!1,open_onmove:!0,default_position:"last",check_move:function(){return!0}}},_fn:{_show_input:function(a,b){var a=this._get_node(a),d=this._get_settings().core.rtl,e=this._get_settings().crrm.input_width_limit,f=a.children("ins").width(),g=a.find("> a:visible > ins").width()*a.find("> a:visible > ins").length,j=this.get_text(a),h=c("<div />",{css:{position:"absolute",top:"-200px",left:d?"0px":"-1000px",visibility:"hidden"}}).appendTo("body"),
k=a.css("position","relative").append(c("<input />",{value:j,"class":"jstree-rename-input",css:{padding:"0",border:"1px solid silver",position:"absolute",left:d?"auto":f+g+4+"px",right:d?f+g+4+"px":"auto",top:"0px",height:this.data.core.li_height-2+"px",lineHeight:this.data.core.li_height-2+"px",width:"150px"},blur:c.proxy(function(){var c=a.children(".jstree-rename-input"),d=c.val();""===d&&(d=j);h.remove();c.remove();this.set_text(a,j);this.rename_node(a,d);b.call(this,a,d,j);a.css("position","")},
this),keyup:function(a){a=a.keyCode||a.which;27==a?(this.value=j,this.blur()):13==a?this.blur():k.width(Math.min(h.text("pW"+this.value).width(),e))},keypress:function(a){if(13==(a.keyCode||a.which))return!1}})).children(".jstree-rename-input");this.set_text(a,"");h.css({fontFamily:k.css("fontFamily")||"",fontSize:k.css("fontSize")||"",fontWeight:k.css("fontWeight")||"",fontStyle:k.css("fontStyle")||"",fontStretch:k.css("fontStretch")||"",fontVariant:k.css("fontVariant")||"",letterSpacing:k.css("letterSpacing")||
...
!1,!0);f?g.__callback({obj:a,name:this.get_text(a),parent:b,position:d}):this._show_input(a,function(a,c){g.__callback({obj:a,name:c,parent:b,position:d})})})},remove:function(a){var a=this._get_node(a,!0),b=this._get_parent(a),c=this._get_prev(a);this.__rollback();a=this.delete_node(a);!1!==a&&this.__callback({obj:a,prev:c,parent:b})},check_move:function(){return!this.__call_old()?!1:!this._get_settings().crrm.move.check_move.call(this,this._get_move())?!1:!0},move_node:function(a,b,c,e,f,g){var j=
this._get_settings().crrm.move;if(!f){if("undefined"===typeof c)c=j.default_position;if("inside"===c&&!j.default_position.match(/^(before|after)$/))c=j.default_position;return this.__call_old(!0,a,b,c,e,!1,g)}if(!0===j.always_copy||"multitree"===j.always_copy&&a.rt.get_index()!==a.ot.get_index())e=!0;this.__call_old(!0,a,b,c,e,!0,g)},cut:function(a){a=this._get_node(a,!0);if(!a||!a.length)return!1;this.data.crrm.cp_nodes=!1;this.data.crrm.ct_nodes=a;this.__callback({obj:a})},copy:function(a){a=this._get_node(a,
!0);if(!a||!a.length)return!1;this.data.crrm.ct_nodes=!1;this.data.crrm.cp_nodes=a;this.__callback({obj:a})},paste:function(a){a=this._get_node(a);if(!a||!a.length)return!1;var b=this.data.crrm.ct_nodes?this.data.crrm.ct_nodes:this.data.crrm.cp_nodes;if(!this.data.crrm.ct_nodes&&!this.data.crrm.cp_nodes)return!1;if(this.data.crrm.ct_nodes)this.move_node(this.data.crrm.ct_nodes,a),this.data.crrm.ct_nodes=!1;this.data.crrm.cp_nodes&&this.move_node(this.data.crrm.cp_nodes,a,!1,!0);this.__callback({obj:a,
...
icons:!0},_fn:{set_theme:function(b,d){if(!b)return!1;d||(d=c.jstree._themes+b+".css");-1==c.inArray(d,a)&&(c.vakata.css.add_sheet({url:d}),a.push(d));if(this.data.themes.theme!=b)this.get_container().removeClass("jstree-"+this.data.themes.theme),this.data.themes.theme=b;this.get_container().addClass("jstree-"+b);this.data.themes.dots?this.show_dots():this.hide_dots();this.data.themes.icons?this.show_icons():this.hide_icons();this.__callback()},get_theme:function(){return this.data.themes.theme},
...
toggle_icons:function(){this.data.themes.icons?this.hide_icons():this.show_icons()}}});c(function(){if(!1===c.jstree._themes)c.jstree._themes="/stylesheets/compiled/jquery/jstree/"});c.jstree.defaults.plugins.push("themes")})(jQuery);(function(c){var a=[];c.jstree.plugin("hotkeys",{__init:function(){if("undefined"===typeof c.hotkeys)throw"jsTree hotkeys: jQuery hotkeys plugin not included.";if(!this.data.ui)throw"jsTree hotkeys: jsTree UI plugin not included.";c.each(this._get_settings().hotkeys,
function(b,d){!1!==d&&-1==c.inArray(b,a)&&(c(document).bind("keydown",b,function(a){var d;var g=c.jstree._focused(),j;g&&g.data&&g.data.hotkeys&&g.data.hotkeys.enabled&&(j=g._get_settings().hotkeys[b])&&(d=j.call(g,a));return d}),a.push(b))});this.get_container().bind("lock.jstree",c.proxy(function(){if(this.data.hotkeys.enabled)this.data.hotkeys.enabled=!1,this.data.hotkeys.revert=!0},this)).bind("unlock.jstree",c.proxy(function(){if(this.data.hotkeys.revert)this.data.hotkeys.enabled=!0},this));
...
this.data.ui.last_selected||-1));return!1},"shift+down":function(){this.hover_node(this._get_next(this.data.ui.hovered||this.data.ui.last_selected||-1));return!1},left:function(){var a=this.data.ui.hovered||this.data.ui.last_selected;a&&(a.hasClass("jstree-open")?this.close_node(a):this.hover_node(this._get_prev(a)));return!1},"ctrl+left":function(){var a=this.data.ui.hovered||this.data.ui.last_selected;a&&(a.hasClass("jstree-open")?this.close_node(a):this.hover_node(this._get_prev(a)));return!1},
"shift+left":function(){var a=this.data.ui.hovered||this.data.ui.last_selected;a&&(a.hasClass("jstree-open")?this.close_node(a):this.hover_node(this._get_prev(a)));return!1},right:function(){var a=this.data.ui.hovered||this.data.ui.last_selected;a&&a.length&&(a.hasClass("jstree-closed")?this.open_node(a):this.hover_node(this._get_next(a)));return!1},"ctrl+right":function(){var a=this.data.ui.hovered||this.data.ui.last_selected;a&&a.length&&(a.hasClass("jstree-closed")?this.open_node(a):this.hover_node(this._get_next(a)));
return!1},"shift+right":function(){var a=this.data.ui.hovered||this.data.ui.last_selected;a&&a.length&&(a.hasClass("jstree-closed")?this.open_node(a):this.hover_node(this._get_next(a)));return!1},space:function(){this.data.ui.hovered&&this.data.ui.hovered.children("a:eq(0)").click();return!1},"ctrl+space":function(a){a.type="click";this.data.ui.hovered&&this.data.ui.hovered.children("a:eq(0)").trigger(a);return!1},"shift+space":function(a){a.type="click";this.data.ui.hovered&&this.data.ui.hovered.children("a:eq(0)").trigger(a);
...
defaults:{data:!1,ajax:!1,correct_state:!0,progressive_render:!1,progressive_unload:!1},_fn:{load_node:function(a,b,c){var e=this;this.load_node_json(a,function(){e.__callback({obj:e._get_node(a)});b.call(this)},c)},_is_loaded:function(a){var b=this._get_settings().json_data,a=this._get_node(a);return-1==a||!a||!b.ajax&&!b.progressive_render&&!c.isFunction(b.data)||a.is(".jstree-open, .jstree-leaf")||0<a.children("ul").children("li").length},refresh:function(a){var a=this._get_node(a),b=this._get_settings().json_data;
a&&-1!==a&&b.progressive_unload&&(c.isFunction(b.data)||b.ajax)&&a.removeData("jstree_children");return this.__call_old()},load_node_json:function(a,b,d){var e=this.get_settings().json_data,f,g=function(){};f=function(){};if((a=this._get_node(a))&&-1!==a&&(e.progressive_render||e.progressive_unload)&&!a.is(".jstree-open, .jstree-leaf")&&0===a.children("ul").children("li").length&&a.data("jstree_children")){if(f=this._parse_json(a.data("jstree_children"),a))a.append(f),e.progressive_unload||a.removeData("jstree_children");
this.clean_node(a);b&&b.call(this)}else{if(a&&-1!==a){if(a.data("jstree_is_loading"))return;a.data("jstree_is_loading",!0)}switch(!0){case !e.data&&!e.ajax:throw"Neither data nor ajax settings supplied.";case c.isFunction(e.data):e.data.call(this,a,c.proxy(function(c){(c=this._parse_json(c,a))?(-1===a||!a?this.get_container().children("ul").empty().append(c.children()):(a.append(c).children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading")),this.clean_node(a),b&&
b.call(this)):(-1===a||!a?e.correct_state&&this.get_container().children("ul").empty():(a.children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading"),e.correct_state&&this.correct_state(a)),d&&d.call(this))},this));break;case !!e.data&&!e.ajax||!!e.data&&!!e.ajax&&(!a||-1===a):if(!a||-1==a)(f=this._parse_json(e.data,a))?(this.get_container().children("ul").empty().append(f.children()),this.clean_node()):e.correct_state&&this.get_container().children("ul").empty();
b&&b.call(this);break;case !e.data&&!!e.ajax||!!e.data&&!!e.ajax&&a&&-1!==a:g=function(c,b,f){var i=this.get_settings().json_data.ajax.error;i&&i.call(this,c,b,f);-1!=a&&a.length?(a.children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading"),"success"===b&&e.correct_state&&this.correct_state(a)):"success"===b&&e.correct_state&&this.get_container().children("ul").empty();d&&d.call(this)};e.ajax.context=this;e.ajax.error=g;e.ajax.success=function(d,f,k){var i=this.get_settings().json_data.ajax.success;
i&&(d=i.call(this,d,f,k)||d);if(""===d||d&&d.toString&&""===d.toString().replace(/^[\s\n]+$/,"")||!c.isArray(d)&&!c.isPlainObject(d))return g.call(this,k,f,"");(d=this._parse_json(d,a))?(-1===a||!a?this.get_container().children("ul").empty().append(d.children()):(a.append(d).children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading")),this.clean_node(a),b&&b.call(this)):-1===a||!a?e.correct_state&&(this.get_container().children("ul").empty(),b&&b.call(this)):(a.children("a.jstree-loading").removeClass("jstree-loading"),
a.removeData("jstree_is_loading"),e.correct_state&&(this.correct_state(a),b&&b.call(this)))};if(!e.ajax.dataType)e.ajax.dataType="json";if(c.isFunction(e.ajax.url))e.ajax.url=e.ajax.url.call(this,a);if(c.isFunction(e.ajax.data))e.ajax.data=e.ajax.data.call(this,a);c.ajax(e.ajax)}}},_parse_json:function(a,b,d){var e=!1,f=this._get_settings(),g=f.json_data,j=f.core.html_titles,h;if(!a)return e;g.progressive_unload&&b&&-1!==b&&b.data("jstree_children",e);if(c.isArray(a)){e=c();if(!a.length)return!1;
for(f=0,g=a.length;f<g;f++)h=this._parse_json(a[f],b,!0),h.length&&(e=e.add(h))}else{"string"==typeof a&&(a={data:a});if(!a.data&&""!==a.data)return e;e=c("<li />");a.attr&&e.attr(a.attr);a.metadata&&e.data(a.metadata);a.state&&e.addClass("jstree-"+a.state);if(!c.isArray(a.data))h=a.data,a.data=[],a.data.push(h);c.each(a.data,function(b,d){h=c("<a />");c.isFunction(d)&&(d=d.call(this,a));if("string"==typeof d)h.attr("href","#")[j?"html":"text"](d);else{if(!d.attr)d.attr={};if(!d.attr.href)d.attr.href=
"#";h.attr(d.attr)[j?"html":"text"](d.title);d.language&&h.addClass(d.language)}h.prepend("<ins class='jstree-icon'>&#160;</ins>");if(!d.icon&&a.icon)d.icon=a.icon;d.icon&&(-1===d.icon.indexOf("/")?h.children("ins").addClass(d.icon):h.children("ins").css("background","url('"+d.icon+"') center center no-repeat"));e.append(h)});e.prepend("<ins class='jstree-icon'>&#160;</ins>");a.children&&(g.progressive_render&&"open"!==a.state?e.addClass("jstree-closed").data("jstree_children",a.children):(g.progressive_unload&&
e.data("jstree_children",a.children),c.isArray(a.children)&&a.children.length&&(h=this._parse_json(a.children,b,!0),h.length&&(b=c("<ul />"),b.append(h),e.append(b)))))}d||(d=c("<ul />"),d.append(e),e=d);return e},get_json:function(a,b,d,e){var f=[],g=this._get_settings(),j=this,h,k,i,m,l,n,a=this._get_node(a);if(!a||-1===a)a=this.get_container().find("> ul > li");b=c.isArray(b)?b:["id","class"];!e&&this.data.types&&b.push(g.types.type_attr);d=c.isArray(d)?d:[];a.each(function(){i=c(this);h={data:[]};
if(b.length)h.attr={};c.each(b,function(a,c){(k=i.attr(c))&&k.length&&k.replace(/jstree[^ ]*/ig,"").length&&(h.attr[c]=(" "+k).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,""))});if(i.hasClass("jstree-open"))h.state="open";if(i.hasClass("jstree-closed"))h.state="closed";if(i.data())h.metadata=i.data();m=i.children("a");m.each(function(){l=c(this);if(d.length||-1!==c.inArray("languages",g.plugins)||l.children("ins").get(0).style.backgroundImage.length||l.children("ins").get(0).className&&
l.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").length){n=!1;-1!==c.inArray("languages",g.plugins)&&c.isArray(g.languages)&&g.languages.length&&c.each(g.languages,function(a,c){if(l.hasClass(c))return n=c,!1});k={attr:{},title:j.get_text(l,n)};c.each(d,function(a,c){k.attr[c]=(" "+(l.attr(c)||"")).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,"")});-1!==c.inArray("languages",g.plugins)&&c.isArray(g.languages)&&g.languages.length&&c.each(g.languages,
function(a,c){if(l.hasClass(c))return k.language=c,!0});if(l.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/^\s+$/ig,"").length)k.icon=l.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,"");if(l.children("ins").get(0).style.backgroundImage.length)k.icon=l.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")","")}else k=j.get_text(l);1<m.length?h.data.push(k):h.data=k});i=i.find("> ul > li");
...
if(!1!==d)d.style.display="none";d=c.vakata.css.get_css(e+"."+a,!1,this.data.languages.language_css);if(!1!==d)d.style.display="";this.data.languages.current_language=a;this.__callback(a);return!0},get_lang:function(){return this.data.languages.current_language},_get_string:function(a,b){var d=this._get_settings().languages,e=this._get_settings().core.strings;c.isArray(d)&&d.length&&(b=b&&-1!=c.inArray(b,d)?b:this.data.languages.current_language);return e[b]&&e[b][a]?e[b][a]:e[a]?e[a]:a},get_text:function(a,
b){a=this._get_node(a)||this.data.ui.last_selected;if(!a.size())return!1;var d=this._get_settings().languages,e=this._get_settings().core.html_titles;c.isArray(d)&&d.length?(b=b&&-1!=c.inArray(b,d)?b:this.data.languages.current_language,a=a.children("a."+b)):a=a.children("a:eq(0)");if(e)return a=a.clone(),a.children("INS").remove(),a.html();a=a.contents().filter(function(){return 3==this.nodeType})[0];return a.nodeValue},set_text:function(a,b,d){a=this._get_node(a)||this.data.ui.last_selected;if(!a.size())return!1;
var e=this._get_settings().languages,f=this._get_settings().core.html_titles;c.isArray(e)&&e.length?(d=d&&-1!=c.inArray(d,e)?d:this.data.languages.current_language,a=a.children("a."+d)):a=a.children("a:eq(0)");if(f)return e=a.children("INS").clone(),a.html(b).prepend(e),this.__callback({obj:a,name:b,lang:d}),!0;a=a.contents().filter(function(){return 3==this.nodeType})[0];this.__callback({obj:a,name:b,lang:d});return a.nodeValue=b},_load_css:function(){var a=this._get_settings().languages,b="/* languages css */",
...
b[h])||a.append(d.eq(0).clone().removeClass(b.join(" ")).addClass(b[h]));d.not("."+b.join(", .")).remove()}e&&e.call(this,a)})}}})})(jQuery);(function(c){c.jstree.plugin("cookies",{__init:function(){if("undefined"===typeof c.cookie)throw"jsTree cookie: jQuery cookie plugin not included.";var a=this._get_settings().cookies,b;if(a.save_loaded&&(b=c.cookie(a.save_loaded))&&b.length)this.data.core.to_load=b.split(",");if(a.save_opened&&(b=c.cookie(a.save_opened))&&b.length)this.data.core.to_open=b.split(",");
...
{__init:function(){this.get_container().bind("load_node.jstree",c.proxy(function(a,c){var d=this._get_node(c.rslt.obj),d=-1===d?this.get_container().children("ul"):d.children("ul");this.sort(d)},this)).bind("rename_node.jstree create_node.jstree create.jstree",c.proxy(function(a,c){this.sort(c.rslt.obj.parent())},this)).bind("move_node.jstree",c.proxy(function(a,c){this.sort((-1==c.rslt.np?this.get_container():c.rslt.np).children("ul"))},this))},defaults:function(a,c){return this.get_text(a)>this.get_text(c)?
...
!1;this.data.dnd.inside=!1;c.vakata.dnd.helper.children("ins").attr("class","jstree-invalid");d.hide();e&&e.hide();if(b&&b[0]===a.target.parentNode){if(this.data.dnd.to1)clearTimeout(this.data.dnd.to1),this.data.dnd.to1=!1;if(this.data.dnd.to2)clearTimeout(this.data.dnd.to2),this.data.dnd.to2=!1}},start_drag:function(b,f){a=this._get_node(b);this.data.ui&&this.is_selected(a)&&(a=this._get_node(null,!0));var h=1<a.length?this._get_string("multiple_selection"):this.get_text(a),g=this.get_container();
this._get_settings().core.html_titles||(h=h.replace(/</ig,"&lt;").replace(/>/ig,"&gt;"));c.vakata.dnd.drag_start(f,{jstree:!0,obj:a},"<ins class='jstree-icon'></ins>"+h);this.data.themes&&(d&&d.attr("class","jstree-"+this.data.themes.theme),e&&e.attr("class","jstree-"+this.data.themes.theme),c.vakata.dnd.helper.attr("class","jstree-dnd-helper jstree-"+this.data.themes.theme));this.data.dnd.cof=g.offset();this.data.dnd.cw=parseInt(g.width(),10);this.data.dnd.ch=parseInt(g.height(),10);this.data.dnd.active=
...
_fn:{_checkbox_notify:function(a,b){b.checked&&this.check_node(a,!1)},_prepare_checkboxes:function(a){a=!a||-1==a?this.get_container().find("> ul > li"):this._get_node(a);if(!1!==a){var b,d=this,e,f=this._get_settings().checkbox.two_state,g=this._get_settings().checkbox.real_checkboxes,j=this._get_settings().checkbox.real_checkboxes_names;a.each(function(){e=c(this);b=e.is("li")&&(e.hasClass("jstree-checked")||g&&e.children(":checked").length)?"jstree-checked":"jstree-unchecked";e.find("li").andSelf().each(function(){var a=
...
!a||!b.ajax&&!c.isFunction(b.data)||a.is(".jstree-open, .jstree-leaf")||0<a.children("ul").children("li").size()},load_node_xml:function(a,b,f){var g=this.get_settings().xml_data,j=function(){},h=function(){};if((a=this._get_node(a))&&-1!==a){if(a.data("jstree_is_loading"))return;a.data("jstree_is_loading",!0)}switch(!0){case !g.data&&!g.ajax:throw"Neither data nor ajax settings supplied.";case c.isFunction(g.data):g.data.call(this,a,c.proxy(function(f){this.parse_xml(f,c.proxy(function(f){f&&(f=
f.replace(/ ?xmlns="[^"]*"/ig,""),10<f.length?(f=c(f),-1===a||!a?this.get_container().children("ul").empty().append(f.children()):(a.children("a.jstree-loading").removeClass("jstree-loading"),a.append(f),a.removeData("jstree_is_loading")),g.clean_node&&this.clean_node(a),b&&b.call(this)):a&&-1!==a?(a.children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading"),g.correct_state&&(this.correct_state(a),b&&b.call(this))):g.correct_state&&(this.get_container().children("ul").empty(),
b&&b.call(this)))},this))},this));break;case !!g.data&&!g.ajax||!!g.data&&!!g.ajax&&(!a||-1===a):(!a||-1==a)&&this.parse_xml(g.data,c.proxy(function(f){f?(f=f.replace(/ ?xmlns="[^"]*"/ig,""),10<f.length&&(f=c(f),this.get_container().children("ul").empty().append(f.children()),g.clean_node&&this.clean_node(a),b&&b.call(this))):g.correct_state&&(this.get_container().children("ul").empty(),b&&b.call(this))},this));break;case !g.data&&!!g.ajax||!!g.data&&!!g.ajax&&a&&-1!==a:j=function(b,c,e){var h=this.get_settings().xml_data.ajax.error;
...
if(!e||-1===e)e=this.get_container().find("> ul > li");f=c.isArray(f)?f:["id","class"];!j&&this.data.types&&-1===c.inArray(k.types.type_attr,f)&&f.push(k.types.type_attr);g=c.isArray(g)?g:[];j||(k.xml_data.get_include_preamble&&(h+='<?xml version="1.0" encoding="UTF-8"?>'),h+="<root>");e.each(function(){h+="<item";n=c(this);c.each(f,function(a,c){var d=n.attr(c);if(!k.xml_data.get_skip_empty||"undefined"!==typeof d)h+=" "+c+'="'+b((" "+(d||"")).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,
"").replace(/ $/,""))+'"'});n.hasClass("jstree-open")&&(h+=' state="open"');n.hasClass("jstree-closed")&&(h+=' state="closed"');"flat"===a&&(h+=' parent_id="'+b(j)+'"');h+=">";h+="<content>";o=n.children("a");o.each(function(){m=c(this);p=!1;h+="<name";-1!==c.inArray("languages",k.plugins)&&c.each(k.languages,function(a,c){if(m.hasClass(c))return h+=' lang="'+b(c)+'"',p=c,!1});g.length&&c.each(g,function(a,c){var d=m.attr(c);if(!k.xml_data.get_skip_empty||"undefined"!==typeof d)h+=" "+c+'="'+b((" "+
...
return 10<d.length?d:!1},exec:function(a){return c.isFunction(c.vakata.context.func[a])?(c.vakata.context.func[a].call(c.vakata.context.data,c.vakata.context.par),!0):!1}};c(function(){c.vakata.css.add_sheet({str:"#vakata-contextmenu { display:block; visibility:hidden; left:0; top:-200px; position:absolute; margin:0; padding:0; min-width:180px; background:#ebebeb; border:1px solid silver; z-index:10000; *width:180px; } #vakata-contextmenu ul { min-width:180px; *width:180px; } #vakata-contextmenu ul, #vakata-contextmenu li { margin:0; padding:0; list-style-type:none; display:block; } #vakata-contextmenu li { line-height:20px; min-height:20px; position:relative; padding:0px; } #vakata-contextmenu li a { padding:1px 6px; line-height:17px; display:block; text-decoration:none; margin:1px 1px 0 1px; } #vakata-contextmenu li ins { float:left; width:16px; height:16px; text-decoration:none; margin-right:2px; } #vakata-contextmenu li a:hover, #vakata-contextmenu li.vakata-hover > a { background:gray; color:white; } #vakata-contextmenu li ul { display:none; position:absolute; top:-2px; left:100%; background:#ebebeb; border:1px solid gray; } #vakata-contextmenu .right { right:100%; left:auto; } #vakata-contextmenu .bottom { bottom:-1px; top:auto; } #vakata-contextmenu li.vakata-separator { min-height:0; height:1px; line-height:1px; font-size:1px; overflow:hidden; margin:0 2px; background:silver; /* border-top:1px solid #fefefe; */ padding:0; } ",
...
function(a,b){if(b.icon&&(b.icon.image||b.icon.position))f="default"===a?e.find("li > a > .jstree-icon"):e.find("li["+g.type_attr+"='"+a+"'] > a > .jstree-icon"),b.icon.image&&f.css("backgroundImage","url("+b.icon.image+")"),f.css("backgroundPosition",b.icon.position||"0 0")})},this))},defaults:{max_children:-1,max_depth:-1,valid_children:"all",use_data:!1,type_attr:"rel",types:{"default":{max_children:-1,max_depth:-1,valid_children:"all"}}},_fn:{_types_notify:function(a,b){b.type&&this._get_settings().types.use_data&&
this.set_type(b.type,a)},_get_type:function(a){a=this._get_node(a);return!a||!a.length?!1:a.attr(this._get_settings().types.type_attr)||"default"},set_type:function(a,b){var b=this._get_node(b),c=!b.length||!a?!1:b.attr(this._get_settings().types.type_attr,a);c&&this.__callback({obj:b,type:a});return c},_check:function(a,b,d){var b=this._get_node(b),e=!1,f=this._get_type(b),g=0,j=this,h=this._get_settings().types,k=!1;if(-1===b)if(h[a])e=h[a];else return;else{if(!1===f)return;(k=h.use_data?b.data("jstree"):
!1)&&k.types&&"undefined"!==typeof k.types[a]?e=k.types[a]:h.types[f]&&"undefined"!==typeof h.types[f][a]?e=h.types[f][a]:h.types["default"]&&"undefined"!==typeof h.types["default"][a]&&(e=h.types["default"][a])}c.isFunction(e)&&(e=e.call(this,b));"max_depth"===a&&-1!==b&&!1!==d&&-2!==h.max_depth&&0!==e&&b.children("a:eq(0)").parentsUntil(".jstree","li").each(function(b){if(-1!==h.max_depth&&0>=h.max_depth-(b+1))return e=0,!1;g=0===b?e:j._check(a,this,!1);if(-1!==g&&0>=g-(b+1))return e=0,!1;if(0<=
g&&(g-(b+1)<e||0>e))e=g-(b+1);if(0<=h.max_depth&&(h.max_depth-(b+1)<e||0>e))e=h.max_depth-(b+1)});return e},check_move:function(){if(!this.__call_old())return!1;var a=this._get_move(),b=a.rt._get_settings().types,d=a.rt._check("max_children",a.cr),e=a.rt._check("max_depth",a.cr),f=a.rt._check("valid_children",a.cr),g=0,j=1;if("none"===f||c.isArray(f)&&a.ot&&a.ot._get_type&&(a.o.each(function(){if(-1===c.inArray(a.ot._get_type(this),f))return j=!1}),!1===j))return!1;if(-2!==b.max_children&&-1!==d&&
(g=-1===a.cr?this.get_container().find("> ul > li").not(a.o).length:a.cr.find("> ul > li").not(a.o).length,g+a.o.length>d))return!1;if(-2!==b.max_depth&&-1!==e){j=0;if(0===e)return!1;if("undefined"===typeof a.o.d){for(b=a.o;0<b.length;)b=b.find("> ul > li"),j++;a.o.d=j}if(0>e-a.o.d)return!1}return!0},create_node:function(a,b,d,e,f,g){if(!g&&(f||this._is_loaded(a))){var j="string"==typeof b&&b.match(/^before|after$/i)&&-1!==a?this._get_parent(a):this._get_node(a),h=this._get_settings().types,k=this._check("max_children",
j),i=this._check("max_depth",j),m=this._check("valid_children",j);"string"===typeof d&&(d={data:d});d||(d={});if("none"===m)return!1;if(c.isArray(m))if(!d.attr||!d.attr[h.type_attr]){if(!d.attr)d.attr={};d.attr[h.type_attr]=m[0]}else if(-1===c.inArray(d.attr[h.type_attr],m))return!1;if(-2!==h.max_children&&-1!==k&&(j=-1===j?this.get_container().find("> ul > li").length:j.find("> ul > li").length,j+1>k)||-2!==h.max_depth&&-1!==i&&0>i-1)return!1}return this.__call_old(!0,a,b,d,e,f,g)}}})})(jQuery);
(function(c){c.jstree.plugin("html_data",{__init:function(){this.data.html_data.original_container_html=this.get_container().find(" > ul > li").clone(!0);this.data.html_data.original_container_html.find("li").andSelf().contents().filter(function(){return 3==this.nodeType}).remove()},defaults:{data:!1,ajax:!1,correct_state:!0},_fn:{load_node:function(a,b,c){var e=this;this.load_node_html(a,function(){e.__callback({obj:e._get_node(a)});b.call(this)},c)},_is_loaded:function(a){a=this._get_node(a);return-1==
a||!a||!this._get_settings().html_data.ajax&&!c.isFunction(this._get_settings().html_data.data)||a.is(".jstree-open, .jstree-leaf")||0<a.children("ul").children("li").size()},load_node_html:function(a,b,d){var e,f=this.get_settings().html_data,g=function(){};e=function(){};if((a=this._get_node(a))&&-1!==a){if(a.data("jstree_is_loading"))return;a.data("jstree_is_loading",!0)}switch(!0){case c.isFunction(f.data):f.data.call(this,a,c.proxy(function(d){d&&""!==d&&d.toString&&""!==d.toString().replace(/^[\s\n]+$/,
"")?(d=c(d),d.is("ul")||(d=c("<ul />").append(d)),-1==a||!a?this.get_container().children("ul").empty().append(d.children()).find("li, a").filter(function(){return!this.firstChild||!this.firstChild.tagName||"INS"!==this.firstChild.tagName}).prepend("<ins class='jstree-icon'>&#160;</ins>").end().filter("a").children("ins:first-child").not(".jstree-icon").addClass("jstree-icon"):(a.children("a.jstree-loading").removeClass("jstree-loading"),a.append(d).children("ul").find("li, a").filter(function(){return!this.firstChild||
...
Math.random())),1]}},__destroy:function(){this.get_container().find("input.jstree-real-radio").removeClass("jstree-real-radio").end().find("ins.jstree-radio").remove()},_fn:{_radio_notify:function(a,b){b.checked&&this.check_node(a,!1)},_prepare_radios:function(a){a=!a||-1==a?this.get_container().find("> ul > li"):this._get_node(a);if(!1!==a){var b,d=this,e,f=this._get_settings().radio.two_state,g=this._get_settings().radio.real_radios,j=this._get_settings().radio.real_radios_names;a.each(function(){e=
c(this);b=e.is("li")&&(e.hasClass("jstree-checked")||g&&e.children(":checked").length)?"jstree-checked":"jstree-unchecked";e.find("li").andSelf().each(function(){var a=c(this),e;a.children("a"+(d.data.languages?"":":eq(0)")).not(":has(.jstree-radio)").prepend("<ins class='jstree-radio'>&#160;</ins>").parent().not(".jstree-checked, .jstree-unchecked").addClass(f?"jstree-unchecked":b);g&&(a.children(":radio").length?a.children(":radio").addClass("jstree-real-radio"):(e=j.call(d,a),a.prepend("<input type='radio' class='jstree-real-radio' id='"+
e[0]+"' name='"+e[0]+"' value='"+e[1]+"' />")));f?(a.hasClass("jstree-checked")||a.children(":checked").length)&&a.addClass("jstree-checked").children(":radio").prop("checked",!0):("jstree-checked"===b||a.hasClass("jstree-checked")||a.children(":checked").length)&&a.find("li").andSelf().addClass("jstree-checked").children(":radio").prop("checked",!0)})});f||a.find(".jstree-checked").parent().parent().each(function(){d._repair_state(this)})}},change_state:function(a,b){var a=this._get_node(a),d=!1,
e=this._get_settings().radio.real_radios;if(!a||-1===a)return!1;b=!1===b||!0===b?b:a.hasClass("jstree-checked");if(this._get_settings().radio.two_state)b?(a.removeClass("jstree-checked").addClass("jstree-unchecked"),e&&a.children(":radio").prop("checked",!1)):(a.removeClass("jstree-unchecked").addClass("jstree-checked"),e&&a.children(":radio").prop("checked",!0));else{if(b){d=a.find("li").andSelf();if(!d.filter(".jstree-checked, .jstree-undetermined").length)return!1;d.removeClass("jstree-checked jstree-undetermined").addClass("jstree-unchecked");
