odule Jqgrid
    ...
    def jqgrid_stylesheets
      css  = stylesheet_link_tag('jquery.ui/redmond.css') + "\n"
      css << stylesheet_link_tag('jquery.ui/jqGrid.css') + "\n"
    end

    def jqgrid_javascripts
      locale = I18n.locale rescue :en
      js =  ''
      js << javascript_include_tag('jquery.js') + "\n" unless Jqgrid.jrails_present
      if locale != :en
        js << javascript_include_tag("i18n/jquery.ui/datepicker-#{locale}.js") + "\n"
      end
      js << javascript_include_tag('jquery-ui.js') + "\n"
      js << javascript_include_tag("i18n/jqgrid/locale-#{locale}.js") + "\n"
      js << javascript_include_tag('jquery.jqGrid.js') + "\n"
    end
